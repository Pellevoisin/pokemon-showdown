export const BattlePokedex: {[speciesid: string]: SpeciesData} = {
	...
	kabutopsaerodactyl: {
		num: 10345,
		name: "kabutopsaerodactyl",
		types: ["Rock", "Flying"],
		baseStats: {hp: 66, atk: 108, def: 78, spa: 63, spd: 71, spe: 113},
		abilities: {0: "Swift Swim", 1: "Pressure", H: "Weak Armor"},
		heightm: 1.55,
		weightkg: 49.75,
		color: "Brown",
	...
	chanseymew: {
		...
		name: "chanseymew",
		types: ["Normal", "Psychic"],
		baseStats: {hp: 200, atk: 68, def: 68, spa: 56, spd: 103, spe: 83},
		abilities: {0: "Natural Cure", 1: "Synchronize", H: "Healer"},
		heightm: 0.75,
		weightkg: 19.3,
		color: "Pink",
		evos: ["Blissey"],
	...
	skarmorylugia: {
		...
		abilities: {0: "Keen Eye", 1: "Multiscale", H: "Weak Armor"},
		heightm: 3.45,
		weightkg: 133.25,
		color: "Gray",
	...
	espeongalvantula: {
		num: 10348,
		name: "espeongalvantula",
		types: ["Psychic", "Electric"],
		baseStats: {hp: 66, atk: 73, def: 60, spa: 119, spd: 83, spe: 108},
		abilities: {0: "Synchronize", 1: "Unnerve", H: "Magic Bounce"},
		heightm: 0.8500000000000001,
		weightkg: 20.4,
		color: "Purple",
		eggGroups: ["Bug", "Field"],
	...
	sylveonmewtwo: {
		...
		abilities: {0: "Cute Charm", 1: "Unnerve", H: "Pixilate"},
		heightm: 1,
		weightkg: 72.75,
		color: "Pink",
		eggGroups: ["Undiscovered", "Field"],
	...
	volcaronadeoxys: {
		num: 10350,
		name: "volcaronadeoxys",
		types: ["Bug", "Psychic"],
		baseStats: {hp: 73, atk: 120, def: 55, spa: 140, spd: 86, spe: 133},
		abilities: {0: "Flame Body", 1: "Pressure", H: "Swarm"},
		heightm: 1.65,
		weightkg: 53.4,
		color: "White",
		eggGroups: ["Undiscovered", "Bug"],
	...
	volcaronasteelix: {
		num: 10351,
		name: "volcaronasteelix",
		types: ["Bug", "Steel"],
		baseStats: {hp: 81, atk: 76, def: 155, spa: 108, spd: 91, spe: 53},
		abilities: {0: "Flame Body", 1: "Sturdy", H: "Swarm"},
		heightm: 5.3999999999999995,
		weightkg: 223,
		color: "White",
	...
	porygonzraikou: {
		...
		baseStats: {hp: 86, atk: 83, def: 73, spa: 128, spd: 83, spe: 106},
		abilities: {0: "Adaptability", 1: "Inner Focus", H: "Analytic"},
		heightm: 1.4,
		weightkg: 106,
		color: "Red",
		eggGroups: ["Undiscovered", "Mineral"],
	...
	deoxyszekrom: {
		...
		name: "deoxyszekrom",
		types: ["Psychic", "Electric"],
		baseStats: {hp: 66, atk: 150, def: 96, spa: 140, spd: 66, spe: 110},
		abilities: {0: "Pressure", 1: "Teravolt", H: ""},
		heightm: 2.3,
		weightkg: 202.9,
		color: "Red",
		eggGroups: ["Undiscovered", "Undiscovered"],
	...
	nidokingzekrom: {
		...
		baseStats: {hp: 87, atk: 134, def: 105, spa: 96, spd: 83, spe: 88},
		abilities: {0: "Poison Point", 1: "Teravolt", H: "Sheer Force"},
		heightm: 2.15,
		weightkg: 203,
		color: "Purple",
		eggGroups: ["Undiscovered", "Monster"],
	...
	garchompaegislash: {
		num: 10356,
		name: "garchompaegislash",
		types: ["Dragon", "Ghost"],
		baseStats: {hp: 92, atk: 76, def: 125, spa: 70, spd: 103, spe: 74},
		abilities: {0: "Sand Veil", 1: "Stance Change", H: "Rough Skin"},
	...
	ampharostangrowth: {
		num: 10357,
		name: "ampharostangrowth",
		types: ["Electric", "Grass"],
		baseStats: {hp: 93, atk: 91, def: 111, spa: 113, spd: 76, spe: 51},
		abilities: {0: "Static", 1: "Leaf Guard", H: "Plus"},
		heightm: 1.7,
		weightkg: 95.05,
		color: "Yellow",
	...
	mantinemuk: {
		...
		name: "mantinemuk",
		types: ["Water", "Poison"],
		baseStats: {hp: 91, atk: 83, def: 73, spa: 75, spd: 126, spe: 56},
		abilities: {0: "Swift Swim", 1: "Sticky Hold", H: "Water Veil"},
		heightm: 1.65,
		weightkg: 125,
		color: "Purple",
	...
	cradilytyranitar: {
		num: 10359,
		name: "cradilytyranitar",
		types: ["Rock", "Dark"],
		baseStats: {hp: 90, atk: 116, def: 105, spa: 85, spd: 104, spe: 55},
		abilities: {0: "Suction Cups", 1: "Unnerve", H: "Storm Drain"},
		heightm: 1.75,
		weightkg: 131.2,
		color: "Green",
	...
	umbreontentacruel: {
		num: 10360,
		name: "umbreontentacruel",
		types: ["Dark", "Poison"],
		baseStats: {hp: 90, atk: 68, def: 80, spa: 66, spd: 126, spe: 88},
		abilities: {0: "Synchronize", 1: "Liquid Ooze", H: "Inner Focus"},
		heightm: 1.3,
		weightkg: 41,
		color: "Black",
	...
	sylveonforretress: {
		num: 10361,
		name: "sylveonforretress",
		types: ["Fairy", "Steel"],
		baseStats: {hp: 88, atk: 81, def: 115, spa: 93, spd: 106, spe: 46},
		abilities: {0: "Cute Charm", 1: "Overcoat", H: "Pixilate"},
		heightm: 1.1,
		weightkg: 74.65,
		color: "Pink",
		eggGroups: ["Bug", "Field"],
	...
	chanseycofagrigus: {
		num: 10363,
		name: "chanseycofagrigus",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 186, atk: 35, def: 98, spa: 55, spd: 105, spe: 36},
		abilities: {0: "Natural Cure", 1: "Mummy", H: "Healer"},
		heightm: 1.4,
		weightkg: 55.55,
		color: "Pink",
		evos: ["Blissey"],
	...
	kecleonaerodactyl: {
		num: 10364,
		name: "kecleonaerodactyl",
		types: ["Normal", "Flying"],
		baseStats: {hp: 66, atk: 100, def: 66, spa: 60, spd: 105, spe: 100},
		abilities: {0: "Color Change", 1: "Pressure", H: "Protean"},
		heightm: 1.4,
		weightkg: 40,
		color: "Green",
		eggGroups: ["Flying", "Field"],
	...
	sylveongenesect: {
		num: 10365,
		name: "sylveongenesect",
		types: ["Fairy", "Steel"],
		baseStats: {hp: 87, atk: 101, def: 85, spa: 113, spd: 118, spe: 86},
		abilities: {0: "Cute Charm", 1: "Download", H: "Pixilate"},
		heightm: 1.25,
		weightkg: 53.0,
		color: "Pink",
		eggGroups: ["Undiscovered", "Field"],
	...
	jumpluffklefki: {
		...
		name: "jumpluffklefki",
		types: ["Grass", "Fairy"],
		baseStats: {hp: 69, atk: 71, def: 84, spa: 63, spd: 92, spe: 86},
	...
	breloomklefki: {
		...
		name: "breloomklefki",
		types: ["Grass", "Fairy"],
		baseStats: {hp: 59, atk: 96, def: 87, spa: 66, spd: 69, spe: 73},
		abilities: {0: "Effect Spore", 1: "Prankster", H: "Technician"},
		heightm: 0.7,
		weightkg: 21.1,
		color: "Green",
		eggGroups: ["Mineral", "Fairy"],
	...
	drifblimklefki: {
		...
		name: "drifblimklefki",
		types: ["Ghost", "Fairy"],
		baseStats: {hp: 119, atk: 80, def: 75, spa: 86, spd: 65, spe: 76},
		abilities: {0: "Aftermath", 1: "Prankster", H: "Flare Boost"},
		heightm: 0.7,
		weightkg: 9,
		color: "Purple",
		eggGroups: ["Mineral", "Amorphous"],
	...
	blazikenbreloom: {
		num: 10369,
		name: "blazikenbreloom",
		types: ["Fire", "Fighting"],
		baseStats: {hp: 73, atk: 126, def: 76, spa: 93, spd: 66, spe: 73},
		abilities: {0: "Blaze", 1: "Poison Heal", H: "Speed Boost"},
		heightm: 1.5499999999999998,
		weightkg: 45.6,
		color: "Red",
		eggGroups: ["Fairy", "Field"],
	...
	breloomblaziken: {
		num: 10370,
		name: "breloomblaziken",
		types: ["Grass", "Fighting"],
		baseStats: {hp: 66, atk: 123, def: 73, spa: 76, spd: 63, spe: 76},
		abilities: {0: "Effect Spore", 1: "Speed Boost", H: "Technician"},
		heightm: 1.5499999999999998,
		weightkg: 45.6,
		color: "Green",
		eggGroups: ["Field", "Fairy"],
	...
	zekromklefki: {
		...
		name: "zekromklefki",
		types: ["Dragon", "Fairy"],
		baseStats: {hp: 85, atk: 103, def: 100, spa: 106, spd: 95, spe: 80},
		abilities: {0: "Teravolt", 1: "Prankster", H: "Magician"},
		heightm: 1.55,
		weightkg: 174,
		color: "Black",
		eggGroups: ["Mineral", "Undiscovered"],
	...
	mantineferrothorn: {
		num: 10372,
		name: "mantineferrothorn",
		types: ["Water", "Steel"],
		baseStats: {hp: 81, atk: 76, def: 110, spa: 71, spd: 132, spe: 36},
		abilities: {0: "Swift Swim", 1: "Anticipation", H: "Water Veil"},
		heightm: 1.55,
		weightkg: 165,
		color: "Purple",
		eggGroups: ["Grass", "Water 1"],
	...
	porygonzgenesect: {
		num: 10373,
		name: "porygonzgenesect",
		types: ["Normal", "Steel"],
		baseStats: {hp: 80, atk: 106, def: 86, spa: 130, spd: 81, spe: 96},
		abilities: {0: "Adaptability", 1: "Download", H: "Analytic"},
		heightm: 1.2,
		weightkg: 58.25,
		color: "Red",
	...
	ferrothornpyukumuku: {
		num: 10374,
		name: "ferrothornpyukumuku",
		types: ["Grass", "Water"],
		baseStats: {hp: 67, atk: 71, def: 130, spa: 46, spd: 120, spe: 10},
		abilities: {0: "Iron Barbs", 1: "Unaware", H: "Anticipation"},
		heightm: 0.65,
		weightkg: 55.6,
		color: "Gray",
		eggGroups: ["Water 1", "Grass"],
	...
	dodriohitmonlee: {
		num: 10375,
		name: "dodriohitmonlee",
		types: ["Flying", "Fighting"],
		baseStats: {hp: 56, atk: 116, def: 58, spa: 51, spd: 76, spe: 94},
		abilities: {0: "Run Away", 1: "Reckless", H: "Tangled Feet"},
		heightm: 1.65,
		weightkg: 67.5,
		color: "Brown",
	...
	primeapehooh: {
		...
		name: "primeapehooh",
		types: ["Fighting", "Flying"],
		baseStats: {hp: 78, atk: 121, def: 80, spa: 76, spd: 98, spe: 91},
		abilities: {0: "Vital Spirit", 1: "Regenerator", H: "Defiant"},
		heightm: 2.4,
		weightkg: 115,
		color: "Brown",
		eggGroups: ["Undiscovered", "Field"],
	...
	deoxysmilotic: {
		...
		name: "deoxysmilotic",
		types: ["Psychic", "Water"],
		baseStats: {hp: 65, atk: 90, def: 69, spa: 133, spd: 75, spe: 104},
		abilities: {0: "Pressure", 1: "Competitive", H: "Cute Charm"},
		heightm: 3.95,
		weightkg: 111.4,
		color: "Red",
		eggGroups: ["Water 1", "Undiscovered"],
	...
	aegislashpyukumuku: {
		num: 10379,
		name: "aegislashpyukumuku",
		types: ["Steel", "Water"],
		baseStats: {hp: 58, atk: 56, def: 133, spa: 43, spd: 136, spe: 23},
		abilities: {0: "Stance Change", 1: "Innards Out", H: "Unaware"},
		heightm: 1.0,
		weightkg: 27.1,
		color: "Brown",
		eggGroups: ["Water 1", "Mineral"],
	...
	aerodactylhydreigon: {
		num: 10380,
		name: "aerodactylhydreigon",
		types: ["Rock", "Dragon"],
		baseStats: {hp: 84, atk: 105, def: 81, spa: 81, spd: 80, spe: 108},
		abilities: {0: "Rock Head", 1: "Levitate", H: "Unnerve"},
		heightm: 1.8,
		weightkg: 109,
		color: "Purple",
	...
	mawilegenesect: {
		...
		name: "mawilegenesect",
		types: ["Steel", "Bug"],
		baseStats: {hp: 57, atk: 108, def: 91, spa: 76, spd: 68, spe: 82},
		abilities: {0: "Hyper Cutter", 1: "Download", H: "Sheer Force"},
		heightm: 1.05,
		weightkg: 47.0,
		color: "Black",
		eggGroups: ["Undiscovered", "Field"],
	...
	ninjaskslaking: {
		...
		name: "ninjaskslaking",
		types: ["Bug", "Normal"],
		baseStats: {hp: 90, atk: 136, def: 81, spa: 65, spd: 55, spe: 120},
		abilities: {0: "Speed Boost", 1: "Truant", H: "Infiltrator"},
		heightm: 1.4,
		weightkg: 71.25,
		color: "Yellow",
		eggGroups: ["Field", "Bug"],
	...
	ninjaskrampardos: {
		num: 10383,
		name: "ninjaskrampardos",
		types: ["Bug", "Rock"],
		baseStats: {hp: 73, atk: 140, def: 55, spa: 55, spd: 50, spe: 92},
		abilities: {0: "Speed Boost", 1: "Sheer Force", H: "Infiltrator"},
		heightm: 1.2000000000000002,
		weightkg: 57.25,
		color: "Yellow",
		eggGroups: ["Monster", "Bug"],
	...
	hoohgroudon: {
		...
		name: "hoohgroudon",
		types: ["Fire", "Ground"],
		baseStats: {hp: 104, atk: 143, def: 123, spa: 106, spd: 132, spe: 90},
	...
	sceptileelectrode: {
		...
		abilities: {0: "Overgrow", 1: "Static", H: "Unburden"},
		heightm: 1.45,
		weightkg: 59.4,
		color: "Green",
		eggGroups: ["Mineral", "Monster"],
	...
	charizardhitmonlee: {
		...
		abilities: {0: "Blaze", 1: "Reckless", H: "Solar Power"},
		heightm: 1.6,
		weightkg: 70.15,
		color: "Red",
		eggGroups: ["Human-Like", "Monster"],
	...
	venusaurelectivire: {
		num: 10387,
		name: "venusaurelectivire",
		types: ["Grass", "Electric"],
		baseStats: {hp: 78, atk: 109, def: 72, spa: 98, spd: 95, spe: 90},
		abilities: {0: "Overgrow", 1: "Vital Spirit", H: "Chlorophyll"},
		heightm: 1.9,
		weightkg: 119.3,
		color: "Green",
		eggGroups: ["Human-Like", "Monster"],
	...
	vaporeongroudon: {
		num: 10388,
		name: "vaporeongroudon",
		types: ["Water", "Ground"],
		baseStats: {hp: 120, atk: 121, def: 113, spa: 106, spd: 93, spe: 81},
		abilities: {0: "Water Absorb", 1: "Drought", H: "Hydration"},
		heightm: 2.25,
		weightkg: 489,
		color: "Blue",
		eggGroups: ["Undiscovered", "Field"],
	...
	groudonpyukumuku: {
		num: 10389,
		name: "groudonpyukumuku",
		types: ["Ground", "Water"],
		baseStats: {hp: 85, atk: 90, def: 133, spa: 76, spd: 103, spe: 33},
		abilities: {0: "Drought", 1: "Innards Out", H: "Unaware"},
		heightm: 1.9,
		weightkg: 475.6,
		color: "Red",
		eggGroups: ["Water 1", "Undiscovered"],
	...
	metagrossbreloom: {
		num: 10390,
		name: "metagrossbreloom",
		types: ["Steel", "Fighting"],
		baseStats: {hp: 73, atk: 131, def: 96, spa: 83, spd: 80, spe: 70},
		abilities: {0: "Clear Body", 1: "Poison Heal", H: "Light Metal"},
		heightm: 1.4,
		weightkg: 294.6,
		color: "Blue",
		eggGroups: ["Fairy", "Mineral"],
	...
	hoohmagnezone: {
		...
		name: "hoohmagnezone",
		types: ["Fire", "Electric"],
		baseStats: {hp: 94, atk: 90, def: 106, spa: 116, spd: 132, spe: 70},
	...
	zekrompyukumuku: {
		num: 10394,
		name: "zekrompyukumuku",
		types: ["Dragon", "Water"],
		baseStats: {hp: 85, atk: 90, def: 126, spa: 90, spd: 110, spe: 33},
		abilities: {0: "Teravolt", 1: "Innards Out", H: "Unaware"},
		heightm: 1.5999999999999999,
		weightkg: 173.1,
		color: "Black",
		eggGroups: ["Water 1", "Undiscovered"],
	},
	porygonzkyurem: {
		...
		name: "porygonzkyurem",
		types: ["Normal", "Ice"],
		baseStats: {hp: 98, atk: 113, def: 83, spa: 133, spd: 80, spe: 93},
		abilities: {0: "Adaptability", 1: "Pressure", H: "Analytic"},
		heightm: 1.95,
		weightkg: 179,
		color: "Red",
		eggGroups: ["Undiscovered", "Mineral"],
	...
	blazikenswampert: {
		num: 10397,
		name: "blazikenswampert",
		types: ["Fire", "Ground"],
		baseStats: {hp: 86, atk: 113, def: 83, spa: 101, spd: 76, spe: 66},
		abilities: {0: "Blaze", 1: "Damp", H: "Speed Boost"},
		heightm: 1.7,
		weightkg: 66.95,
		color: "Red",
		eggGroups: ["Monster", "Field"],
	...
	zapdosweezing: {
		...
		name: "zapdosweezing",
		types: ["Electric", "Poison"],
		baseStats: {hp: 81, atk: 90, def: 108, spa: 111, spd: 83, spe: 73},
		abilities: {0: "Pressure", 1: "Neutralizing Gas", H: "Static"},
		heightm: 1.4,
		weightkg: 31.05,
		color: "Yellow",
		eggGroups: ["Amorphous", "Undiscovered"],
	...
	volcaronazoroark: {
		num: 10399,
		name: "volcaronazoroark",
		types: ["Bug", "Dark"],
		baseStats: {hp: 76, atk: 90, def: 61, spa: 130, spd: 90, spe: 103},
		abilities: {0: "Flame Body", 1: "Illusion", H: "Swarm"},
		heightm: 1.6,
		weightkg: 63.55,
		color: "White",
		eggGroups: ["Field", "Bug"],
	...
	scizorgroudon: {
		...
		abilities: {0: "Swarm", 1: "Drought", H: "Light Metal"},
		heightm: 2.65,
		weightkg: 534,
		color: "Red",
		eggGroups: ["Undiscovered", "Bug"],
	...
	tangrowthslaking: {
		...
		abilities: {0: "Chlorophyll", 1: "Truant", H: "Regenerator"},
		heightm: 2,
		weightkg: 129.55,
		color: "Blue",
		eggGroups: ["Field", "Grass"],
	...
	vaporeonumbreon: {
		num: 10402,
		name: "vaporeonumbreon",
		types: ["Water", "Dark"],
		baseStats: {hp: 118, atk: 65, def: 93, spa: 93, spd: 106, spe: 65},
		abilities: {0: "Water Absorb", 1: "Inner Focus", H: "Hydration"},
		heightm: 1,
		weightkg: 28,
		color: "Blue",
		eggGroups: ["Field", "Field"],
	...
	reshiramgardevoir: {
		num: 10403,
		name: "reshiramgardevoir",
		types: ["Dragon", "Fairy"],
		baseStats: {hp: 89, atk: 83, def: 76, spa: 141, spd: 118, spe: 83},
		abilities: {0: "Turboblaze", 1: "Trace", H: "Telepathy"},
		heightm: 2.4000000000000004,
		weightkg: 189.2,
		color: "White",
	...
	crobataerodactyl: {
		num: 10404,
		name: "crobataerodactyl",
		types: ["Poison", "Flying"],
		baseStats: {hp: 83, atk: 100, def: 70, spa: 66, spd: 78, spe: 130},
		abilities: {0: "Inner Focus", 1: "Pressure", H: "Infiltrator"},
		heightm: 1.8,
		weightkg: 67,
		color: "Purple",
		eggGroups: ["Flying", "Flying"],
	...
	kabutopsinfernape: {
		num: 10405,
		name: "kabutopsinfernape",
		types: ["Rock", "Fighting"],
		baseStats: {hp: 65, atk: 107, def: 82, spa: 78, spd: 70, spe: 98},
		abilities: {0: "Swift Swim", 1: "Iron Fist", H: "Weak Armor"},
		heightm: 1.25,
		weightkg: 47.75,
		color: "Brown",
		eggGroups: ["Field", "Water 1"],
	...
	magnezonechandelure: {
		num: 10406,
		name: "magnezonechandelure",
		types: ["Steel", "Fire"],
		baseStats: {hp: 66, atk: 60, def: 98, spa: 135, spd: 90, spe: 73},
		abilities: {0: "Magnet Pull", 1: "Flame Body", H: "Analytic"},
		heightm: 1.1,
		weightkg: 107.15,
		color: "Gray",
		eggGroups: ["Amorphous", "Mineral"],
	...
	chandeluremagnezone: {
		num: 10407,
		name: "chandeluremagnezone",
		types: ["Ghost", "Electric"],
		baseStats: {hp: 63, atk: 65, def: 106, spa: 140, spd: 90, spe: 66},
		abilities: {0: "Flash Fire", 1: "Sturdy", H: "Infiltrator"},
		heightm: 1.1,
		weightkg: 107.15,
		color: "Black",
		eggGroups: ["Mineral", "Amorphous"],
	...
	alakazamgengar: {
		...
		name: "alakazamgengar",
		types: ["Psychic", "Ghost"],
		baseStats: {hp: 56, atk: 60, def: 55, spa: 133, spd: 88, spe: 113},
		abilities: {0: "Synchronize", 1: "Cursed Body", H: "Magic Guard"},
		heightm: 1.5,
		weightkg: 44.25,
		color: "Brown",
		eggGroups: ["Amorphous", "Human-Like"],
	...
	chandelureglaceon: {
		num: 10409,
		name: "chandelureglaceon",
		types: ["Ghost", "Ice"],
		baseStats: {hp: 61, atk: 58, def: 103, spa: 140, spd: 91, spe: 70},
		abilities: {0: "Flash Fire", 1: "Ice Body", H: "Infiltrator"},
		heightm: 0.9,
		weightkg: 30.099999999999998,
		color: "Black",
		eggGroups: ["Field", "Amorphous"],
	},
	dewgongtangrowth: {
		num: 10410,
		name: "dewgongtangrowth",
		types: ["Ice", "Grass"],
		baseStats: {hp: 93, atk: 90, def: 110, spa: 83, spd: 80, spe: 56},
		abilities: {0: "Thick Fat", 1: "Leaf Guard", H: "Ice Body"},
		heightm: 1.85,
		weightkg: 124.3,
		color: "White",
		eggGroups: ["Grass", "Water 1"],
	...
	breloomweavile: {
		...
		name: "breloomweavile",
		types: ["Grass", "Ice"],
		baseStats: {hp: 63, atk: 123, def: 70, spa: 55, spd: 68, spe: 106},
		abilities: {0: "Effect Spore", 1: "Pickpocket", H: "Technician"},
		heightm: 1.15,
		weightkg: 36.6,
		color: "Green",
		eggGroups: ["Field", "Fairy"],
	...
	clefairylugia: {
		...
		name: "clefairylugia",
		types: ["Fairy", "Flying"],
		baseStats: {hp: 82, atk: 75, def: 102, spa: 70, spd: 94, spe: 85},
		abilities: {0: "Cute Charm", 1: "Multiscale", H: "Friend Guard"},
		heightm: 2.9,
		weightkg: 111.75,
		color: "Pink",
		evos: ["Clefable"],
	...
	lugialucario: {
		...
		name: "lugialucario",
		types: ["Psychic", "Steel"],
		baseStats: {hp: 94, atk: 103, def: 90, spa: 98, spd: 126, spe: 96},
	...
	chandelureforretress: {
		num: 10414,
		name: "chandelureforretress",
		types: ["Ghost", "Steel"],
		baseStats: {hp: 65, atk: 78, def: 123, spa: 116, spd: 80, spe: 53},
	...
	typhlosiongenesect: {
		num: 10415,
		name: "typhlosiongenesect",
		types: ["Fire", "Steel"],
		baseStats: {hp: 75, atk: 108, def: 89, spa: 112, spd: 88, spe: 99},
		abilities: {0: "Blaze", 1: "Download", H: "Flash Fire"},
		heightm: 1.6,
		weightkg: 81.0,
		color: "Yellow",
		eggGroups: ["Undiscovered", "Field"],
	...
	weavilescizor: {
		...
		name: "weavilescizor",
		types: ["Dark", "Bug"],
		baseStats: {hp: 70, atk: 126, def: 88, spa: 48, spd: 83, spe: 85},
	...
	rhyperiormachamp: {
		...
		abilities: {0: "Lightning Rod", 1: "No Guard", H: "Reckless"},
		heightm: 2.0,
		weightkg: 206.4,
		color: "Gray",
		eggGroups: ["Human-Like", "Monster"],
	...
	azumarillmamoswine: {
		...
		abilities: {0: "Thick Fat", 1: "Snow Cloak", H: "Sap Sipper"},
		heightm: 1.65,
		weightkg: 159.75,
		color: "Blue",
		eggGroups: ["Field", "Water 1"],
	...
	bidoofarceus: {
		...
		name: "bidoofarceus",
		types: ["Normal"],
		baseStats: {hp: 79, atk: 95, def: 93, spa: 63, spd: 66, spe: 90},
		abilities: {0: "Simple", 1: "Multitype", H: "Moody"},
		heightm: 1.85,
		weightkg: 170,
		color: "Brown",
		evos: ["Bibarel"],
	...
	gengarjolteon: {
		...
		abilities: {0: "Cursed Body", 1: "Volt Absorb", H: "Quick Feet"},
		heightm: 1.15,
		weightkg: 32.5,
		color: "Purple",
		eggGroups: ["Field", "Amorphous"],
	...
	zekromdoublade: {
		...
		name: "zekromdoublade",
		types: ["Dragon", "Ghost"],
		baseStats: {hp: 86, atk: 123, def: 140, spa: 95, spd: 83, spe: 53},
		abilities: {0: "Teravolt", 1: "No Guard", H: ""},
		heightm: 1.85,
		weightkg: 174.75,
		color: "Black",
		evos: ["Aegislash"],
	...
	deoxysgalvantula: {
		num: 10423,
		name: "deoxysgalvantula",
		types: ["Psychic", "Electric"],
		baseStats: {hp: 56, atk: 101, def: 56, spa: 132, spd: 53, spe: 122},
		abilities: {0: "Pressure", 1: "Unnerve", H: "Swarm"},
		heightm: 1.25,
		weightkg: 37.55,
		color: "Red",
		eggGroups: ["Bug", "Undiscovered"],
	...
	klefkiparasect: {
		...
		name: "klefkiparasect",
		types: ["Steel", "Grass"],
		baseStats: {hp: 58, atk: 90, def: 83, spa: 73, spd: 84, spe: 45},
		abilities: {0: "Prankster", 1: "Dry Skin", H: "Magician"},
		heightm: 0.6,
		weightkg: 16.25,
		color: "Gray",
		eggGroups: ["Bug", "Mineral"],
	...
	heracrossscyther: {
		...
		types: ["Bug"],
		baseStats: {hp: 76, atk: 115, def: 78, spa: 45, spd: 90, spe: 98},
	...
	drifblimskarmory: {
		num: 10426,
		name: "drifblimskarmory",
		types: ["Ghost", "Flying"],
		baseStats: {hp: 121, atk: 80, def: 108, spa: 73, spd: 59, spe: 73},
		abilities: {0: "Aftermath", 1: "Sturdy", H: "Flare Boost"},
		heightm: 1.45,
		weightkg: 32.75,
		color: "Purple",
	...
	groudonheracross: {
		num: 10427,
		name: "groudonheracross",
		types: ["Ground", "Fighting"],
		baseStats: {hp: 93, atk: 133, def: 96, spa: 80, spd: 91, spe: 86},
		abilities: {0: "Drought", 1: "Guts", H: "Moxie"},
		heightm: 2.5,
		weightkg: 502,
		color: "Red",
		eggGroups: ["Bug", "Undiscovered"],
	...
	sylveonvolcarona: {
		num: 10428,
		name: "sylveonvolcarona",
		types: ["Fairy", "Fire"],
		baseStats: {hp: 91, atk: 61, def: 65, spa: 118, spd: 121, spe: 86},
		abilities: {0: "Cute Charm", 1: "Swarm", H: "Pixilate"},
		heightm: 1.3,
		weightkg: 34.75,
		color: "Pink",
		eggGroups: ["Bug", "Field"],
	...
	lugiaclefairy: {
		...
		name: "lugiaclefairy",
		types: ["Psychic", "Fairy"],
		baseStats: {hp: 94, atk: 60, def: 75, spa: 80, spd: 124, spe: 60},
		abilities: {0: "Pressure", 1: "Magic Guard", H: "Multiscale"},
		heightm: 2.9,
		weightkg: 111.75,
		color: "White",
		evos: ["Clefable"],
	...
	muklugia: {
		...
		name: "muklugia",
		types: ["Poison", "Flying"],
		baseStats: {hp: 105, atk: 95, def: 111, spa: 73, spd: 118, spe: 90},
		abilities: {0: "Stench", 1: "Multiscale", H: "Poison Touch"},
		heightm: 3.2,
		weightkg: 123,
		color: "Purple",
		eggGroups: ["Undiscovered", "Amorphous"],
	...
	blisseygliscor: {
		...
		name: "blisseygliscor",
		types: ["Normal", "Flying"],
		baseStats: {hp: 195, atk: 66, def: 86, spa: 65, spd: 115, spe: 81},
		abilities: {0: "Natural Cure", 1: "Sand Veil", H: "Healer"},
		heightm: 1.75,
		weightkg: 44.65,
		color: "Pink",
		eggGroups: ["Bug", "Fairy"],
	...
	zoroarkdeoxys: {
		...
		name: "zoroarkdeoxys",
		types: ["Dark", "Psychic"],
		baseStats: {hp: 56, atk: 135, def: 53, spa: 130, spd: 56, spe: 135},
		abilities: {0: "Illusion", 1: "Pressure", H: ""},
		heightm: 1.65,
		weightkg: 70.94999999999999,
		color: "Gray",
		eggGroups: ["Undiscovered", "Field"],
	},
	porygonzmewtwo: {
		...
		name: "porygonzmewtwo",
		types: ["Normal", "Psychic"],
		baseStats: {hp: 92, atk: 100, def: 83, spa: 141, spd: 80, spe: 116},
		abilities: {0: "Adaptability", 1: "Unnerve", H: "Analytic"},
		heightm: 1.45,
		weightkg: 78,
		color: "Red",
		eggGroups: ["Undiscovered", "Mineral"],
	...
	rayquazaklinklang: {
		...
		abilities: {0: "Air Lock", 1: "Minus", H: "Clear Body"},
		heightm: 3.8,
		weightkg: 143.75,
		color: "Green",
		eggGroups: ["Mineral", "Undiscovered"],
	...
	groudonkyogre: {
		...
		abilities: {0: "Drought", 1: "Drizzle", H: ""},
		heightm: 4.0,
		weightkg: 651,
		color: "Red",
		eggGroups: ["Undiscovered", "Undiscovered"],
	...
	ferrothorndusclops: {
		num: 10454,
		name: "ferrothorndusclops",
		types: ["Grass", "Ghost"],
		baseStats: {hp: 62, atk: 78, def: 130, spa: 56, spd: 120, spe: 23},
		abilities: {0: "Iron Barbs", 1: "Frisk", H: "Anticipation"},
		heightm: 1.3,
		weightkg: 70.3,
		color: "Gray",
		evos: ["Dusknoir"],
	...
	raichuninetales: {
		...
		abilities: {0: "Static", 1: "Drought", H: "Lightning Rod"},
	...
	blastoisedrifblim: {
		num: 10456,
		name: "blastoisedrifblim",
		types: ["Water", "Flying"],
		baseStats: {hp: 102, atk: 81, def: 62, spa: 86, spd: 88, spe: 79},
		abilities: {0: "Torrent", 1: "Unburden", H: "Rain Dish"},
		heightm: 1.4,
		weightkg: 50.25,
		color: "Blue",
		eggGroups: ["Amorphous", "Monster"],
	...
	xatushuckle: {
		...
		name: "xatushuckle",
		types: ["Psychic", "Rock"],
		baseStats: {hp: 50, atk: 31, def: 176, spa: 66, spd: 123, spe: 35},
		abilities: {0: "Synchronize", 1: "Gluttony", H: "Magic Bounce"},
		heightm: 1.05,
		weightkg: 17.75,
		color: "Green",
	...
	piplupanorith: {
		...
		name: "piplupanorith",
		types: ["Water", "Bug"],
		baseStats: {hp: 50, atk: 80, def: 51, spa: 54, spd: 54, spe: 63},
		abilities: {0: "Torrent", 1: "Swift Swim", H: "Defiant"},
		heightm: 0.55,
		weightkg: 8.85,
		color: "Blue",
		evos: ["ArmaldoPrinplup"],
		eggGroups: ["Water 3", "Water 1"],
	},
	chandeluretangrowth: {
		num: 10459,
		name: "chandeluretangrowth",
		types: ["Ghost", "Grass"],
		baseStats: {hp: 73, atk: 85, def: 113, spa: 133, spd: 76, spe: 60},
		abilities: {0: "Flash Fire", 1: "Leaf Guard", H: "Infiltrator"},
		heightm: 1,
		weightkg: 81.44999999999999,
		color: "Black",
		eggGroups: ["Grass", "Amorphous"],
	},
	aegislashtangrowth: {
		...
		abilities: {0: "Stance Change", 1: "Leaf Guard", H: "Regenerator"},
		heightm: 1.85,
		weightkg: 90.8,
		color: "Brown",
		eggGroups: ["Grass", "Mineral"],
	...
	metagrosslugia: {
		...
		name: "metagrosslugia",
		types: ["Steel", "Flying"],
		baseStats: {hp: 88, atk: 105, def: 130, spa: 93, spd: 111, spe: 96},
		abilities: {0: "Clear Body", 1: "Multiscale", H: "Light Metal"},
		heightm: 3.4000000000000004,
		weightkg: 383,
		color: "Blue",
		eggGroups: ["Undiscovered", "Mineral"],
	...
	togekisscharizard: {
		...
		abilities: {0: "Hustle", 1: "Solar Power", H: "Super Luck"},
		heightm: 1.6,
		weightkg: 64.25,
		color: "White",
		eggGroups: ["Monster", "Flying"],
	...
	regigigasbreloom: {
		num: 10464,
		name: "regigigasbreloom",
		types: ["Normal", "Fighting"],
		baseStats: {hp: 93, atk: 140, def: 90, spa: 73, spd: 93, spe: 80},
		abilities: {0: "Slow Start", 1: "Poison Heal", H: "Technician"},
		heightm: 2.45,
		weightkg: 229.6,
		color: "White",
		eggGroups: ["Fairy", "Undiscovered"],
	...
	exeggutorreshiram: {
		num: 10465,
		name: "exeggutorreshiram",
		types: ["Grass", "Fire"],
		baseStats: {hp: 96, atk: 111, def: 95, spa: 133, spd: 90, spe: 78},
		abilities: {0: "Chlorophyll", 1: "Turboblaze", H: "Harvest"},
		heightm: 2.6,
		weightkg: 225,
		color: "Yellow",
		eggGroups: ["Undiscovered", "Grass"],
	...
	alakazamjolteon: {
		num: 10466,
		name: "alakazamjolteon",
		types: ["Psychic", "Electric"],
		baseStats: {hp: 58, atk: 60, def: 55, spa: 126, spd: 95, spe: 126},
		abilities: {0: "Synchronize", 1: "Quick Feet", H: "Magic Guard"},
		heightm: 1.15,
		weightkg: 36.25,
		color: "Brown",
		eggGroups: ["Field", "Human-Like"],
	...
	giratinainfernape: {
		num: 10467,
		name: "giratinainfernape",
		types: ["Ghost", "Fighting"],
		baseStats: {hp: 125, atk: 102, def: 87, spa: 101, spd: 103, spe: 102},
		abilities: {0: "Pressure", 1: "Iron Fist", H: "Telepathy"},
		heightm: 2.85,
		weightkg: 402,
		color: "Black",
		eggGroups: ["Field", "Undiscovered"],
	...
	darkraimachamp: {
		...
		name: "darkraimachamp",
		types: ["Dark", "Fighting"],
		baseStats: {hp: 76, atk: 116, def: 83, spa: 111, spd: 88, spe: 78},
		abilities: {0: "Bad Dreams", 1: "No Guard", H: "Steadfast"},
		heightm: 1.55,
		weightkg: 90.25,
		color: "Black",
		eggGroups: ["Human-Like", "Undiscovered"],
	...
	hypnomachamp: {
		...
		name: "hypnomachamp",
		types: ["Psychic", "Fighting"],
		baseStats: {hp: 86, atk: 111, def: 76, spa: 70, spd: 105, spe: 59},
		abilities: {0: "Insomnia", 1: "No Guard", H: "Inner Focus"},
		heightm: 1.6,
		weightkg: 102.8,
		color: "Yellow",
	...
	chanseymuk: {
		...
		name: "chanseymuk",
		types: ["Normal", "Poison"],
		baseStats: {hp: 201, atk: 71, def: 51, spa: 45, spd: 103, spe: 50},
		abilities: {0: "Natural Cure", 1: "Sticky Hold", H: "Healer"},
		heightm: 1.15,
		weightkg: 32.3,
		color: "Pink",
		evos: ["Blissey"],
	...
	lucariomewtwo: {
		...
		name: "lucariomewtwo",
		types: ["Fighting", "Psychic"],
		baseStats: {hp: 82, atk: 110, def: 83, spa: 128, spd: 76, spe: 116},
		abilities: {0: "Steadfast", 1: "Unnerve", H: "Justified"},
		heightm: 1.6,
		weightkg: 88,
		color: "Blue",
		eggGroups: ["Undiscovered", "Field"],
	...
	magnezonevolcarona: {
		num: 10472,
		name: "magnezonevolcarona",
		types: ["Steel", "Fire"],
		baseStats: {hp: 75, atk: 63, def: 81, spa: 131, spd: 95, spe: 86},
		abilities: {0: "Magnet Pull", 1: "Swarm", H: "Analytic"},
		heightm: 1.4,
		weightkg: 113,
		color: "Gray",
		eggGroups: ["Bug", "Mineral"],
	...
	cloysterhaxorus: {
		num: 10473,
		name: "cloysterhaxorus",
		types: ["Water", "Dragon"],
		baseStats: {hp: 58, atk: 129, def: 120, spa: 76, spd: 53, spe: 88},
		abilities: {0: "Shell Armor", 1: "Mold Breaker", H: "Overcoat"},
		heightm: 1.65,
		weightkg: 119.0,
		color: "Purple",
		eggGroups: ["Monster", "Water 3"],
	...
	flygonflareon: {
		...
		name: "flygonflareon",
		types: ["Ground", "Fire"],
		baseStats: {hp: 75, atk: 120, def: 66, spa: 85, spd: 90, spe: 76},
		abilities: {0: "Levitate", 1: "Flash Fire", H: "Guts"},
		heightm: 1.45,
		weightkg: 53,
		color: "Green",
		eggGroups: ["Field", "Bug"],
	...
	snorlaxsteelix: {
		...
		abilities: {0: "Immunity", 1: "Sturdy", H: "Gluttony"},
		heightm: 5.6499999999999995,
		weightkg: 430,
		color: "Black",
		eggGroups: ["Mineral", "Monster"],
	},
	crobathaxorus: {
		...
		name: "crobathaxorus",
		types: ["Poison", "Dragon"],
		baseStats: {hp: 82, atk: 128, def: 86, spa: 66, spd: 76, spe: 108},
		abilities: {0: "Inner Focus", 1: "Mold Breaker", H: "Infiltrator"},
		heightm: 1.8,
		weightkg: 90.25,
		color: "Purple",
		eggGroups: ["Monster", "Flying"],
	...
	haxoruscrobat: {
		...
		name: "haxoruscrobat",
		types: ["Dragon", "Flying"],
		baseStats: {hp: 79, atk: 109, def: 83, spa: 63, spd: 73, spe: 119},
		abilities: {0: "Rivalry", 1: "Infiltrator", H: "Unnerve"},
		heightm: 1.8,
		weightkg: 90.25,
		color: "Yellow",
		eggGroups: ["Flying", "Monster"],
	...
	porygonzchandelure: {
		num: 10478,
		name: "porygonzchandelure",
		types: ["Normal", "Fire"],
		baseStats: {hp: 76, atk: 63, def: 83, spa: 138, spd: 80, spe: 83},
		abilities: {0: "Adaptability", 1: "Flame Body", H: "Analytic"},
		heightm: 0.95,
		weightkg: 34.15,
		color: "Red",
		eggGroups: ["Amorphous", "Mineral"],
	...
	litwickeevee: {
		...
		name: "litwickeevee",
		types: ["Ghost", "Normal"],
		baseStats: {hp: 51, atk: 46, def: 51, spa: 58, spd: 58, spe: 43},
		abilities: {0: "Flash Fire", 1: "Adaptability", H: "Infiltrator"},
		heightm: 0.3,
		weightkg: 4.8,
		color: "White",
		evos: ["VaporeonLampentJolteon"],
		eggGroups: ["Field", "Amorphous"],
	},
	taurosslaking: {
		num: 10480,
		name: "taurosslaking",
		types: ["Normal"],
		baseStats: {hp: 100, atk: 140, def: 98, spa: 58, spd: 68, spe: 103},
		abilities: {0: "Intimidate", 1: "Truant", H: "Sheer Force"},
		heightm: 1.7,
		weightkg: 109.45,
		color: "Brown",
		eggGroups: ["Field", "Field"],
	...
	mantineklefki: {
		...
		name: "mantineklefki",
		types: ["Water", "Fairy"],
		baseStats: {hp: 75, atk: 66, def: 84, spa: 80, spd: 122, spe: 73},
		abilities: {0: "Swift Swim", 1: "Prankster", H: "Water Veil"},
		heightm: 1.1500000000000001,
		weightkg: 111,
		color: "Purple",
		eggGroups: ["Mineral", "Water 1"],
	},
	klefkimantine: {
		...
		name: "klefkimantine",
		types: ["Steel", "Flying"],
		baseStats: {hp: 66, atk: 53, def: 77, spa: 80, spd: 104, spe: 71},
		abilities: {0: "Prankster", 1: "Water Absorb", H: "Magician"},
		heightm: 1.1500000000000001,
		weightkg: 111,
		color: "Gray",
		eggGroups: ["Water 1", "Mineral"],
	...
	gibleponyta: {
		...
		name: "gibleponyta",
		types: ["Dragon", "Fire"],
		baseStats: {hp: 55, atk: 80, def: 51, spa: 48, spd: 51, spe: 74},
		abilities: {0: "Sand Veil", 1: "Flash Fire", H: "Rough Skin"},
		heightm: 0.85,
		weightkg: 25.25,
		color: "Blue",
		evos: ["RapidashGabite"],
	...
	sandslashgallade: {
		num: 10484,
		name: "sandslashgallade",
		types: ["Ground", "Fighting"],
		baseStats: {hp: 72, atk: 116, def: 80, spa: 51, spd: 75, spe: 75},
		abilities: {0: "Sand Veil", 1: "Justified", H: "Sand Rush"},
		heightm: 1.3,
		weightkg: 40.75,
		color: "Yellow",
		eggGroups: ["Human-Like", "Field"],
	...
	dialgamilotic: {
		...
		name: "dialgamilotic",
		types: ["Steel", "Water"],
		baseStats: {hp: 98, atk: 80, def: 92, spa: 133, spd: 108, spe: 84},
		abilities: {0: "Pressure", 1: "Competitive", H: "Telepathy"},
		heightm: 5.800000000000001,
		weightkg: 422,
		color: "White",
		eggGroups: ["Water 1", "Undiscovered"],
	},
	zapdoscloyster: {
		...
		name: "zapdoscloyster",
		types: ["Electric", "Ice"],
		baseStats: {hp: 76, atk: 93, def: 148, spa: 111, spd: 75, spe: 80},
		abilities: {0: "Pressure", 1: "Skill Link", H: "Static"},
		heightm: 1.55,
		weightkg: 92.55,
		color: "Yellow",
		eggGroups: ["Water 3", "Undiscovered"],
	...
	munchlaxhonedge: {
		num: 10487,
		name: "munchlaxhonedge",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 105, atk: 81, def: 80, spa: 38, spd: 69, spe: 20},
		abilities: {0: "Pickup", 1: "No Guard", H: "Gluttony"},
		heightm: 0.7,
		weightkg: 53,
		color: "Black",
		evos: ["DoubladeSnorlax"],
		eggGroups: ["Mineral", "Undiscovered"],
	},
	sandslashdeoxys: {
		num: 10488,
		name: "sandslashdeoxys",
		types: ["Ground", "Psychic"],
		baseStats: {hp: 66, atk: 133, def: 70, spa: 80, spd: 53, spe: 121},
		abilities: {0: "Sand Veil", 1: "Pressure", H: "Sand Rush"},
		heightm: 1.35,
		weightkg: 45.15,
		color: "Yellow",
		eggGroups: ["Undiscovered", "Field"],
	...
	umbreonmantine: {
		...
		name: "umbreonmantine",
		types: ["Dark", "Flying"],
		baseStats: {hp: 91, atk: 48, def: 83, spa: 66, spd: 133, spe: 68},
		abilities: {0: "Synchronize", 1: "Water Absorb", H: "Inner Focus"},
		heightm: 1.55,
		weightkg: 123,
		color: "Black",
		eggGroups: ["Water 1", "Field"],
	...
	magnemitenatu: {
		...
		name: "magnemitenatu",
		types: ["Steel", "Flying"],
		baseStats: {hp: 30, atk: 45, def: 53, spa: 86, spd: 51, spe: 61},
		abilities: {0: "Magnet Pull", 1: "Early Bird", H: "Analytic"},
		heightm: 0.25,
		weightkg: 4,
		color: "Gray",
		evos: ["XatuMagneton"],
	...
	tyranitarhooh: {
		...
		name: "tyranitarhooh",
		types: ["Rock", "Flying"],
		baseStats: {hp: 102, atk: 131, def: 96, spa: 100, spd: 118, spe: 80},
		abilities: {0: "Sand Stream", 1: "Regenerator", H: "Unnerve"},
		heightm: 2.9,
		weightkg: 200,
		color: "Green",
		eggGroups: ["Undiscovered", "Monster"],
	...
	bisharpzekrom: {
		...
		name: "bisharpzekrom",
		types: ["Dark", "Electric"],
		baseStats: {hp: 76, atk: 141, def: 113, spa: 80, spd: 80, spe: 83},
		abilities: {0: "Defiant", 1: "Teravolt", H: "Pressure"},
		heightm: 2.25,
		weightkg: 207,
		color: "Red",
		eggGroups: ["Undiscovered", "Human-Like"],
	...
	chandeluregardevoir: {
		num: 10493,
		name: "chandeluregardevoir",
		types: ["Ghost", "Fairy"],
		baseStats: {hp: 62, atk: 61, def: 73, spa: 138, spd: 98, spe: 80},
		abilities: {0: "Flash Fire", 1: "Trace", H: "Infiltrator"},
		heightm: 1.3,
		weightkg: 41.349999999999994,
		color: "Black",
		eggGroups: ["Human-Like", "Amorphous"],
	},
	houndourkoffing: {
		num: 10494,
		name: "houndourkoffing",
		types: ["Dark", "Poison"],
		baseStats: {hp: 43, atk: 63, def: 73, spa: 73, spd: 48, spe: 45},
		abilities: {0: "Early Bird", 1: "Neutralizing Gas", H: "Unnerve"},
		heightm: 0.6,
		weightkg: 5.9,
		color: "Black",
		evos: ["WeezingHoundoomWeezing-Galar"],
		eggGroups: ["Amorphous", "Field"],
	},
	gyaradosabsol: {
		num: 10495,
		name: "gyaradosabsol",
		types: ["Water", "Dark"],
		baseStats: {hp: 85, atk: 128, def: 66, spa: 65, spd: 86, spe: 77},
	...
	celebityranitar: {
		num: 10496,
		name: "celebityranitar",
		types: ["Psychic", "Dark"],
		baseStats: {hp: 100, atk: 122, def: 106, spa: 98, spd: 100, spe: 74},
		abilities: {0: "Natural Cure", 1: "Sand Stream", H: "Unnerve"},
		heightm: 1.3,
		weightkg: 103,
		color: "Green",
		eggGroups: ["Monster", "Undiscovered"],
	...
	machampmew: {
		...
		name: "machampmew",
		types: ["Fighting", "Psychic"],
		baseStats: {hp: 93, atk: 110, def: 93, spa: 76, spd: 90, spe: 85},
		abilities: {0: "Guts", 1: "Synchronize", H: "Steadfast"},
		heightm: 1.0,
		weightkg: 67,
		color: "Gray",
		eggGroups: ["Undiscovered", "Human-Like"],
	...
	mewmachamp: {
		...
		name: "mewmachamp",
		types: ["Psychic", "Fighting"],
		baseStats: {hp: 96, atk: 120, def: 86, spa: 88, spd: 95, spe: 70},
		abilities: {0: "Synchronize", 1: "No Guard", H: "Steadfast"},
		heightm: 1.0,
		weightkg: 67,
		color: "Pink",
		eggGroups: ["Human-Like", "Undiscovered"],
	...
	whimsicottmew: {
		...
		name: "whimsicottmew",
		types: ["Grass", "Psychic"],
		baseStats: {hp: 73, atk: 89, def: 95, spa: 84, spd: 83, spe: 105},
		abilities: {0: "Prankster", 1: "Synchronize", H: "Chlorophyll"},
		heightm: 0.55,
		weightkg: 5.3,
		color: "Green",
		eggGroups: ["Undiscovered", "Fairy"],
	...
	houndourtogepi: {
		...
		name: "houndourtogepi",
		types: ["Dark", "Fairy"],
		baseStats: {hp: 41, atk: 33, def: 53, spa: 66, spd: 55, spe: 35},
		abilities: {0: "Early Bird", 1: "Serene Grace", H: "Unnerve"},
		heightm: 0.44999999999999996,
		weightkg: 6.15,
		color: "Black",
		evos: ["TogeticHoundoom"],
		eggGroups: ["Undiscovered", "Field"],
	},
	giratinaglaceon: {
		num: 10501,
		name: "giratinaglaceon",
		types: ["Ghost", "Ice"],
		baseStats: {hp: 121, atk: 73, def: 113, spa: 110, spd: 111, spe: 73},
		abilities: {0: "Pressure", 1: "Ice Body", H: "Telepathy"},
		heightm: 2.65,
		weightkg: 387.95,
		color: "Black",
		eggGroups: ["Field", "Undiscovered"],
	...
	luxrayweavile: {
		...
		name: "luxrayweavile",
		types: ["Electric", "Ice"],
		baseStats: {hp: 76, atk: 120, def: 69, spa: 78, spd: 81, spe: 106},
		abilities: {0: "Rivalry", 1: "Pickpocket", H: "Guts"},
		heightm: 1.25,
		weightkg: 38,
		color: "Blue",
		eggGroups: ["Field", "Field"],
	...
	bulbasaurvulpix: {
		num: 10503,
		name: "bulbasaurvulpix",
		types: ["Grass", "Fire"],
		baseStats: {hp: 42, atk: 43, def: 43, spa: 60, spd: 65, spe: 58},
		abilities: {0: "Overgrow", 1: "Drought", H: "Chlorophyll"},
		heightm: 0.6499999999999999,
		weightkg: 8.4,
		color: "Green",
		evos: ["NinetalesIvysaur"],
		eggGroups: ["Field", "Monster"],
	},
	koffinggligar: {
		num: 10504,
		name: "koffinggligar",
		types: ["Poison", "Flying"],
		baseStats: {hp: 48, atk: 71, def: 101, spa: 51, spd: 51, spe: 68},
		abilities: {0: "Levitate", 1: "Sand Veil", H: "Stench"},
		heightm: 0.8500000000000001,
		weightkg: 32.9,
		color: "Purple",
		evos: ["GliscorWeezingWeezing-Galar"],
		eggGroups: ["Bug", "Amorphous"],
	},
	poliwagparas: {
		num: 10505,
		name: "poliwagparas",
		types: ["Water", "Grass"],
		baseStats: {hp: 38, atk: 63, def: 50, spa: 41, spd: 45, spe: 46},
		abilities: {0: "Water Absorb", 1: "Dry Skin", H: "Swift Swim"},
		heightm: 0.44999999999999996,
		weightkg: 8.9,
		color: "Blue",
		evos: ["ParasectPoliwhirl"],
	...
	elekidsneasel: {
		...
		name: "elekidsneasel",
		types: ["Electric", "Ice"],
		baseStats: {hp: 48, atk: 84, def: 49, spa: 55, spd: 61, spe: 108},
		abilities: {0: "Static", 1: "Keen Eye", H: "Vital Spirit"},
		heightm: 0.75,
		weightkg: 25.75,
		color: "Yellow",
		evos: ["WeavileElectabuzz"],
		eggGroups: ["Field", "Undiscovered"],
	},
	cuboneshellder: {
		num: 10507,
		name: "cuboneshellder",
		types: ["Ground", "Water"],
		baseStats: {hp: 43, atk: 60, def: 98, spa: 41, spd: 41, spe: 38},
		abilities: {0: "Rock Head", 1: "Skill Link", H: "Battle Armor"},
		heightm: 0.35,
		weightkg: 5.25,
		color: "Brown",
		evos: ["CloysterMarowakMarowak-Alola"],
		eggGroups: ["Water 3", "Monster"],
	},
	mantykelickitung: {
		num: 10508,
		name: "mantykelickitung",
		types: ["Water", "Normal"],
		baseStats: {hp: 60, atk: 43, def: 66, spa: 60, spd: 105, spe: 36},
		abilities: {0: "Swift Swim", 1: "Oblivious", H: "Water Veil"},
		heightm: 1.1,
		weightkg: 65.25,
		color: "Blue",
		evos: ["LickilickyMantine"],
		eggGroups: ["Monster", "Undiscovered"],
	},
	happinyhonedge: {
		num: 10509,
		name: "happinyhonedge",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 81, atk: 55, def: 68, spa: 21, spd: 55, spe: 28},
		abilities: {0: "Natural Cure", 1: "No Guard", H: "Friend Guard"},
		heightm: 0.7,
		weightkg: 13.2,
		color: "Pink",
		evos: ["DoubladeChansey"],
		eggGroups: ["Mineral", "Undiscovered"],
	},
	cyndaquillitwick: {
		num: 10510,
		name: "cyndaquillitwick",
		types: ["Fire", "Ghost"],
		baseStats: {hp: 42, atk: 37, def: 51, spa: 61, spd: 51, spe: 35},
	...
	tentacooltangela: {
		num: 10511,
		name: "tentacooltangela",
		types: ["Water", "Grass"],
		baseStats: {hp: 48, atk: 50, def: 88, spa: 66, spd: 80, spe: 63},
		abilities: {0: "Clear Body", 1: "Leaf Guard", H: "Rain Dish"},
		heightm: 0.95,
		weightkg: 40.25,
		color: "Blue",
		evos: ["TangrowthTentacruel"],
		eggGroups: ["Grass", "Water 3"],
	},
	lickitungduskull: {
		num: 10512,
		name: "lickitungduskull",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 66, atk: 45, def: 85, spa: 50, spd: 80, spe: 26},
		abilities: {0: "Own Tempo", 1: "Frisk", H: "Cloud Nine"},
		heightm: 1.0,
		weightkg: 40.25,
		color: "Pink",
		evos: ["DusclopsLickilicky"],
		eggGroups: ["Amorphous", "Monster"],
	},
	totodileparas: {
		num: 10513,
		name: "totodileparas",
		types: ["Water", "Grass"],
		baseStats: {hp: 45, atk: 68, def: 58, spa: 44, spd: 50, spe: 31},
		abilities: {0: "Torrent", 1: "Dry Skin", H: "Sheer Force"},
		heightm: 0.44999999999999996,
		weightkg: 7.45,
		color: "Blue",
		evos: ["ParasectCroconaw"],
		eggGroups: ["Bug", "Monster"],
	},
	piplupsmoochum: {
		num: 10514,
		name: "piplupsmoochum",
		types: ["Water", "Psychic"],
		baseStats: {hp: 50, atk: 37, def: 27, spa: 69, spd: 59, spe: 56},
		abilities: {0: "Torrent", 1: "Forewarn", H: "Defiant"},
		heightm: 0.4,
		weightkg: 5.6,
		color: "Blue",
		evos: ["JynxPrinplup"],
	...
	snubbullmachop: {
		...
		name: "snubbullmachop",
		types: ["Fairy", "Fighting"],
		baseStats: {hp: 63, atk: 80, def: 50, spa: 38, spd: 38, spe: 33},
		abilities: {0: "Intimidate", 1: "No Guard", H: "Rattled"},
		heightm: 0.7,
		weightkg: 13.65,
		color: "Pink",
		evos: ["MachokeGranbull"],
		eggGroups: ["Human-Like", "Field"],
	},
	gastlyvulpix: {
		num: 10516,
		name: "gastlyvulpix",
		types: ["Ghost", "Fire"],
		baseStats: {hp: 32, atk: 39, def: 36, spa: 83, spd: 45, spe: 70},
		abilities: {0: "Levitate", 1: "Flash Fire", H: "Drought"},
		heightm: 0.95,
		weightkg: 5.0,
		color: "Purple",
		evos: ["NinetalesHaunter"],
		eggGroups: ["Field", "Amorphous"],
	},
	litwickmagnemite: {
		num: 10517,
		name: "litwickmagnemite",
		types: ["Ghost", "Electric"],
		baseStats: {hp: 41, atk: 33, def: 65, spa: 75, spd: 55, spe: 36},
		abilities: {0: "Flash Fire", 1: "Sturdy", H: "Infiltrator"},
		heightm: 0.3,
		weightkg: 4.55,
		color: "White",
		evos: ["MagnetonLampent"],
		eggGroups: ["Mineral", "Amorphous"],
	},
	eeveecranidos: {
		num: 10518,
		name: "eeveecranidos",
		types: ["Normal", "Rock"],
		baseStats: {hp: 59, atk: 101, def: 43, spa: 40, spd: 53, spe: 57},
		abilities: {0: "Run Away", 1: "Sheer Force", H: "Anticipation"},
		heightm: 0.6,
		weightkg: 19.0,
		color: "Brown",
		evos: ["RampardosVaporeonJolteon"],
		eggGroups: ["Monster", "Field"],
	},
	cranidoseevee: {
		num: 10519,
		name: "cranidoseevee",
		types: ["Rock", "Normal"],
		baseStats: {hp: 63, atk: 78, def: 46, spa: 35, spd: 41, spe: 56},
		abilities: {0: "Mold Breaker", 1: "Adaptability", H: "Sheer Force"},
		heightm: 0.6,
		weightkg: 19.0,
		color: "Blue",
		evos: ["VaporeonRampardosJolteon"],
		eggGroups: ["Field", "Monster"],
	},
	misdreavusgrimer: {
		num: 10520,
		name: "misdreavusgrimer",
		types: ["Ghost", "Poison"],
		baseStats: {hp: 66, atk: 73, def: 53, spa: 70, spd: 73, spe: 45},
		abilities: {0: "Levitate", 1: "Sticky Hold", H: "Poison Touch"},
		heightm: 0.8,
		weightkg: 15,
		color: "Gray",
		evos: ["MukMismagius"],
	...
	treeckoomanyte: {
		...
		name: "treeckoomanyte",
		types: ["Grass", "Rock"],
		baseStats: {hp: 38, atk: 41, def: 78, spa: 73, spd: 55, spe: 46},
		abilities: {0: "Overgrow", 1: "Shell Armor", H: "Unburden"},
		heightm: 0.45,
		weightkg: 6.25,
		color: "Green",
		evos: ["OmastarGrovyle"],
	...
	koffingmagnemite: {
		num: 10522,
		name: "koffingmagnemite",
		types: ["Poison", "Electric"],
		baseStats: {hp: 35, atk: 45, def: 78, spa: 71, spd: 48, spe: 41},
		abilities: {0: "Levitate", 1: "Sturdy", H: "Stench"},
		heightm: 0.44999999999999996,
		weightkg: 3,
		color: "Purple",
		evos: ["MagnetonWeezingWeezing-Galar"],
		eggGroups: ["Mineral", "Amorphous"],
	},
	sneaselazurill: {
		num: 10523,
		name: "sneaselazurill",
		types: ["Dark", "Fairy"],
		baseStats: {hp: 53, atk: 45, def: 45, spa: 30, spd: 63, spe: 51},
		abilities: {0: "Inner Focus", 1: "Huge Power", H: "Pickpocket"},
		heightm: 0.55,
		weightkg: 15,
		color: "Black",
		evos: ["MarillWeavile"],
	...
	ekansyanma: {
		...
		name: "ekansyanma",
		types: ["Poison", "Flying"],
		baseStats: {hp: 45, atk: 63, def: 44, spa: 51, spd: 51, spe: 81},
	...
	deinohonedge: {
		...
		name: "deinohonedge",
		types: ["Dark", "Ghost"],
		baseStats: {hp: 49, atk: 75, def: 83, spa: 41, spd: 45, spe: 31},
		abilities: {0: "Hustle", 1: "No Guard", H: ""},
		heightm: 0.8,
		weightkg: 9.65,
		color: "Blue",
		evos: ["DoubladeZweilous"],
		eggGroups: ["Mineral", "Dragon"],
	},
	meowthpawniard: {
		num: 10526,
		name: "meowthpawniard",
		types: ["Normal", "Steel"],
		baseStats: {hp: 41, atk: 71, def: 58, spa: 40, spd: 40, spe: 70},
		abilities: {0: "Pickup", 1: "Inner Focus", H: "Unnerve"},
		heightm: 0.45,
		weightkg: 7.199999999999999,
		color: "Yellow",
		evos: ["BisharpPersian"],
		eggGroups: ["Human-Like", "Field"],
	},
	goldeendoduo: {
		...
		name: "goldeendoduo",
		types: ["Water", "Flying"],
		baseStats: {hp: 41, atk: 79, def: 50, spa: 35, spd: 45, spe: 71},
	...
	smoochumelekid: {
		...
		name: "smoochumelekid",
		types: ["Ice", "Electric"],
		baseStats: {hp: 45, atk: 52, def: 29, spa: 78, spd: 61, spe: 85},
		abilities: {0: "Oblivious", 1: "Vital Spirit", H: "Hydration"},
		heightm: 0.5,
		weightkg: 14.75,
		color: "Pink",
		evos: ["ElectabuzzJynx"],
	...
	togepislowpoke: {
		...
		name: "togepislowpoke",
		types: ["Fairy", "Psychic"],
		baseStats: {hp: 53, atk: 50, def: 65, spa: 40, spd: 56, spe: 16},
		abilities: {0: "Hustle", 1: "Own Tempo", H: "Super Luck"},
		heightm: 0.75,
		weightkg: 18.75,
		color: "White",
		evos: ["SlowbroTogeticSlowking"],
		eggGroups: ["Monster", "Undiscovered"],
	},
	smoochumhorsea: {
		num: 10530,
		name: "smoochumhorsea",
		types: ["Ice", "Water"],
		baseStats: {hp: 40, atk: 36, def: 51, spa: 80, spd: 51, spe: 61},
		abilities: {0: "Oblivious", 1: "Sniper", H: "Hydration"},
		heightm: 0.4,
		weightkg: 7,
		color: "Pink",
		evos: ["SeadraJynx"],
	...
	mimejrstaryu: {
		...
		name: "mimejrstaryu",
		types: ["Psychic", "Water"],
		baseStats: {hp: 23, atk: 38, def: 51, spa: 70, spd: 78, spe: 76},
		abilities: {0: "Soundproof", 1: "Natural Cure", H: "Technician"},
		heightm: 0.7,
		weightkg: 23.75,
		color: "Pink",
		evos: ["StarmieMr. MimeMr. Mime-Galar"],
		eggGroups: ["Water 3", "Undiscovered"],
	},
	dratinieevee: {
		num: 10532,
		name: "dratinieevee",
		types: ["Dragon", "Normal"],
		baseStats: {hp: 45, atk: 58, def: 48, spa: 48, spd: 55, spe: 53},
		abilities: {0: "Shed Skin", 1: "Adaptability", H: "Marvel Scale"},
		heightm: 1.05,
		weightkg: 4.9,
		color: "Blue",
		evos: ["VaporeonDragonairJolteon"],
		eggGroups: ["Field", "Water 1"],
	},
	mantykeshieldon: {
		num: 10533,
		name: "mantykeshieldon",
		types: ["Water", "Steel"],
		baseStats: {hp: 40, atk: 34, def: 95, spa: 54, spd: 109, spe: 36},
		abilities: {0: "Swift Swim", 1: "Soundproof", H: "Water Veil"},
		heightm: 0.75,
		weightkg: 61,
		color: "Blue",
		evos: ["BastiodonMantine"],
		eggGroups: ["Monster", "Undiscovered"],
	},
	bidoofshellder: {
		num: 10534,
		name: "bidoofshellder",
		types: ["Normal", "Water"],
		baseStats: {hp: 49, atk: 58, def: 80, spa: 38, spd: 35, spe: 37},
		abilities: {0: "Simple", 1: "Skill Link", H: "Moody"},
		heightm: 0.4,
		weightkg: 12,
		color: "Brown",
		evos: ["CloysterBibarel"],
		eggGroups: ["Water 3", "Water 1"],
	},
	torchicmagby: {
		num: 10535,
		name: "torchicmagby",
		types: ["Fire"],
		baseStats: {hp: 45, atk: 70, def: 38, spa: 70, spd: 51, spe: 70},
		abilities: {0: "Blaze", 1: "Vital Spirit", H: "Speed Boost"},
		heightm: 0.55,
		weightkg: 11.95,
		color: "Red",
		evos: ["MagmarCombusken"],
		eggGroups: ["Undiscovered", "Field"],
	},
	yanmaekans: {
		num: 10536,
		name: "yanmaekans",
		types: ["Bug", "Poison"],
		baseStats: {hp: 55, atk: 61, def: 44, spa: 63, spd: 48, spe: 68},
		abilities: {0: "Speed Boost", 1: "Shed Skin", H: "Frisk"},
		heightm: 1.6,
		weightkg: 22.45,
		color: "Red",
		evos: ["ArbokYanmega"],
	...
	clefableferrothorn: {
		num: 10537,
		name: "clefableferrothorn",
		types: ["Fairy", "Steel"],
		baseStats: {hp: 88, atk: 86, def: 111, spa: 81, spd: 98, spe: 33},
		abilities: {0: "Cute Charm", 1: "Anticipation", H: "Unaware"},
		heightm: 1.15,
		weightkg: 75,
		color: "Pink",
		eggGroups: ["Grass", "Fairy"],
	...
	suicunecradily: {
		...
		name: "suicunecradily",
		types: ["Water", "Grass"],
		baseStats: {hp: 95, atk: 79, def: 103, spa: 87, spd: 112, spe: 57},
		abilities: {0: "Pressure", 1: "Storm Drain", H: "Inner Focus"},
		heightm: 1.75,
		weightkg: 123.7,
		color: "Blue",
		eggGroups: ["Water 3", "Undiscovered"],
	...
	gardevoirzekrom: {
		num: 10539,
		name: "gardevoirzekrom",
		types: ["Psychic", "Electric"],
		baseStats: {hp: 78, atk: 121, def: 101, spa: 123, spd: 110, spe: 86},
		abilities: {0: "Synchronize", 1: "Teravolt", H: "Telepathy"},
		heightm: 2.25,
		weightkg: 196.7,
		color: "White",
		eggGroups: ["Undiscovered", "Human-Like"],
	...
	porygonzflygon: {
		...
		name: "porygonzflygon",
		types: ["Normal", "Dragon"],
		baseStats: {hp: 83, atk: 93, def: 76, spa: 116, spd: 76, spe: 96},
		abilities: {0: "Adaptability", 1: "Levitate", H: "Analytic"},
		heightm: 1.45,
		weightkg: 58,
		color: "Red",
		eggGroups: ["Bug", "Mineral"],
	...
	espeonumbreon: {
		...
		name: "espeonumbreon",
		types: ["Psychic", "Dark"],
		baseStats: {hp: 75, atk: 65, def: 93, spa: 106, spd: 106, spe: 80},
	...
	blazikensteelix: {
		num: 10542,
		name: "blazikensteelix",
		types: ["Fire", "Steel"],
		baseStats: {hp: 78, atk: 96, def: 156, spa: 91, spd: 68, spe: 46},
		abilities: {0: "Blaze", 1: "Sturdy", H: "Speed Boost"},
		heightm: 5.55,
		weightkg: 226,
		color: "Red",
		eggGroups: ["Mineral", "Field"],
	...
	palkiaclefable: {
		...
		abilities: {0: "Pressure", 1: "Magic Guard", H: "Telepathy"},
		heightm: 2.75,
		weightkg: 188,
		color: "Purple",
		eggGroups: ["Fairy", "Undiscovered"],
	...
	palkiaroserade: {
		...
		name: "palkiaroserade",
		types: ["Water", "Poison"],
		baseStats: {hp: 80, atk: 86, def: 76, spa: 141, spd: 115, spe: 93},
		abilities: {0: "Pressure", 1: "Poison Point", H: "Telepathy"},
		heightm: 2.5500000000000003,
		weightkg: 175.25,
		color: "Purple",
		eggGroups: ["Fairy", "Undiscovered"],
	},
	omastardarkrai: {
		...
		name: "omastardarkrai",
		types: ["Water", "Dark"],
		baseStats: {hp: 70, atk: 80, def: 101, spa: 121, spd: 76, spe: 101},
		abilities: {0: "Swift Swim", 1: "Bad Dreams", H: "Weak Armor"},
		heightm: 1.25,
		weightkg: 42.75,
		color: "Blue",
		eggGroups: ["Undiscovered", "Water 1"],
	...
	alakazamlucario: {
		num: 10547,
		name: "alakazamlucario",
		types: ["Psychic", "Steel"],
		baseStats: {hp: 60, atk: 90, def: 61, spa: 128, spd: 86, spe: 100},
		abilities: {0: "Synchronize", 1: "Inner Focus", H: "Magic Guard"},
		heightm: 1.35,
		weightkg: 51,
		color: "Brown",
	...
	roseradeinfernape: {
		num: 10548,
		name: "roseradeinfernape",
		types: ["Grass", "Fighting"],
		baseStats: {hp: 65, atk: 92, def: 69, spa: 118, spd: 93, spe: 102},
		abilities: {0: "Natural Cure", 1: "Iron Fist", H: "Technician"},
		heightm: 1.05,
		weightkg: 34.75,
		color: "Green",
		eggGroups: ["Field", "Fairy"],
	...
	miltankprimeape: {
		num: 10549,
		name: "miltankprimeape",
		types: ["Normal", "Fighting"],
		baseStats: {hp: 85, atk: 96, def: 75, spa: 46, spd: 70, spe: 96},
		abilities: {0: "Thick Fat", 1: "Anger Point", H: "Sap Sipper"},
		heightm: 1.1,
		weightkg: 53.75,
		color: "Pink",
		eggGroups: ["Field", "Field"],
	...
	clefabledusclops: {
		num: 10550,
		name: "clefabledusclops",
		types: ["Fairy", "Ghost"],
		baseStats: {hp: 76, atk: 70, def: 111, spa: 83, spd: 103, spe: 36},
		abilities: {0: "Cute Charm", 1: "Frisk", H: "Unaware"},
		heightm: 1.4500000000000002,
		weightkg: 35.3,
		color: "Pink",
		evos: ["Dusknoir"],
	...
	volcaronaalakazam: {
		num: 10551,
		name: "volcaronaalakazam",
		types: ["Bug", "Psychic"],
		baseStats: {hp: 75, atk: 53, def: 51, spa: 135, spd: 101, spe: 113},
		abilities: {0: "Flame Body", 1: "Inner Focus", H: "Swarm"},
		heightm: 1.55,
		weightkg: 47,
		color: "White",
		eggGroups: ["Human-Like", "Bug"],
	...
	arceusflygon: {
		...
		name: "arceusflygon",
		types: ["Normal", "Dragon"],
		baseStats: {hp: 106, atk: 106, def: 93, spa: 106, spd: 106, spe: 106},
		abilities: {0: "Multitype", 1: "Levitate", H: ""},
		heightm: 2.6,
		weightkg: 201,
		color: "White",
		eggGroups: ["Bug", "Undiscovered"],
	...
	misdreavuslileep: {
		num: 10553,
		name: "misdreavuslileep",
		types: ["Ghost", "Grass"],
		baseStats: {hp: 62, atk: 47, def: 71, spa: 77, spd: 85, spe: 43},
		abilities: {0: "Levitate", 1: "Suction Cups", H: "Storm Drain"},
		heightm: 0.85,
		weightkg: 12.4,
		color: "Gray",
		evos: ["CradilyMismagius"],
		eggGroups: ["Water 3", "Amorphous"],
	},
	tyranitarrhyperior: {
		num: 10554,
		name: "tyranitarrhyperior",
		types: ["Rock", "Ground"],
		baseStats: {hp: 105, atk: 138, def: 123, spa: 81, spd: 85, spe: 47},
	...
	deoxyshonchkrow: {
		num: 10555,
		name: "deoxyshonchkrow",
		types: ["Psychic", "Flying"],
		baseStats: {hp: 66, atk: 133, def: 51, spa: 135, spd: 50, spe: 97},
		abilities: {0: "Pressure", 1: "Super Luck", H: "Moxie"},
		heightm: 1.3,
		weightkg: 44.05,
		color: "Red",
	...
	honchkrowdusknoir: {
		num: 10556,
		name: "honchkrowdusknoir",
		types: ["Dark", "Ghost"],
		baseStats: {hp: 81, atk: 108, def: 107, spa: 91, spd: 79, spe: 53},
		abilities: {0: "Insomnia", 1: "Frisk", H: "Moxie"},
		heightm: 1.55,
		weightkg: 66.95,
		color: "Black",
		eggGroups: ["Amorphous", "Flying"],
	...
	dragoniteaggron: {
		...
		abilities: {0: "Inner Focus", 1: "Rock Head", H: "Multiscale"},
		heightm: 2.1500000000000004,
		weightkg: 285,
		color: "Brown",
		eggGroups: ["Monster", "Water 1"],
	},
	mewsalamence: {
		...
		name: "mewsalamence",
		types: ["Psychic", "Flying"],
		baseStats: {hp: 98, atk: 123, def: 86, spa: 103, spd: 93, spe: 100},
		abilities: {0: "Synchronize", 1: "Intimidate", H: "Moxie"},
		heightm: 0.95,
		weightkg: 53.3,
		color: "Pink",
	...
	roseradearticuno: {
		num: 10559,
		name: "roseradearticuno",
		types: ["Grass", "Ice"],
		baseStats: {hp: 70, atk: 80, def: 88, spa: 115, spd: 111, spe: 86},
		abilities: {0: "Natural Cure", 1: "Snow Cloak", H: "Technician"},
		heightm: 1.3,
		weightkg: 34.95,
		color: "Green",
		eggGroups: ["Undiscovered", "Fairy"],
	...
	cradilygroudon: {
		...
		name: "cradilygroudon",
		types: ["Rock", "Ground"],
		baseStats: {hp: 90, atk: 127, def: 125, spa: 87, spd: 101, spe: 74},
		abilities: {0: "Suction Cups", 1: "Drought", H: "Storm Drain"},
		heightm: 2.5,
		weightkg: 505.2,
		color: "Green",
	...
	volcaronagardevoir: {
		num: 10561,
		name: "volcaronagardevoir",
		types: ["Bug", "Fairy"],
		baseStats: {hp: 79, atk: 63, def: 65, spa: 131, spd: 108, spe: 86},
		abilities: {0: "Flame Body", 1: "Trace", H: "Swarm"},
		heightm: 1.6,
		weightkg: 47.2,
		color: "White",
		eggGroups: ["Human-Like", "Bug"],
	...
	breloomklinklang: {
		num: 10562,
		name: "breloomklinklang",
		types: ["Grass", "Steel"],
		baseStats: {hp: 60, atk: 110, def: 103, spa: 63, spd: 68, spe: 83},
		abilities: {0: "Effect Spore", 1: "Minus", H: "Technician"},
		heightm: 0.8999999999999999,
		weightkg: 60.1,
		color: "Green",
		eggGroups: ["Mineral", "Fairy"],
	...
	gyaradoshooh: {
		...
		name: "gyaradoshooh",
		types: ["Water", "Flying"],
		baseStats: {hp: 98, atk: 128, def: 86, spa: 76, spd: 118, spe: 87},
		abilities: {0: "Intimidate", 1: "Regenerator", H: "Moxie"},
		heightm: 5.15,
		weightkg: 217,
		color: "Blue",
		eggGroups: ["Undiscovered", "Water 2"],
	...
	elekidcranidos: {
		...
		name: "elekidcranidos",
		types: ["Electric", "Rock"],
		baseStats: {hp: 52, atk: 104, def: 39, spa: 53, spd: 46, spe: 70},
		abilities: {0: "Static", 1: "Sheer Force", H: "Vital Spirit"},
		heightm: 0.75,
		weightkg: 27.5,
		color: "Yellow",
		evos: ["RampardosElectabuzz"],
		eggGroups: ["Monster", "Undiscovered"],
	},
	giratinaarceus: {
		num: 10565,
		name: "giratinaarceus",
		types: ["Ghost", "Normal"],
		baseStats: {hp: 140, atk: 113, def: 120, spa: 106, spd: 120, spe: 110},
		abilities: {0: "Pressure", 1: "Multitype", H: "Telepathy"},
		heightm: 3.85,
		weightkg: 535,
		color: "Black",
		eggGroups: ["Undiscovered", "Undiscovered"],
	...
	porygonzdeoxys: {
		...
		name: "porygonzdeoxys",
		types: ["Normal", "Psychic"],
		baseStats: {hp: 73, atk: 126, def: 56, spa: 140, spd: 66, spe: 130},
		abilities: {0: "Adaptability", 1: "Pressure", H: "Analytic"},
		heightm: 1.3,
		weightkg: 47.4,
		color: "Red",
	...
	abravoltorb: {
		...
		name: "abravoltorb",
		types: ["Psychic", "Electric"],
		baseStats: {hp: 30, atk: 26, def: 38, spa: 88, spd: 55, spe: 96},
		abilities: {0: "Synchronize", 1: "Static", H: "Magic Guard"},
		heightm: 0.7,
		weightkg: 14.95,
		color: "Brown",
		evos: ["ElectrodeKadabra"],
		eggGroups: ["Mineral", "Human-Like"],
	},
	porygon2dusclops: {
		num: 10568,
		name: "porygon2dusclops",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 70, atk: 73, def: 116, spa: 90, spd: 106, spe: 36},
		abilities: {0: "Trace", 1: "Frisk", H: "Analytic"},
		heightm: 1.1,
		weightkg: 31.55,
		color: "Red",
		evos: ["DusknoirPorygon-Z"],
		eggGroups: ["Amorphous", "Mineral"],
	},
	articunozekrom: {
		num: 10569,
		name: "articunozekrom",
		types: ["Ice", "Electric"],
		baseStats: {hp: 93, atk: 128, def: 113, spa: 103, spd: 116, spe: 88},
		abilities: {0: "Pressure", 1: "Teravolt", H: "Snow Cloak"},
		heightm: 2.3,
		weightkg: 200.2,
		color: "Blue",
		eggGroups: ["Undiscovered", "Undiscovered"],
	...
	reshiramcharizard: {
		num: 10570,
		name: "reshiramcharizard",
		types: ["Dragon", "Fire"],
		baseStats: {hp: 92, atk: 96, def: 85, spa: 136, spd: 108, spe: 96},
		abilities: {0: "Turboblaze", 1: "Blaze", H: "Solar Power"},
		heightm: 2.45,
		weightkg: 210.25,
		color: "White",
		eggGroups: ["Monster", "Undiscovered"],
	...
	regigigasdodrio: {
		num: 10571,
		name: "regigigasdodrio",
		types: ["Normal", "Flying"],
		baseStats: {hp: 93, atk: 126, def: 83, spa: 73, spd: 93, spe: 106},
		abilities: {0: "Slow Start", 1: "Early Bird", H: "Tangled Feet"},
		heightm: 2.75,
		weightkg: 252.6,
		color: "White",
		eggGroups: ["Flying", "Undiscovered"],
	...
	alakazamjirachi: {
		num: 10572,
		name: "alakazamjirachi",
		types: ["Psychic", "Steel"],
		baseStats: {hp: 70, atk: 83, def: 81, spa: 123, spd: 96, spe: 106},
		abilities: {0: "Synchronize", 1: "Serene Grace", H: "Magic Guard"},
		heightm: 0.9,
		weightkg: 24.55,
		color: "Brown",
		eggGroups: ["Undiscovered", "Human-Like"],
	...
	snorlaxdusknoir: {
		...
		abilities: {0: "Immunity", 1: "Frisk", H: "Gluttony"},
		heightm: 2.1500000000000004,
		weightkg: 283.3,
		color: "Black",
		eggGroups: ["Amorphous", "Monster"],
	...
	zoroarkregigigas: {
		...
		abilities: {0: "Illusion", 1: "Slow Start", H: ""},
		heightm: 2.6500000000000004,
		weightkg: 250.55,
		color: "Gray",
		eggGroups: ["Undiscovered", "Field"],
	...
	kyuremprobopass: {
		num: 10575,
		name: "kyuremprobopass",
		types: ["Dragon", "Steel"],
		baseStats: {hp: 103, atk: 80, def: 126, spa: 111, spd: 110, spe: 58},
		abilities: {0: "Pressure", 1: "Magnet Pull", H: "Sand Force"},
		heightm: 2.2,
		weightkg: 332,
		color: "Gray",
		eggGroups: ["Mineral", "Undiscovered"],
	...
	azumarillgarchomp: {
		...
		abilities: {0: "Thick Fat", 1: "Rough Skin", H: "Sap Sipper"},
		heightm: 1.35,
		weightkg: 61.75,
		color: "Blue",
		eggGroups: ["Monster", "Water 1"],
	...
	hoohinfernape: {
		...
		name: "hoohinfernape",
		types: ["Fire", "Fighting"],
		baseStats: {hp: 96, atk: 112, def: 77, spa: 108, spd: 126, spe: 102},
		abilities: {0: "Pressure", 1: "Iron Fist", H: "Regenerator"},
		heightm: 2.5,
		weightkg: 127,
		color: "Red",
		eggGroups: ["Field", "Undiscovered"],
	...
	galvantulainfernape: {
		num: 10579,
		name: "galvantulainfernape",
		types: ["Bug", "Fighting"],
		baseStats: {hp: 72, atk: 95, def: 67, spa: 99, spd: 63, spe: 108},
		abilities: {0: "Compound Eyes", 1: "Iron Fist", H: "Swarm"},
		heightm: 1.0,
		weightkg: 34.65,
		color: "Yellow",
		eggGroups: ["Field", "Bug"],
	...
	kinglerzekrom: {
		...
		name: "kinglerzekrom",
		types: ["Water", "Electric"],
		baseStats: {hp: 70, atk: 143, def: 118, spa: 73, spd: 66, spe: 85},
		abilities: {0: "Hyper Cutter", 1: "Teravolt", H: "Sheer Force"},
		heightm: 2.1,
		weightkg: 202,
		color: "Red",
		eggGroups: ["Undiscovered", "Water 3"],
	...
	tyranitarzekrom: {
		num: 10581,
		name: "tyranitarzekrom",
		types: ["Rock", "Electric"],
		baseStats: {hp: 100, atk: 144, def: 116, spa: 103, spd: 100, spe: 80},
		abilities: {0: "Sand Stream", 1: "Teravolt", H: "Unnerve"},
		heightm: 2.45,
		weightkg: 273,
		color: "Green",
		eggGroups: ["Undiscovered", "Monster"],
	...
	dusclopshitmontop: {
		num: 10582,
		name: "dusclopshitmontop",
		types: ["Ghost", "Fighting"],
		baseStats: {hp: 43, atk: 86, def: 106, spa: 51, spd: 123, spe: 55},
		abilities: {0: "Pressure", 1: "Technician", H: "Frisk"},
		heightm: 1.5,
		weightkg: 39.3,
		color: "Black",
		evos: ["Dusknoir"],
	...
	lanturnhooh: {
		...
		name: "lanturnhooh",
		types: ["Water", "Flying"],
		baseStats: {hp: 118, atk: 106, def: 79, spa: 87, spd: 102, spe: 82},
		abilities: {0: "Volt Absorb", 1: "Regenerator", H: "Water Absorb"},
		heightm: 2.5,
		weightkg: 110.75,
		color: "Blue",
		eggGroups: ["Undiscovered", "Water 2"],
	...
	butterfreemewtwo: {
		num: 10584,
		name: "butterfreemewtwo",
		types: ["Bug", "Psychic"],
		baseStats: {hp: 75, atk: 88, def: 76, spa: 111, spd: 83, spe: 110},
		abilities: {0: "Compound Eyes", 1: "Unnerve", H: "Tinted Lens"},
		heightm: 1.55,
		weightkg: 77,
		color: "White",
		eggGroups: ["Undiscovered", "Bug"],
	...
	chandeluregenesect: {
		num: 10585,
		name: "chandeluregenesect",
		types: ["Ghost", "Steel"],
		baseStats: {hp: 63, atk: 98, def: 93, spa: 136, spd: 91, spe: 92},
		abilities: {0: "Flash Fire", 1: "Download", H: "Infiltrator"},
		heightm: 1.25,
		weightkg: 58.4,
		color: "Black",
		eggGroups: ["Undiscovered", "Amorphous"],
	...
	reuniclusreshiram: {
		num: 10586,
		name: "reuniclusreshiram",
		types: ["Psychic", "Fire"],
		baseStats: {hp: 106, atk: 101, def: 91, spa: 133, spd: 96, spe: 70},
		abilities: {0: "Overcoat", 1: "Turboblaze", H: "Regenerator"},
		heightm: 2.1,
		weightkg: 175.05,
		color: "Green",
		eggGroups: ["Undiscovered", "Amorphous"],
	...
	giratinaquagsire: {
		num: 10587,
		name: "giratinaquagsire",
		types: ["Ghost", "Ground"],
		baseStats: {hp: 131, atk: 90, def: 96, spa: 88, spd: 101, spe: 53},
		abilities: {0: "Pressure", 1: "Water Absorb", H: "Telepathy"},
		heightm: 2.95,
		weightkg: 412,
		color: "Black",
		eggGroups: ["Water 1", "Undiscovered"],
	...
	darkraihooh: {
		...
		name: "darkraihooh",
		types: ["Dark", "Flying"],
		baseStats: {hp: 82, atk: 116, def: 90, spa: 126, spd: 111, spe: 101},
		abilities: {0: "Bad Dreams", 1: "Pressure", H: "Regenerator"},
		heightm: 2.65,
		weightkg: 124.75,
		color: "Black",
		eggGroups: ["Undiscovered", "Undiscovered"],
	...
	slowkingsteelix: {
		num: 10589,
		name: "slowkingsteelix",
		types: ["Water", "Steel"],
		baseStats: {hp: 88, atk: 81, def: 160, spa: 85, spd: 95, spe: 30},
		abilities: {0: "Oblivious", 1: "Sturdy", H: "Regenerator"},
		heightm: 5.6,
		weightkg: 239.75,
		color: "Pink",
		eggGroups: ["Mineral", "Monster"],
	...
	regigigasparasect: {
		num: 10590,
		name: "regigigasparasect",
		types: ["Normal", "Grass"],
		baseStats: {hp: 93, atk: 116, def: 90, spa: 73, spd: 100, spe: 53},
		abilities: {0: "Slow Start", 1: "Dry Skin", H: "Damp"},
		heightm: 2.35,
		weightkg: 224.75,
		color: "White",
		eggGroups: ["Bug", "Undiscovered"],
	...
	klefkivaporeon: {
		...
		name: "klefkivaporeon",
		types: ["Steel", "Water"],
		baseStats: {hp: 81, atk: 70, def: 70, spa: 90, spd: 89, spe: 68},
		abilities: {0: "Prankster", 1: "Hydration", H: "Magician"},
		heightm: 0.6,
		weightkg: 16,
		color: "Gray",
		eggGroups: ["Field", "Mineral"],
	...
	jirachiweavile: {
		...
		name: "jirachiweavile",
		types: ["Steel", "Ice"],
		baseStats: {hp: 90, atk: 113, def: 76, spa: 81, spd: 95, spe: 116},
		abilities: {0: "Serene Grace", 1: "Pressure", H: "Pickpocket"},
		heightm: 0.7000000000000001,
		weightkg: 17.55,
		color: "Yellow",
		eggGroups: ["Field", "Undiscovered"],
	},
	aegislashdusclops: {
		num: 10593,
		name: "aegislashdusclops",
		types: ["Steel", "Ghost"],
		baseStats: {hp: 53, atk: 63, def: 133, spa: 53, spd: 136, spe: 36},
		abilities: {0: "Stance Change", 1: "Pressure", H: "Frisk"},
		heightm: 1.65,
		weightkg: 41.8,
		color: "Brown",
		evos: ["Dusknoir"],
	...
	vaporeonweezing: {
		num: 10594,
		name: "vaporeonweezing",
		types: ["Water", "Poison"],
		baseStats: {hp: 108, atk: 81, def: 100, spa: 101, spd: 86, spe: 61},
		abilities: {0: "Water Absorb", 1: "Neutralizing Gas", H: "Hydration"},
		heightm: 1.1,
		weightkg: 19.25,
		color: "Blue",
		eggGroups: ["Amorphous", "Field"],
	...
	jirachitangrowth: {
		num: 10595,
		name: "jirachitangrowth",
		types: ["Steel", "Grass"],
		baseStats: {hp: 100, atk: 100, def: 116, spa: 103, spd: 83, spe: 66},
		abilities: {0: "Serene Grace", 1: "Leaf Guard", H: "Regenerator"},
		heightm: 1.15,
		weightkg: 64.85,
		color: "Yellow",
		eggGroups: ["Grass", "Undiscovered"],
	...
	zekromshuckle: {
		...
		abilities: {0: "Teravolt", 1: "Gluttony", H: "Contrary"},
		heightm: 1.75,
		weightkg: 182.75,
		color: "Black",
		eggGroups: ["Bug", "Undiscovered"],
	...
	ninetalessceptile: {
		num: 10597,
		name: "ninetalessceptile",
		types: ["Fire", "Grass"],
		baseStats: {hp: 72, atk: 82, def: 68, spa: 89, spd: 95, spe: 113},
		abilities: {0: "Flash Fire", 1: "Unburden", H: "Drought"},
		heightm: 1.4,
		weightkg: 36.05,
		color: "Yellow",
		eggGroups: ["Monster", "Field"],
	...
	snorlaxdoublade: {
		num: 10598,
		name: "snorlaxdoublade",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 126, atk: 110, def: 121, spa: 58, spd: 89, spe: 33},
		abilities: {0: "Immunity", 1: "No Guard", H: "Gluttony"},
		heightm: 1.4500000000000002,
		weightkg: 232.25,
		color: "Black",
		evos: ["Aegislash"],
	...
	blazikengardevoir: {
		num: 10599,
		name: "blazikengardevoir",
		types: ["Fire", "Fairy"],
		baseStats: {hp: 76, atk: 83, def: 66, spa: 115, spd: 85, spe: 80},
		abilities: {0: "Blaze", 1: "Trace", H: "Speed Boost"},
		heightm: 1.75,
		weightkg: 50.2,
		color: "Red",
		eggGroups: ["Human-Like", "Field"],
	...
	reuniclusazumarill: {
		num: 10600,
		name: "reuniclusazumarill",
		types: ["Psychic", "Fairy"],
		baseStats: {hp: 106, atk: 55, def: 78, spa: 103, spd: 83, spe: 43},
		abilities: {0: "Overcoat", 1: "Huge Power", H: "Regenerator"},
		heightm: 0.9,
		weightkg: 24.3,
		color: "Green",
		eggGroups: ["Water 1", "Amorphous"],
	...
	palkiaklinklang: {
		num: 10601,
		name: "palkiaklinklang",
		types: ["Water", "Steel"],
		baseStats: {hp: 80, atk: 106, def: 110, spa: 123, spd: 108, spe: 93},
		abilities: {0: "Pressure", 1: "Minus", H: "Telepathy"},
		heightm: 2.4,
		weightkg: 208,
		color: "Purple",
		eggGroups: ["Mineral", "Undiscovered"],
	...
	pyukumukudusclops: {
		num: 10602,
		name: "pyukumukudusclops",
		types: ["Water", "Ghost"],
		baseStats: {hp: 50, atk: 66, def: 130, spa: 40, spd: 130, spe: 18},
		abilities: {0: "Innards Out", 1: "Frisk", H: "Unaware"},
		heightm: 0.9500000000000001,
		weightkg: 15.9,
		color: "Black",
		evos: ["Dusknoir"],
	...
	sandslashslaking: {
		num: 10603,
		name: "sandslashslaking",
		types: ["Ground", "Normal"],
		baseStats: {hp: 100, atk: 140, def: 103, spa: 61, spd: 58, spe: 88},
		abilities: {0: "Sand Veil", 1: "Truant", H: "Sand Rush"},
		heightm: 1,
		weightkg: 80.0,
		color: "Yellow",
		eggGroups: ["Field", "Field"],
	...
	giratinastarmie: {
		num: 10604,
		name: "giratinastarmie",
		types: ["Ghost", "Psychic"],
		baseStats: {hp: 120, atk: 83, def: 96, spa: 100, spd: 108, spe: 106},
		abilities: {0: "Pressure", 1: "Natural Cure", H: "Telepathy"},
		heightm: 2.8,
		weightkg: 415,
		color: "Black",
		eggGroups: ["Water 3", "Undiscovered"],
	...
	ampharoslugia: {
		...
		name: "ampharoslugia",
		types: ["Electric", "Flying"],
		baseStats: {hp: 95, atk: 85, def: 115, spa: 106, spd: 111, spe: 91},
		abilities: {0: "Static", 1: "Multiscale", H: "Plus"},
		heightm: 3.3,
		weightkg: 138.75,
		color: "Yellow",
		eggGroups: ["Undiscovered", "Monster"],
	...
	palkiainfernape: {
		num: 10606,
		name: "palkiainfernape",
		types: ["Water", "Fighting"],
		baseStats: {hp: 85, atk: 109, def: 80, spa: 134, spd: 103, spe: 105},
		abilities: {0: "Pressure", 1: "Iron Fist", H: "Telepathy"},
		heightm: 2.7,
		weightkg: 195,
		color: "Purple",
	...
	metagrossgarchomp: {
		...
		abilities: {0: "Clear Body", 1: "Rough Skin", H: "Light Metal"},
		heightm: 1.75,
		weightkg: 322,
		color: "Blue",
		eggGroups: ["Monster", "Mineral"],
	...
	arceusraichu: {
		...
		name: "arceusraichu",
		types: ["Normal", "Electric"],
		baseStats: {hp: 100, atk: 100, def: 76, spa: 110, spd: 106, spe: 113},
		abilities: {0: "Multitype", 1: "Static", H: "Lightning Rod"},
		heightm: 2.0,
		weightkg: 175,
		color: "White",
		eggGroups: ["Field", "Undiscovered"],
	...
	slakingdusknoir: {
		num: 10609,
		name: "slakingdusknoir",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 115, atk: 120, def: 123, spa: 85, spd: 88, spe: 63},
		abilities: {0: "Truant", 1: "Pressure", H: "Frisk"},
		heightm: 2.1,
		weightkg: 118.55,
		color: "Brown",
		eggGroups: ["Amorphous", "Field"],
	...
	dialgareuniclus: {
		num: 10610,
		name: "dialgareuniclus",
		types: ["Steel", "Psychic"],
		baseStats: {hp: 103, atk: 83, def: 90, spa: 141, spd: 95, spe: 50},
		abilities: {0: "Pressure", 1: "Magic Guard", H: "Telepathy"},
		heightm: 3.2,
		weightkg: 351.55,
		color: "White",
	...
	dialgagranbull: {
		...
		name: "dialgagranbull",
		types: ["Steel", "Fairy"],
		baseStats: {hp: 96, atk: 120, def: 90, spa: 120, spd: 86, spe: 60},
		abilities: {0: "Pressure", 1: "Quick Feet", H: "Telepathy"},
		heightm: 3.4000000000000004,
		weightkg: 365.85,
		color: "White",
		eggGroups: ["Field", "Undiscovered"],
	...
	poliwrathregigigas: {
		num: 10612,
		name: "poliwrathregigigas",
		types: ["Water", "Normal"],
		baseStats: {hp: 96, atk: 138, def: 105, spa: 73, spd: 96, spe: 90},
		abilities: {0: "Water Absorb", 1: "Slow Start", H: "Swift Swim"},
		heightm: 2.5,
		weightkg: 237,
		color: "Blue",
		eggGroups: ["Undiscovered", "Water 1"],
	...
	reuniclusmew: {
		...
		name: "reuniclusmew",
		types: ["Psychic"],
		baseStats: {hp: 106, atk: 88, def: 91, spa: 116, spd: 90, spe: 76},
		abilities: {0: "Overcoat", 1: "Synchronize", H: "Regenerator"},
		heightm: 0.7,
		weightkg: 12.05,
		color: "Green",
		eggGroups: ["Undiscovered", "Amorphous"],
	...
	giratinagliscor: {
		num: 10614,
		name: "giratinagliscor",
		types: ["Ghost", "Flying"],
		baseStats: {hp: 125, atk: 96, def: 123, spa: 81, spd: 105, spe: 93},
		abilities: {0: "Pressure", 1: "Sand Veil", H: "Telepathy"},
		heightm: 3.25,
		weightkg: 396.25,
		color: "Black",
		eggGroups: ["Bug", "Undiscovered"],
	...
	tyranitartangrowth: {
		num: 10615,
		name: "tyranitartangrowth",
		types: ["Rock", "Grass"],
		baseStats: {hp: 100, atk: 111, def: 120, spa: 100, spd: 83, spe: 53},
		abilities: {0: "Sand Stream", 1: "Leaf Guard", H: "Unnerve"},
		heightm: 2,
		weightkg: 165.3,
		color: "Green",
		eggGroups: ["Grass", "Monster"],
	...
	kyuremzekrom: {
		...
		name: "kyuremzekrom",
		types: ["Dragon", "Electric"],
		baseStats: {hp: 116, atk: 143, def: 110, spa: 126, spd: 93, spe: 91},
		abilities: {0: "Pressure", 1: "Teravolt", H: ""},
		heightm: 2.95,
		weightkg: 335,
		color: "Gray",
	...
	slowkingforretress: {
		num: 10617,
		name: "slowkingforretress",
		types: ["Water", "Steel"],
		baseStats: {hp: 88, atk: 85, def: 120, spa: 86, spd: 93, spe: 36},
		abilities: {0: "Oblivious", 1: "Overcoat", H: "Regenerator"},
		heightm: 1.6,
		weightkg: 102.65,
		color: "Pink",
		eggGroups: ["Bug", "Monster"],
	...
	lanturnlugia: {
		...
		name: "lanturnlugia",
		types: ["Water", "Flying"],
		baseStats: {hp: 118, atk: 79, def: 106, spa: 80, spd: 102, spe: 95},
		abilities: {0: "Volt Absorb", 1: "Multiscale", H: "Water Absorb"},
		heightm: 3.2,
		weightkg: 119.25,
		color: "Blue",
		eggGroups: ["Undiscovered", "Water 2"],
	...
	articunohaxorus: {
		num: 10620,
		name: "articunohaxorus",
		types: ["Ice", "Dragon"],
		baseStats: {hp: 85, atk: 126, def: 93, spa: 83, spd: 106, spe: 93},
		abilities: {0: "Pressure", 1: "Mold Breaker", H: "Snow Cloak"},
		heightm: 1.75,
		weightkg: 80.45,
		color: "Blue",
		eggGroups: ["Monster", "Undiscovered"],
	...
	groudongliscor: {
		...
		name: "groudongliscor",
		types: ["Ground", "Flying"],
		baseStats: {hp: 91, atk: 113, def: 130, spa: 81, spd: 85, spe: 93},
		abilities: {0: "Drought", 1: "Sand Veil", H: "Poison Heal"},
		heightm: 2.75,
		weightkg: 496.25,
		color: "Red",
		eggGroups: ["Bug", "Undiscovered"],
	...
	arbokregigigas: {
		...
		name: "arbokregigigas",
		types: ["Poison", "Normal"],
		baseStats: {hp: 76, atk: 138, def: 96, spa: 70, spd: 89, spe: 93},
		abilities: {0: "Intimidate", 1: "Slow Start", H: "Unnerve"},
		heightm: 3.6,
		weightkg: 242,
		color: "Purple",
		eggGroups: ["Undiscovered", "Field"],
	...
	magmortarelectivire: {
		num: 10623,
		name: "magmortarelectivire",
		types: ["Fire", "Electric"],
		baseStats: {hp: 75, atk: 113, def: 67, spa: 115, spd: 91, spe: 91},
		abilities: {0: "Flame Body", 1: "Motor Drive", H: "Vital Spirit"},
		heightm: 1.7000000000000002,
		weightkg: 103.3,
		color: "Red",
		eggGroups: ["Human-Like", "Human-Like"],
	...
	scythermurkrow: {
		...
		name: "scythermurkrow",
		types: ["Bug", "Flying"],
		baseStats: {hp: 66, atk: 93, def: 54, spa: 65, spd: 67, spe: 95},
		abilities: {0: "Swarm", 1: "Super Luck", H: "Steadfast"},
		heightm: 1.0,
		weightkg: 29.05,
		color: "Green",
		evos: ["HonchkrowScizor"],
	...
	starmieweezing: {
		...
		name: "starmieweezing",
		types: ["Water", "Poison"],
		baseStats: {hp: 61, atk: 85, def: 108, spa: 95, spd: 80, spe: 78},
		abilities: {0: "Illuminate", 1: "Neutralizing Gas", H: "Analytic"},
		heightm: 1.15,
		weightkg: 44.75,
		color: "Purple",
	...
	swampertmetagross: {
		num: 10626,
		name: "swampertmetagross",
		types: ["Water", "Psychic"],
		baseStats: {hp: 93, atk: 126, def: 116, spa: 88, spd: 90, spe: 66},
		abilities: {0: "Torrent", 1: "Light Metal", H: "Damp"},
		heightm: 1.55,
		weightkg: 315.95,
		color: "Blue",
		eggGroups: ["Mineral", "Monster"],
	...
	togekissaggron: {
		...
		abilities: {0: "Hustle", 1: "Rock Head", H: "Super Luck"},
		heightm: 1.8,
		weightkg: 199,
		color: "White",
		eggGroups: ["Monster", "Flying"],
	...
	palkiasandslash: {
		num: 10628,
		name: "palkiasandslash",
		types: ["Water", "Ground"],
		baseStats: {hp: 85, atk: 106, def: 106, spa: 115, spd: 98, spe: 76},
		abilities: {0: "Pressure", 1: "Sand Rush", H: "Telepathy"},
		heightm: 2.6,
		weightkg: 182.75,
		color: "Purple",
		eggGroups: ["Field", "Undiscovered"],
	...
	weezingsudowoodo: {
		num: 10629,
		name: "weezingsudowoodo",
		types: ["Poison", "Rock"],
		baseStats: {hp: 66, atk: 96, def: 116, spa: 66, spd: 68, spe: 40},
		abilities: {0: "Levitate", 1: "Rock Head", H: "Stench"},
		heightm: 1.2,
		weightkg: 23.75,
		color: "Purple",
		eggGroups: ["Mineral", "Amorphous"],
	...
	deoxyslopunny: {
		...
		name: "deoxyslopunny",
		types: ["Psychic", "Normal"],
		baseStats: {hp: 55, atk: 100, def: 72, spa: 118, spd: 65, spe: 120},
		abilities: {0: "Pressure", 1: "Klutz", H: "Limber"},
		heightm: 1.45,
		weightkg: 47.05,
		color: "Red",
		eggGroups: ["Field", "Undiscovered"],
	...
	butterfreeflygon: {
		num: 10631,
		name: "butterfreeflygon",
		types: ["Bug", "Dragon"],
		baseStats: {hp: 66, atk: 81, def: 70, spa: 86, spd: 80, spe: 90},
	...
	gardevoirtogekiss: {
		num: 10632,
		name: "gardevoirtogekiss",
		types: ["Psychic", "Flying"],
		baseStats: {hp: 73, atk: 55, def: 85, spa: 123, spd: 115, spe: 80},
		abilities: {0: "Synchronize", 1: "Serene Grace", H: "Telepathy"},
		heightm: 1.55,
		weightkg: 43.2,
		color: "White",
		eggGroups: ["Flying", "Human-Like"],
	...
	palkiaarticuno: {
		...
		name: "palkiaarticuno",
		types: ["Water", "Ice"],
		baseStats: {hp: 90, atk: 96, def: 100, spa: 131, spd: 121, spe: 90},
		abilities: {0: "Pressure", 1: "Snow Cloak", H: "Telepathy"},
		heightm: 2.95,
		weightkg: 195.7,
		color: "Purple",
		eggGroups: ["Undiscovered", "Undiscovered"],
	...
	lucarioinfernape: {
		num: 10634,
		name: "lucarioinfernape",
		types: ["Fighting", "Fire"],
		baseStats: {hp: 72, atk: 106, def: 70, spa: 111, spd: 70, spe: 102},
		abilities: {0: "Steadfast", 1: "Iron Fist", H: "Justified"},
		heightm: 1.2,
		weightkg: 54,
		color: "Blue",
		eggGroups: ["Field", "Field"],
	...
	blastoisemiltank: {
		num: 10635,
		name: "blastoisemiltank",
		types: ["Water", "Normal"],
		baseStats: {hp: 84, atk: 81, def: 103, spa: 70, spd: 93, spe: 92},
		abilities: {0: "Torrent", 1: "Scrappy", H: "Rain Dish"},
		heightm: 1.4,
		weightkg: 80.5,
		color: "Blue",
		eggGroups: ["Field", "Monster"],
	...
	jolteonkyurem: {
		...
		name: "jolteonkyurem",
		types: ["Electric", "Ice"],
		baseStats: {hp: 85, atk: 108, def: 80, spa: 116, spd: 93, spe: 106},
		abilities: {0: "Volt Absorb", 1: "Pressure", H: "Quick Feet"},
		heightm: 1.9,
		weightkg: 174.75,
		color: "Yellow",
		eggGroups: ["Undiscovered", "Field"],
	...
	electiviregyarados: {
		num: 10637,
		name: "electiviregyarados",
		types: ["Electric", "Water"],
		baseStats: {hp: 81, atk: 124, def: 75, spa: 83, spd: 90, spe: 85},
		abilities: {0: "Motor Drive", 1: "Moxie", H: "Vital Spirit"},
		heightm: 4.15,
		weightkg: 186.8,
		color: "Yellow",
	...
	snorlaxmetagross: {
		num: 10638,
		name: "snorlaxmetagross",
		types: ["Normal", "Psychic"],
		baseStats: {hp: 133, atk: 126, def: 108, spa: 75, spd: 103, spe: 56},
		abilities: {0: "Immunity", 1: "Light Metal", H: "Gluttony"},
		heightm: 1.85,
		weightkg: 505,
		color: "Black",
		eggGroups: ["Mineral", "Monster"],
	...
	golurkkangaskhan: {
		num: 10639,
		name: "golurkkangaskhan",
		types: ["Ground", "Normal"],
		baseStats: {hp: 94, atk: 104, def: 80, spa: 50, spd: 80, spe: 78},
	...
	scizorcrobat: {
		...
		abilities: {0: "Swarm", 1: "Infiltrator", H: "Light Metal"},
		heightm: 1.8,
		weightkg: 96,
		color: "Red",
		eggGroups: ["Flying", "Bug"],
	...
	infernapeaggron: {
		num: 10641,
		name: "infernapeaggron",
		types: ["Fire", "Rock"],
		baseStats: {hp: 74, atk: 108, def: 143, spa: 89, spd: 67, spe: 69},
		abilities: {0: "Blaze", 1: "Rock Head", H: "Iron Fist"},
		heightm: 1.65,
		weightkg: 207,
		color: "Brown",
		eggGroups: ["Monster", "Field"],
	...
	kingdramagmortar: {
		num: 10642,
		name: "kingdramagmortar",
		types: ["Water", "Fire"],
		baseStats: {hp: 75, atk: 95, def: 76, spa: 105, spd: 95, spe: 83},
		abilities: {0: "Swift Swim", 1: "Vital Spirit", H: "Damp"},
		heightm: 1.7000000000000002,
		weightkg: 110,
		color: "Blue",
	...
	infernapelapras: {
		num: 10643,
		name: "infernapelapras",
		types: ["Fire", "Ice"],
		baseStats: {hp: 94, atk: 91, def: 77, spa: 97, spd: 79, spe: 76},
		abilities: {0: "Blaze", 1: "Shell Armor", H: "Iron Fist"},
		heightm: 1.85,
		weightkg: 137,
		color: "Brown",
		eggGroups: ["Monster", "Field"],
	...
	machampdoublade: {
		num: 10644,
		name: "machampdoublade",
		types: ["Fighting", "Ghost"],
		baseStats: {hp: 79, atk: 116, def: 126, spa: 58, spd: 73, spe: 41},
		abilities: {0: "Guts", 1: "No Guard", H: "Steadfast"},
		heightm: 1.2000000000000002,
		weightkg: 67.25,
		color: "Gray",
	...
	houndoomhaxorus: {
		num: 10645,
		name: "houndoomhaxorus",
		types: ["Dark", "Dragon"],
		baseStats: {hp: 75, atk: 128, def: 76, spa: 93, spd: 76, spe: 96},
		abilities: {0: "Early Bird", 1: "Mold Breaker", H: "Unnerve"},
		heightm: 1.6,
		weightkg: 70.25,
		color: "Black",
		eggGroups: ["Monster", "Field"],
	...
	houndoomscyther: {
		num: 10646,
		name: "houndoomscyther",
		types: ["Dark", "Bug"],
		baseStats: {hp: 73, atk: 103, def: 70, spa: 91, spd: 80, spe: 101},
		abilities: {0: "Early Bird", 1: "Technician", H: "Unnerve"},
		heightm: 1.45,
		weightkg: 45,
		color: "Black",
		evos: ["Scizor"],
	...
	empoleonforretress: {
		num: 10647,
		name: "empoleonforretress",
		types: ["Water", "Steel"],
		baseStats: {hp: 81, atk: 88, def: 122, spa: 94, spd: 87, spe: 46},
		abilities: {0: "Torrent", 1: "Overcoat", H: "Defiant"},
		heightm: 1.45,
		weightkg: 105.15,
		color: "Blue",
		eggGroups: ["Bug", "Water 1"],
	...
	blisseydoublade: {
		num: 10648,
		name: "blisseydoublade",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 189, atk: 76, def: 103, spa: 65, spd: 106, spe: 41},
		abilities: {0: "Natural Cure", 1: "No Guard", H: "Healer"},
		heightm: 1.15,
		weightkg: 25.65,
		color: "Pink",
		evos: ["Aegislash"],
	...
	nidokingaggron: {
		...
		name: "nidokingaggron",
		types: ["Poison", "Rock"],
		baseStats: {hp: 77, atk: 107, def: 145, spa: 76, spd: 70, spe: 61},
		abilities: {0: "Poison Point", 1: "Rock Head", H: "Sheer Force"},
		heightm: 1.75,
		weightkg: 211,
		color: "Purple",
		eggGroups: ["Monster", "Monster"],
	...
	salamencecofagrigus: {
		num: 10650,
		name: "salamencecofagrigus",
		types: ["Dragon", "Ghost"],
		baseStats: {hp: 82, atk: 78, def: 123, spa: 105, spd: 88, spe: 53},
		abilities: {0: "Intimidate", 1: "Mummy", H: "Moxie"},
		heightm: 1.6,
		weightkg: 89.55,
		color: "Blue",
		eggGroups: ["Mineral", "Dragon"],
	...
	kingdrascyther: {
		...
		name: "kingdrascyther",
		types: ["Water", "Bug"],
		baseStats: {hp: 73, atk: 105, def: 85, spa: 81, spd: 90, spe: 98},
		abilities: {0: "Swift Swim", 1: "Technician", H: "Damp"},
		heightm: 1.65,
		weightkg: 104,
		color: "Blue",
		evos: ["Scizor"],
	...
	kecleondonphan: {
		...
		name: "kecleondonphan",
		types: ["Normal", "Ground"],
		baseStats: {hp: 70, atk: 110, def: 103, spa: 60, spd: 100, spe: 46},
		abilities: {0: "Color Change", 1: "Sand Veil", H: "Protean"},
		heightm: 1.05,
		weightkg: 71,
		color: "Green",
		eggGroups: ["Field", "Field"],
	...
	bisharpdusknoir: {
		...
		abilities: {0: "Defiant", 1: "Frisk", H: "Pressure"},
		heightm: 1.9000000000000001,
		weightkg: 88.3,
		color: "Red",
		eggGroups: ["Amorphous", "Human-Like"],
	...
	seakingmantine: {
		...
		abilities: {0: "Swift Swim", 1: "Water Absorb", H: "Lightning Rod"},
		heightm: 1.7000000000000002,
		weightkg: 129,
		color: "Red",
		eggGroups: ["Water 1", "Water 2"],
	...
	charizardflygon: {
		num: 10655,
		name: "charizardflygon",
		types: ["Fire", "Dragon"],
		baseStats: {hp: 78, atk: 94, def: 79, spa: 99, spd: 83, spe: 100},
	...
	pidgeotsudowoodo: {
		num: 10656,
		name: "pidgeotsudowoodo",
		types: ["Flying", "Rock"],
		baseStats: {hp: 78, atk: 93, def: 101, spa: 56, spd: 68, spe: 53},
		abilities: {0: "Keen Eye", 1: "Rock Head", H: "Big Pecks"},
		heightm: 1.35,
		weightkg: 38.75,
		color: "Brown",
		eggGroups: ["Mineral", "Flying"],
	...
	bisharprampardos: {
		num: 10657,
		name: "bisharprampardos",
		types: ["Dark", "Rock"],
		baseStats: {hp: 75, atk: 151, def: 73, spa: 61, spd: 63, spe: 62},
		abilities: {0: "Defiant", 1: "Sheer Force", H: "Pressure"},
		heightm: 1.6,
		weightkg: 86.25,
		color: "Red",
		eggGroups: ["Monster", "Human-Like"],
	...
	chanseyhaxorus: {
		...
		name: "chanseyhaxorus",
		types: ["Normal", "Dragon"],
		baseStats: {hp: 192, atk: 99, def: 61, spa: 43, spd: 93, spe: 81},
		abilities: {0: "Natural Cure", 1: "Mold Breaker", H: "Healer"},
		heightm: 1.4500000000000002,
		weightkg: 70.05,
		color: "Pink",
		evos: ["Blissey"],
	...
	articunokingdra: {
		num: 10659,
		name: "articunokingdra",
		types: ["Ice", "Dragon"],
		baseStats: {hp: 85, atk: 91, def: 96, spa: 95, spd: 115, spe: 85},
		abilities: {0: "Pressure", 1: "Sniper", H: "Snow Cloak"},
		heightm: 1.75,
		weightkg: 103.7,
		color: "Blue",
		eggGroups: ["Water 1", "Undiscovered"],
	...
	latioslatias: {
		...
		name: "latioslatias",
		types: ["Dragon", "Psychic"],
		baseStats: {hp: 80, atk: 83, def: 86, spa: 123, spd: 116, spe: 110},
		abilities: {0: "Levitate"},
		heightm: 1.7,
		weightkg: 50,
		color: "Blue",
	...
	reshiramzekrom: {
		...
		name: "reshiramzekrom",
		types: ["Dragon", "Electric"],
		baseStats: {hp: 100, atk: 140, def: 113, spa: 140, spd: 113, spe: 90},
		abilities: {0: "Turboblaze", 1: "Teravolt", H: ""},
		heightm: 3.05,
		weightkg: 337,
		color: "White",
		eggGroups: ["Undiscovered", "Undiscovered"],
	...
	arceusgiratina: {
		...
		name: "arceusgiratina",
		types: ["Normal", "Dragon"],
		baseStats: {hp: 130, atk: 106, def: 120, spa: 113, spd: 120, spe: 100},
		abilities: {0: "Multitype", 1: "Pressure", H: "Telepathy"},
		heightm: 3.85,
		weightkg: 535,
		color: "White",
		eggGroups: ["Undiscovered", "Undiscovered"],
	...
	blazikengengar: {
		...
		name: "blazikengengar",
		types: ["Fire", "Ghost"],
		baseStats: {hp: 73, atk: 83, def: 63, spa: 116, spd: 71, spe: 100},
		abilities: {0: "Blaze", 1: "Cursed Body", H: "Speed Boost"},
		heightm: 1.7,
		weightkg: 46.25,
		color: "Red",
		eggGroups: ["Amorphous", "Field"],
	...
	arceusrotom: {
		...
		name: "arceusrotom",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 96, atk: 73, def: 91, spa: 111, spd: 105, spe: 100},
		abilities: {0: "Multitype", 1: "Levitate", H: ""},
		heightm: 1.75,
		weightkg: 160.15,
		color: "White",
	...
	arceusheracross: {
		num: 10666,
		name: "arceusheracross",
		types: ["Normal", "Fighting"],
		baseStats: {hp: 106, atk: 123, def: 90, spa: 93, spd: 111, spe: 96},
		abilities: {0: "Multitype", 1: "Guts", H: "Moxie"},
		heightm: 2.35,
		weightkg: 187,
		color: "White",
		eggGroups: ["Bug", "Undiscovered"],
	...
	sudowoodogolem: {
		...
		name: "sudowoodogolem",
		types: ["Rock"],
		baseStats: {hp: 73, atk: 113, def: 125, spa: 38, spd: 65, spe: 40},
		abilities: {0: "Sturdy", 1: "Rock Head", H: "Rattled"},
		heightm: 1.2999999999999998,
		weightkg: 169,
		color: "Brown",
	...
	chanseypyukumuku: {
		num: 10671,
		name: "chanseypyukumuku",
		types: ["Normal", "Water"],
		baseStats: {hp: 185, atk: 41, def: 88, spa: 33, spd: 113, spe: 20},
		abilities: {0: "Natural Cure", 1: "Unaware", H: "Healer"},
		heightm: 0.7000000000000001,
		weightkg: 17.900000000000002,
		color: "Pink",
		evos: ["Blissey"],
		eggGroups: ["Water 1", "Fairy"],
	},
	blazikenalakazam: {
		num: 10672,
		name: "blazikenalakazam",
		types: ["Fire", "Psychic"],
		baseStats: {hp: 71, atk: 73, def: 53, spa: 118, spd: 78, spe: 106},
		abilities: {0: "Blaze", 1: "Inner Focus", H: "Speed Boost"},
		heightm: 1.7,
		weightkg: 50,
		color: "Red",
		eggGroups: ["Human-Like", "Field"],
	...
	blazikengarchomp: {
		num: 10673,
		name: "blazikengarchomp",
		types: ["Fire", "Ground"],
		baseStats: {hp: 89, atk: 126, def: 86, spa: 100, spd: 75, spe: 94},
		abilities: {0: "Blaze", 1: "Rough Skin", H: "Speed Boost"},
		heightm: 1.9,
		weightkg: 73,
		color: "Red",
		eggGroups: ["Monster", "Field"],
	...
	aegislashtentacruel: {
		...
		abilities: {0: "Stance Change", 1: "Liquid Ooze", H: "Rain Dish"},
		heightm: 1.65,
		weightkg: 54,
		color: "Brown",
	...
	ninetalesinfernape: {
		...
		abilities: {0: "Flash Fire", 1: "Iron Fist", H: "Drought"},
		heightm: 1.15,
		weightkg: 37.45,
		color: "Yellow",
		eggGroups: ["Field", "Field"],
	...
	hydreigonjolteon: {
		num: 10676,
		name: "hydreigonjolteon",
		types: ["Dark", "Electric"],
		baseStats: {hp: 83, atk: 78, def: 70, spa: 120, spd: 91, spe: 119},
		abilities: {0: "Levitate", 1: "Volt Absorb", H: "Quick Feet"},
		heightm: 1.3,
		weightkg: 92.25,
		color: "Blue",
		eggGroups: ["Field", "Dragon"],
	...
	ambipomhaxorus: {
		...
		name: "ambipomhaxorus",
		types: ["Normal", "Dragon"],
		baseStats: {hp: 75, atk: 131, def: 82, spa: 60, spd: 67, spe: 103},
		abilities: {0: "Technician", 1: "Mold Breaker", H: "Skill Link"},
		heightm: 1.5,
		weightkg: 62.9,
		color: "Purple",
		eggGroups: ["Monster", "Field"],
	...
	blazikensalamence: {
		num: 10678,
		name: "blazikensalamence",
		types: ["Fire", "Flying"],
		baseStats: {hp: 85, atk: 130, def: 76, spa: 110, spd: 73, spe: 93},
		abilities: {0: "Blaze", 1: "Moxie", H: "Speed Boost"},
		heightm: 1.7,
		weightkg: 77.3,
		color: "Red",
	...
	feraligatrscizor: {
		num: 10679,
		name: "feraligatrscizor",
		types: ["Water", "Bug"],
		baseStats: {hp: 80, atk: 121, def: 100, spa: 71, spd: 82, spe: 69},
		abilities: {0: "Torrent", 1: "Technician", H: "Sheer Force"},
		heightm: 2.05,
		weightkg: 103.4,
		color: "Blue",
		eggGroups: ["Bug", "Monster"],
	...
	golurkweavile: {
		...
		name: "golurkweavile",
		types: ["Ground", "Ice"],
		baseStats: {hp: 82, atk: 121, def: 70, spa: 51, spd: 81, spe: 101},
		abilities: {0: "Iron Fist", 1: "Pickpocket", H: "No Guard"},
		heightm: 1.95,
		weightkg: 182,
		color: "Green",
		eggGroups: ["Field", "Mineral"],
	...
	yanmegahydreigon: {
		num: 10681,
		name: "yanmegahydreigon",
		types: ["Bug", "Dragon"],
		baseStats: {hp: 88, atk: 95, def: 88, spa: 119, spd: 67, spe: 97},
		abilities: {0: "Speed Boost", 1: "Levitate", H: "Frisk"},
		heightm: 1.85,
		weightkg: 105.75,
		color: "Green",
		eggGroups: ["Dragon", "Bug"],
	...
	typhlosionempoleon: {
		num: 10682,
		name: "typhlosionempoleon",
		types: ["Fire", "Steel"],
		baseStats: {hp: 80, atk: 85, def: 84, spa: 109, spd: 90, spe: 73},
		abilities: {0: "Blaze", 1: "Defiant", H: "Flash Fire"},
		heightm: 1.7,
		weightkg: 82.0,
		color: "Yellow",
		eggGroups: ["Water 1", "Field"],
	...
	slakingpinsir: {
		...
		name: "slakingpinsir",
		types: ["Normal", "Bug"],
		baseStats: {hp: 121, atk: 136, def: 100, spa: 81, spd: 66, spe: 90},
		abilities: {0: "Truant", 1: "Mold Breaker", H: "Moxie"},
		heightm: 1.75,
		weightkg: 92.75,
		color: "Brown",
		eggGroups: ["Bug", "Field"],
	...
	alakazamhydreigon: {
		num: 10684,
		name: "alakazamhydreigon",
		types: ["Psychic", "Dragon"],
		baseStats: {hp: 67, atk: 86, def: 75, spa: 131, spd: 93, spe: 105},
		abilities: {0: "Synchronize", 1: "Levitate", H: "Magic Guard"},
		heightm: 1.65,
		weightkg: 104,
		color: "Brown",
	...
	venusaurhydreigon: {
		num: 10685,
		name: "venusaurhydreigon",
		types: ["Grass", "Dragon"],
		baseStats: {hp: 84, atk: 97, def: 87, spa: 108, spd: 96, spe: 92},
		abilities: {0: "Overgrow", 1: "Levitate", H: "Chlorophyll"},
		heightm: 1.9,
		weightkg: 130,
		color: "Green",
		eggGroups: ["Dragon", "Monster"],
	...
	chanseytangrowth: {
		num: 10686,
		name: "chanseytangrowth",
		types: ["Normal", "Grass"],
		baseStats: {hp: 200, atk: 68, def: 85, spa: 60, spd: 86, spe: 50},
		abilities: {0: "Natural Cure", 1: "Leaf Guard", H: "Healer"},
		heightm: 1.55,
		weightkg: 81.6,
		color: "Pink",
		evos: ["Blissey"],
	...
	klinklanghaxorus: {
		num: 10688,
		name: "klinklanghaxorus",
		types: ["Steel", "Dragon"],
		baseStats: {hp: 65, atk: 131, def: 98, spa: 66, spd: 80, spe: 94},
		abilities: {0: "Plus", 1: "Mold Breaker", H: "Clear Body"},
		heightm: 1.2,
		weightkg: 93.25,
		color: "Gray",
		eggGroups: ["Monster", "Mineral"],
	...
	rhyperiorcradily: {
		num: 10689,
		name: "rhyperiorcradily",
		types: ["Ground", "Grass"],
		baseStats: {hp: 105, atk: 100, def: 108, spa: 63, spd: 72, spe: 42},
		abilities: {0: "Lightning Rod", 1: "Storm Drain", H: "Reckless"},
		heightm: 1.95,
		weightkg: 171.6,
		color: "Gray",
		eggGroups: ["Water 3", "Monster"],
	...
	giratinarhyperior: {
		num: 10690,
		name: "giratinarhyperior",
		types: ["Ghost", "Rock"],
		baseStats: {hp: 138, atk: 126, def: 126, spa: 85, spd: 98, spe: 56},
		abilities: {0: "Pressure", 1: "Solid Rock", H: "Telepathy"},
		heightm: 3.45,
		weightkg: 516.4,
		color: "Black",
		eggGroups: ["Monster", "Undiscovered"],
	...
	clefairyferrothorn: {
		num: 10691,
		name: "clefairyferrothorn",
		types: ["Fairy", "Steel"],
		baseStats: {hp: 71, atk: 77, def: 103, spa: 58, spd: 82, spe: 25},
		abilities: {0: "Cute Charm", 1: "Anticipation", H: "Friend Guard"},
		heightm: 0.8,
		weightkg: 58.75,
		color: "Pink",
		evos: ["Clefable"],
	...
	latiassalamence: {
		num: 10692,
		name: "latiassalamence",
		types: ["Dragon", "Flying"],
		baseStats: {hp: 85, atk: 116, def: 83, spa: 110, spd: 113, spe: 103},
		abilities: {0: "Levitate", 1: "Intimidate", H: "Moxie"},
		heightm: 1.45,
		weightkg: 71.3,
		color: "Red",
		eggGroups: ["Dragon", "Undiscovered"],
	...
	palkiagallade: {
		...
		abilities: {0: "Pressure", 1: "Justified", H: "Telepathy"},
		heightm: 2.9000000000000004,
		weightkg: 194,
		color: "Purple",
		eggGroups: ["Human-Like", "Undiscovered"],
	},
	zapdoshydreigon: {
		num: 10694,
		name: "zapdoshydreigon",
		types: ["Electric", "Dragon"],
		baseStats: {hp: 90, atk: 100, def: 88, spa: 125, spd: 90, spe: 98},
		abilities: {0: "Pressure", 1: "Levitate", H: "Static"},
		heightm: 1.7000000000000002,
		weightkg: 106.3,
		color: "Yellow",
		eggGroups: ["Dragon", "Undiscovered"],
	...
	empoleontyranitar: {
		num: 10695,
		name: "empoleontyranitar",
		types: ["Water", "Dark"],
		baseStats: {hp: 89, atk: 118, def: 102, spa: 105, spd: 100, spe: 60},
		abilities: {0: "Torrent", 1: "Unnerve", H: "Defiant"},
		heightm: 1.85,
		weightkg: 143.25,
		color: "Blue",
		eggGroups: ["Monster", "Water 1"],
	...
	salamenceweavile: {
		num: 10696,
		name: "salamenceweavile",
		types: ["Dragon", "Ice"],
		baseStats: {hp: 86, atk: 125, def: 70, spa: 88, spd: 81, spe: 116},
		abilities: {0: "Intimidate", 1: "Pickpocket", H: "Moxie"},
		heightm: 1.3,
		weightkg: 68.3,
		color: "Blue",
		eggGroups: ["Field", "Dragon"],
	...
	cradilyreshiram: {
		num: 10697,
		name: "cradilyreshiram",
		types: ["Rock", "Fire"],
		baseStats: {hp: 90, atk: 107, def: 99, spa: 104, spd: 111, spe: 74},
		abilities: {0: "Suction Cups", 1: "Turboblaze", H: "Storm Drain"},
		heightm: 2.35,
		weightkg: 195.2,
		color: "Green",
		eggGroups: ["Undiscovered", "Water 3"],
	...
	hydreigontentacruel: {
		num: 10698,
		name: "hydreigontentacruel",
		types: ["Dark", "Poison"],
		baseStats: {hp: 88, atk: 81, def: 73, spa: 110, spd: 100, spe: 99},
		abilities: {0: "Levitate", 1: "Liquid Ooze", H: "Rain Dish"},
		heightm: 1.7000000000000002,
		weightkg: 107,
		color: "Blue",
	...
	sylveonarcanine: {
		num: 10699,
		name: "sylveonarcanine",
		types: ["Fairy", "Fire"],
		baseStats: {hp: 93, atk: 95, def: 75, spa: 106, spd: 113, spe: 83},
		abilities: {0: "Cute Charm", 1: "Flash Fire", H: "Pixilate"},
		heightm: 1.45,
		weightkg: 89.25,
		color: "Pink",
		eggGroups: ["Field", "Field"],
	...
	hoohquagsire: {
		...
		name: "hoohquagsire",
		types: ["Fire", "Ground"],
		baseStats: {hp: 102, atk: 100, def: 86, spa: 95, spd: 124, spe: 53},
		abilities: {0: "Pressure", 1: "Water Absorb", H: "Regenerator"},
	...
	shuckledragonite: {
		...
		abilities: {0: "Sturdy", 1: "Multiscale", H: "Contrary"},
		heightm: 1.4000000000000001,
		weightkg: 115.25,
		color: "Yellow",
		eggGroups: ["Water 1", "Bug"],
	},
	hoohxatu: {
		...
		name: "hoohxatu",
		types: ["Fire", "Flying"],
		baseStats: {hp: 92, atk: 93, def: 76, spa: 105, spd: 126, spe: 93},
		abilities: {0: "Pressure", 1: "Early Bird", H: "Regenerator"},
		heightm: 2.65,
		weightkg: 107,
		color: "Red",
		eggGroups: ["Flying", "Undiscovered"],
	...
	dialgaweezing: {
		...
		name: "dialgaweezing",
		types: ["Steel", "Poison"],
		baseStats: {hp: 88, atk: 100, def: 120, spa: 128, spd: 90, spe: 70},
		abilities: {0: "Pressure", 1: "Neutralizing Gas", H: "Telepathy"},
		heightm: 3.3000000000000003,
		weightkg: 346.25,
		color: "White",
		eggGroups: ["Amorphous", "Undiscovered"],
	},
	ursaringdarkrai: {
		num: 10704,
		name: "ursaringdarkrai",
		types: ["Normal", "Dark"],
		baseStats: {hp: 83, atk: 103, def: 85, spa: 95, spd: 80, spe: 101},
		abilities: {0: "Guts", 1: "Bad Dreams", H: "Unnerve"},
		heightm: 1.65,
		weightkg: 88.15,
		color: "Brown",
		eggGroups: ["Undiscovered", "Field"],
	...
	chandeluremilotic: {
		num: 10705,
		name: "chandeluremilotic",
		types: ["Ghost", "Water"],
		baseStats: {hp: 71, atk: 58, def: 82, spa: 130, spd: 101, spe: 80},
		abilities: {0: "Flash Fire", 1: "Competitive", H: "Infiltrator"},
		heightm: 3.6,
		weightkg: 98.15,
		color: "Black",
		eggGroups: ["Water 1", "Amorphous"],
	...
	vaporeonlugia: {
		...
		name: "vaporeonlugia",
		types: ["Water", "Flying"],
		baseStats: {hp: 122, atk: 81, def: 106, spa: 103, spd: 114, spe: 95},
	...
	charizarddarkrai: {
		num: 10707,
		name: "charizarddarkrai",
		types: ["Fire", "Dark"],
		baseStats: {hp: 75, atk: 88, def: 86, spa: 117, spd: 86, spe: 116},
		abilities: {0: "Blaze", 1: "Bad Dreams", H: "Solar Power"},
		heightm: 1.6,
		weightkg: 70.5,
		color: "Red",
		eggGroups: ["Undiscovered", "Monster"],
	...
	chandeluretalonflame: {
		num: 10708,
		name: "chandeluretalonflame",
		types: ["Ghost", "Flying"],
		baseStats: {hp: 66, atk: 72, def: 77, spa: 121, spd: 83, spe: 110},
		abilities: {0: "Flash Fire", 1: "Gale Wings", H: "Infiltrator"},
		heightm: 1.1,
		weightkg: 29.4,
		color: "Black",
		eggGroups: ["Flying", "Amorphous"],
	...
	omastardeoxys: {
		...
		name: "omastardeoxys",
		types: ["Water", "Psychic"],
		baseStats: {hp: 63, atk: 120, def: 75, spa: 126, spd: 63, spe: 118},
		abilities: {0: "Swift Swim", 1: "Pressure", H: "Weak Armor"},
		heightm: 1.35,
		weightkg: 47.9,
		color: "Blue",
	...
	magnezonelatios: {
		num: 10710,
		name: "magnezonelatios",
		types: ["Steel", "Psychic"],
		baseStats: {hp: 73, atk: 83, def: 91, spa: 130, spd: 96, spe: 93},
	...
	moltreshooh: {
		...
		name: "moltreshooh",
		types: ["Fire", "Flying"],
		baseStats: {hp: 95, atk: 120, def: 90, spa: 120, spd: 108, spe: 90},
	...
	porygonztyphlosion: {
		num: 10712,
		name: "porygonztyphlosion",
		types: ["Normal", "Fire"],
		baseStats: {hp: 82, atk: 82, def: 75, spa: 126, spd: 78, spe: 96},
		abilities: {0: "Adaptability", 1: "Flash Fire", H: "Analytic"},
		heightm: 1.3,
		weightkg: 56.75,
		color: "Red",
		eggGroups: ["Field", "Mineral"],
	...
	aegislashlugia: {
		...
		abilities: {0: "Stance Change", 1: "Pressure", H: "Multiscale"},
		heightm: 3.45,
		weightkg: 134,
		color: "Brown",
		eggGroups: ["Undiscovered", "Mineral"],
	...
	hoohsteelix: {
		...
		name: "hoohsteelix",
		types: ["Fire", "Steel"],
		baseStats: {hp: 95, atk: 100, def: 163, spa: 91, spd: 124, spe: 50},
		abilities: {0: "Pressure", 1: "Sturdy", H: "Regenerator"},
		heightm: 6.5,
		weightkg: 299,
		color: "Red",
	...
	volcaronaomastar: {
		num: 10715,
		name: "volcaronaomastar",
		types: ["Bug", "Rock"],
		baseStats: {hp: 80, atk: 60, def: 105, spa: 128, spd: 93, spe: 70},
		abilities: {0: "Flame Body", 1: "Shell Armor", H: "Swarm"},
		heightm: 1.3,
		weightkg: 40,
		color: "White",
		eggGroups: ["Water 1", "Bug"],
	...
	cloysterkrookodile: {
		num: 10716,
		name: "cloysterkrookodile",
		types: ["Water", "Dark"],
		baseStats: {hp: 65, atk: 109, def: 113, spa: 78, spd: 53, spe: 84},
		abilities: {0: "Shell Armor", 1: "Moxie", H: "Overcoat"},
		heightm: 1.5,
		weightkg: 114.4,
		color: "Purple",
	...
	dialgasalamence: {
		num: 10717,
		name: "dialgasalamence",
		types: ["Steel", "Flying"],
		baseStats: {hp: 98, atk: 130, def: 93, spa: 136, spd: 93, spe: 96},
		abilities: {0: "Pressure", 1: "Moxie", H: "Telepathy"},
		heightm: 3.45,
		weightkg: 392.8,
		color: "White",
		eggGroups: ["Dragon", "Undiscovered"],
	...
	sylveontentacruel: {
		num: 10718,
		name: "sylveontentacruel",
		types: ["Fairy", "Poison"],
		baseStats: {hp: 90, atk: 68, def: 65, spa: 100, spd: 126, spe: 86},
		abilities: {0: "Cute Charm", 1: "Liquid Ooze", H: "Pixilate"},
		heightm: 1.3,
		weightkg: 39.25,
		color: "Pink",
		eggGroups: ["Water 3", "Field"],
	...
	gyaradossandslash: {
		num: 10720,
		name: "gyaradossandslash",
		types: ["Water", "Ground"],
		baseStats: {hp: 88, atk: 108, def: 99, spa: 55, spd: 85, spe: 70},
		abilities: {0: "Intimidate", 1: "Sand Rush", H: "Moxie"},
		heightm: 3.75,
		weightkg: 132.25,
		color: "Blue",
		eggGroups: ["Field", "Water 2"],
	...
	slakingregigigas: {
		...
		abilities: {0: "Truant", 1: "Slow Start", H: ""},
		heightm: 2.85,
		weightkg: 275.25,
		color: "Brown",
		eggGroups: ["Undiscovered", "Field"],
	...
	rhyperiorclefable: {
		num: 10722,
		name: "rhyperiorclefable",
		types: ["Ground", "Fairy"],
		baseStats: {hp: 108, atk: 93, def: 92, spa: 68, spd: 66, spe: 53},
		abilities: {0: "Lightning Rod", 1: "Magic Guard", H: "Reckless"},
		heightm: 1.85,
		weightkg: 161.4,
		color: "Gray",
	...
	arcaninetyranitar: {
		num: 10723,
		name: "arcaninetyranitar",
		types: ["Fire", "Dark"],
		baseStats: {hp: 93, atk: 126, def: 100, spa: 98, spd: 86, spe: 72},
		abilities: {0: "Intimidate", 1: "Unnerve", H: "Justified"},
		heightm: 1.95,
		weightkg: 178,
		color: "Brown",
		eggGroups: ["Monster", "Field"],
	...
	glaceonelectrode: {
		num: 10724,
		name: "glaceonelectrode",
		types: ["Ice", "Electric"],
		baseStats: {hp: 63, atk: 53, def: 83, spa: 113, spd: 90, spe: 121},
		abilities: {0: "Snow Cloak", 1: "Static", H: "Ice Body"},
		heightm: 1.0,
		weightkg: 46.25,
		color: "Blue",
		eggGroups: ["Mineral", "Field"],
	...
	torterratyranitar: {
		num: 10725,
		name: "torterratyranitar",
		types: ["Grass", "Dark"],
		baseStats: {hp: 96, atk: 125, def: 108, spa: 81, spd: 90, spe: 59},
		abilities: {0: "Overgrow", 1: "Unnerve", H: "Shell Armor"},
		heightm: 2.1,
		weightkg: 256,
		color: "Green",
		eggGroups: ["Monster", "Monster"],
	...
	klefkigalvantula: {
		num: 10726,
		name: "klefkigalvantula",
		types: ["Steel", "Electric"],
		baseStats: {hp: 61, atk: 78, def: 70, spa: 85, spd: 78, spe: 97},
		abilities: {0: "Prankster", 1: "Unnerve", H: "Magician"},
		heightm: 0.5,
		weightkg: 8.65,
		color: "Gray",
		eggGroups: ["Bug", "Mineral"],
	...
	sceptilemagmortar: {
		...
		abilities: {0: "Overgrow", 1: "Vital Spirit", H: "Unburden"},
		heightm: 1.65,
		weightkg: 60.1,
		color: "Green",
		eggGroups: ["Human-Like", "Monster"],
	...
	tyranitarprobopass: {
		num: 10728,
		name: "tyranitarprobopass",
		types: ["Rock", "Steel"],
		baseStats: {hp: 86, atk: 81, def: 133, spa: 88, spd: 116, spe: 47},
		abilities: {0: "Sand Stream", 1: "Magnet Pull", H: "Unnerve"},
		heightm: 1.7,
		weightkg: 271,
		color: "Green",
		eggGroups: ["Mineral", "Monster"],
	...
	jolteonarbok: {
		...
		name: "jolteonarbok",
		types: ["Electric", "Poison"],
		baseStats: {hp: 63, atk: 85, def: 66, spa: 95, spd: 89, spe: 96},
		abilities: {0: "Volt Absorb", 1: "Shed Skin", H: "Quick Feet"},
		heightm: 2.15,
		weightkg: 44.75,
		color: "Yellow",
		eggGroups: ["Field", "Field"],
	...
	golurkrampardos: {
		num: 10730,
		name: "golurkrampardos",
		types: ["Ground", "Rock"],
		baseStats: {hp: 91, atk: 151, def: 66, spa: 58, spd: 70, spe: 57},
		abilities: {0: "Iron Fist", 1: "Sheer Force", H: "No Guard"},
		heightm: 2.2,
		weightkg: 216.25,
		color: "Green",
		eggGroups: ["Monster", "Mineral"],
	...
	chandeluresandslash: {
		num: 10731,
		name: "chandeluresandslash",
		types: ["Ghost", "Ground"],
		baseStats: {hp: 65, atk: 85, def: 103, spa: 111, spd: 78, spe: 70},
		abilities: {0: "Flash Fire", 1: "Sand Rush", H: "Infiltrator"},
		heightm: 1,
		weightkg: 31.9,
		color: "Black",
		eggGroups: ["Field", "Amorphous"],
	...
	jolteongolduck: {
		...
		abilities: {0: "Volt Absorb", 1: "Cloud Nine", H: "Quick Feet"},
		heightm: 1.25,
		weightkg: 50.55,
		color: "Yellow",
		eggGroups: ["Water 1", "Field"],
	...
	volcaronatogekiss: {
		num: 10733,
		name: "volcaronatogekiss",
		types: ["Bug", "Flying"],
		baseStats: {hp: 85, atk: 53, def: 85, spa: 130, spd: 108, spe: 86},
		abilities: {0: "Flame Body", 1: "Serene Grace", H: "Swarm"},
		heightm: 1.55,
		weightkg: 42,
		color: "White",
		eggGroups: ["Flying", "Bug"],
	...
	hitmonleepoliwrath: {
		...
		abilities: {0: "Limber", 1: "Damp", H: "Unburden"},
		heightm: 1.4,
		weightkg: 51.9,
		color: "Brown",
		eggGroups: ["Water 1", "Human-Like"],
	...
	aggronpinsir: {
		...
		abilities: {0: "Sturdy", 1: "Mold Breaker", H: "Heavy Metal"},
		heightm: 1.8,
		weightkg: 207,
		color: "Gray",
		eggGroups: ["Bug", "Monster"],
	...
	lickilickydusknoir: {
		num: 10736,
		name: "lickilickydusknoir",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 88, atk: 95, def: 121, spa: 75, spd: 108, spe: 46},
		abilities: {0: "Own Tempo", 1: "Frisk", H: "Cloud Nine"},
	...
	venusaurninetales: {
		num: 10737,
		name: "venusaurninetales",
		types: ["Grass", "Fire"],
		baseStats: {hp: 77, atk: 78, def: 77, spa: 93, spd: 100, spe: 93},
		abilities: {0: "Overgrow", 1: "Drought", H: "Chlorophyll"},
		heightm: 1.55,
		weightkg: 59.95,
		color: "Green",
	...
	kangaskhangolurk: {
		num: 10738,
		name: "kangaskhangolurk",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 99, atk: 114, def: 80, spa: 45, spd: 80, spe: 66},
		abilities: {0: "Early Bird", 1: "Klutz", H: "Inner Focus"},
		heightm: 2.5,
		weightkg: 205,
		color: "Brown",
		eggGroups: ["Mineral", "Monster"],
	...
	dugtrioaerodactyl: {
		num: 10739,
		name: "dugtrioaerodactyl",
		types: ["Ground", "Flying"],
		baseStats: {hp: 50, atk: 103, def: 60, spa: 53, spd: 71, spe: 126},
		abilities: {0: "Sand Veil", 1: "Pressure", H: "Sand Force"},
		heightm: 1.25,
		weightkg: 46.15,
		color: "Brown",
		eggGroups: ["Flying", "Field"],
	...
	omastargardevoir: {
		num: 10741,
		name: "omastargardevoir",
		types: ["Water", "Fairy"],
		baseStats: {hp: 69, atk: 63, def: 85, spa: 118, spd: 85, spe: 71},
		abilities: {0: "Swift Swim", 1: "Trace", H: "Weak Armor"},
		heightm: 1.3,
		weightkg: 41.7,
		color: "Blue",
		eggGroups: ["Human-Like", "Water 1"],
	...
	bisharpscizor: {
		...
		name: "bisharpscizor",
		types: ["Dark", "Bug"],
		baseStats: {hp: 66, atk: 128, def: 100, spa: 58, spd: 73, spe: 66},
	...
	magmortarmuk: {
		...
		name: "magmortarmuk",
		types: ["Fire", "Poison"],
		baseStats: {hp: 85, atk: 101, def: 72, spa: 105, spd: 96, spe: 61},
		abilities: {0: "Flame Body", 1: "Sticky Hold", H: "Vital Spirit"},
		heightm: 1.4,
		weightkg: 49,
		color: "Red",
		eggGroups: ["Amorphous", "Human-Like"],
	...
	mukmachamp: {
		...
		name: "mukmachamp",
		types: ["Poison", "Fighting"],
		baseStats: {hp: 100, atk: 121, def: 78, spa: 65, spd: 95, spe: 53},
		abilities: {0: "Stench", 1: "No Guard", H: "Poison Touch"},
		heightm: 1.4,
		weightkg: 80,
		color: "Purple",
		eggGroups: ["Human-Like", "Amorphous"],
	...
	blazikenheracross: {
		num: 10745,
		name: "blazikenheracross",
		types: ["Fire", "Fighting"],
		baseStats: {hp: 80, atk: 123, def: 73, spa: 86, spd: 78, spe: 83},
		abilities: {0: "Blaze", 1: "Guts", H: "Speed Boost"},
		heightm: 1.7,
		weightkg: 53,
		color: "Red",
		eggGroups: ["Bug", "Field"],
	...
	gengarweezing: {
		...
		abilities: {0: "Cursed Body", 1: "Neutralizing Gas", H: "Stench"},
		heightm: 1.35,
		weightkg: 25.0,
		color: "Purple",
		eggGroups: ["Amorphous", "Amorphous"],
	...
	whimsicottdoublade: {
		num: 10747,
		name: "whimsicottdoublade",
		types: ["Grass", "Ghost"],
		baseStats: {hp: 59, atk: 95, def: 128, spa: 66, spd: 66, spe: 62},
		abilities: {0: "Prankster", 1: "No Guard", H: "Chlorophyll"},
		heightm: 0.75,
		weightkg: 5.55,
		color: "Green",
		evos: ["Aegislash"],
	...
	zoroarklucario: {
		...
		name: "zoroarklucario",
		types: ["Dark", "Steel"],
		baseStats: {hp: 63, atk: 108, def: 66, spa: 118, spd: 63, spe: 95},
		abilities: {0: "Illusion", 1: "Inner Focus", H: "Justified"},
		heightm: 1.4,
		weightkg: 67.55,
		color: "Gray",
		eggGroups: ["Field", "Field"],
	...
	golurksalamence: {
		num: 10750,
		name: "golurksalamence",
		types: ["Ground", "Flying"],
		baseStats: {hp: 91, atk: 131, def: 80, spa: 73, spd: 80, spe: 85},
	...
	golurkgallade: {
		...
		name: "golurkgallade",
		types: ["Ground", "Fighting"],
		baseStats: {hp: 82, atk: 124, def: 70, spa: 58, spd: 91, spe: 71},
		abilities: {0: "Iron Fist", 1: "Justified", H: "No Guard"},
		heightm: 2.2,
		weightkg: 191,
		color: "Green",
		eggGroups: ["Human-Like", "Mineral"],
	...
	slowkingshuckle: {
		num: 10752,
		name: "slowkingshuckle",
		types: ["Water", "Rock"],
		baseStats: {hp: 70, atk: 31, def: 180, spa: 70, spd: 150, spe: 13},
		abilities: {0: "Oblivious", 1: "Gluttony", H: "Regenerator"},
		heightm: 1.3,
		weightkg: 50.0,
		color: "Pink",
		eggGroups: ["Bug", "Monster"],
	...
	quagsiresandslash: {
		num: 10754,
		name: "quagsiresandslash",
		types: ["Water", "Ground"],
		baseStats: {hp: 88, atk: 95, def: 101, spa: 58, spd: 61, spe: 55},
		abilities: {0: "Damp", 1: "Sand Rush", H: "Unaware"},
		heightm: 1.2,
		weightkg: 52.25,
		color: "Blue",
	...
	glaceonroserade: {
		num: 10755,
		name: "glaceonroserade",
		types: ["Ice", "Poison"],
		baseStats: {hp: 63, atk: 66, def: 80, spa: 128, spd: 98, spe: 81},
		abilities: {0: "Snow Cloak", 1: "Poison Point", H: "Ice Body"},
		heightm: 0.8500000000000001,
		weightkg: 20.2,
		color: "Blue",
		eggGroups: ["Fairy", "Field"],
	...
	slowpokemuk: {
		...
		name: "slowpokemuk",
		types: ["Water", "Poison"],
		baseStats: {hp: 95, atk: 91, def: 71, spa: 48, spd: 60, spe: 38},
		abilities: {0: "Oblivious", 1: "Sticky Hold", H: "Regenerator"},
		heightm: 1.2,
		weightkg: 33,
		color: "Pink",
		evos: ["SlowbroSlowking"],
		eggGroups: ["Amorphous", "Monster"],
	},
	reuniclusumbreon: {
		num: 10757,
		name: "reuniclusumbreon",
		types: ["Psychic", "Dark"],
		baseStats: {hp: 105, atk: 65, def: 98, spa: 103, spd: 100, spe: 53},
		abilities: {0: "Overcoat", 1: "Inner Focus", H: "Regenerator"},
		heightm: 1,
		weightkg: 23.55,
		color: "Green",
		eggGroups: ["Field", "Amorphous"],
	...
	doublademachamp: {
		num: 10759,
		name: "doublademachamp",
		types: ["Steel", "Fighting"],
		baseStats: {hp: 69, atk: 123, def: 103, spa: 51, spd: 61, spe: 48},
		abilities: {0: "No Guard", 1: "Guts", H: "Steadfast"},
		heightm: 1.2000000000000002,
		weightkg: 67.25,
		color: "Brown",
		evos: ["Aegislash"],
	...
	haxoruscloyster: {
		num: 10760,
		name: "haxoruscloyster",
		types: ["Dragon", "Ice"],
		baseStats: {hp: 67, atk: 112, def: 150, spa: 68, spd: 61, spe: 79},
		abilities: {0: "Rivalry", 1: "Skill Link", H: "Unnerve"},
		heightm: 1.65,
		weightkg: 119.0,
		color: "Yellow",
		eggGroups: ["Water 3", "Monster"],
	...
	reunicluscofagrigus: {
		num: 10761,
		name: "reunicluscofagrigus",
		types: ["Psychic", "Ghost"],
		baseStats: {hp: 92, atk: 55, def: 121, spa: 115, spd: 91, spe: 30},
		abilities: {0: "Overcoat", 1: "Mummy", H: "Regenerator"},
		heightm: 1.35,
		weightkg: 48.3,
		color: "Green",
		eggGroups: ["Mineral", "Amorphous"],
	...
	crobatheracross: {
		...
		abilities: {0: "Inner Focus", 1: "Guts", H: "Infiltrator"},
		heightm: 1.65,
		weightkg: 64,
		color: "Purple",
		eggGroups: ["Bug", "Flying"],
	...
	marowakcloyster: {
		num: 10763,
		name: "marowakcloyster",
		types: ["Ground", "Ice"],
		baseStats: {hp: 56, atk: 90, def: 156, spa: 61, spd: 68, spe: 61},
		abilities: {0: "Rock Head", 1: "Skill Link", H: "Battle Armor"},
		heightm: 1.25,
		weightkg: 88.75,
		color: "Brown",
	...
	roseradedragonite: {
		num: 10764,
		name: "roseradedragonite",
		types: ["Grass", "Dragon"],
		baseStats: {hp: 70, atk: 112, def: 85, spa: 116, spd: 103, spe: 83},
		abilities: {0: "Natural Cure", 1: "Multiscale", H: "Technician"},
		heightm: 1.55,
		weightkg: 112.25,
		color: "Green",
		eggGroups: ["Water 1", "Fairy"],
	...
	porygonzvenomoth: {
		num: 10765,
		name: "porygonzvenomoth",
		types: ["Normal", "Poison"],
		baseStats: {hp: 80, atk: 70, def: 63, spa: 120, spd: 75, spe: 90},
		abilities: {0: "Adaptability", 1: "Tinted Lens", H: "Analytic"},
		heightm: 1.2,
		weightkg: 23.25,
		color: "Red",
		eggGroups: ["Bug", "Mineral"],
	...
	pinsirkangaskhan: {
		num: 10766,
		name: "pinsirkangaskhan",
		types: ["Bug", "Normal"],
		baseStats: {hp: 78, atk: 105, def: 86, spa: 50, spd: 73, spe: 88},
		abilities: {0: "Hyper Cutter", 1: "Scrappy", H: "Moxie"},
		heightm: 1.85,
		weightkg: 67,
		color: "Brown",
		eggGroups: ["Monster", "Bug"],
	...
	kingdragengar: {
		...
		name: "kingdragengar",
		types: ["Water", "Ghost"],
		baseStats: {hp: 70, atk: 75, def: 71, spa: 106, spd: 88, spe: 101},
		abilities: {0: "Swift Swim", 1: "Cursed Body", H: "Damp"},
		heightm: 1.65,
		weightkg: 96.25,
		color: "Blue",
		eggGroups: ["Amorphous", "Water 1"],
	...
	doubladeflygon: {
		...
		abilities: {0: "No Guard", 1: "Levitate", H: ""},
		heightm: 1.4,
		weightkg: 43.25,
		color: "Brown",
		evos: ["Aegislash"],
	...
	gengarhitmonlee: {
		num: 10769,
		name: "gengarhitmonlee",
		types: ["Ghost", "Fighting"],
		baseStats: {hp: 56, atk: 101, def: 55, spa: 98, spd: 86, spe: 94},
		abilities: {0: "Cursed Body", 1: "Reckless", H: "Unburden"},
		heightm: 1.5,
		weightkg: 45.15,
		color: "Purple",
		eggGroups: ["Human-Like", "Amorphous"],
	...
	machampmetagross: {
		num: 10770,
		name: "machampmetagross",
		types: ["Fighting", "Psychic"],
		baseStats: {hp: 86, atk: 133, def: 113, spa: 75, spd: 86, spe: 65},
		abilities: {0: "Guts", 1: "Light Metal", H: "Steadfast"},
		heightm: 1.6,
		weightkg: 340,
		color: "Gray",
		eggGroups: ["Mineral", "Human-Like"],
	...
	blastoisegardevoir: {
		num: 10771,
		name: "blastoisegardevoir",
		types: ["Water", "Fairy"],
		baseStats: {hp: 75, atk: 71, def: 76, spa: 98, spd: 108, spe: 79},
		abilities: {0: "Torrent", 1: "Trace", H: "Rain Dish"},
		heightm: 1.6,
		weightkg: 66.95,
		color: "Blue",
		eggGroups: ["Human-Like", "Monster"],
	...
	starmiepinsir: {
		...
		abilities: {0: "Illuminate", 1: "Mold Breaker", H: "Analytic"},
		heightm: 1.3,
		weightkg: 67,
		color: "Purple",
		eggGroups: ["Bug", "Water 3"],
	...
	hydreigonbastiodon: {
		num: 10773,
		name: "hydreigonbastiodon",
		types: ["Dark", "Steel"],
		baseStats: {hp: 81, atk: 69, def: 142, spa: 99, spd: 106, spe: 52},
		abilities: {0: "Levitate", 1: "Sturdy", H: "Soundproof"},
		heightm: 1.55,
		weightkg: 154.75,
		color: "Blue",
		eggGroups: ["Monster", "Dragon"],
	...
	heracrossaerodactyl: {
		num: 10774,
		name: "heracrossaerodactyl",
		types: ["Bug", "Flying"],
		baseStats: {hp: 80, atk: 111, def: 68, spa: 46, spd: 88, spe: 115},
		abilities: {0: "Swarm", 1: "Pressure", H: "Moxie"},
		heightm: 1.65,
		weightkg: 56,
		color: "Blue",
		eggGroups: ["Flying", "Bug"],
	...
	electrodeazumarill: {
		num: 10776,
		name: "electrodeazumarill",
		types: ["Electric", "Fairy"],
		baseStats: {hp: 73, atk: 50, def: 76, spa: 73, spd: 80, spe: 83},
		abilities: {0: "Soundproof", 1: "Huge Power", H: "Aftermath"},
		heightm: 1.0,
		weightkg: 47.55,
		color: "Red",
		eggGroups: ["Water 1", "Mineral"],
	...
	hitmonchankangaskhan: {
		num: 10777,
		name: "hitmonchankangaskhan",
		types: ["Fighting", "Normal"],
		baseStats: {hp: 68, atk: 98, def: 79, spa: 36, spd: 100, spe: 85},
		abilities: {0: "Keen Eye", 1: "Scrappy", H: "Inner Focus"},
		heightm: 1.8,
		weightkg: 65.1,
		color: "Brown",
		eggGroups: ["Monster", "Human-Like"],
	...
	tangelaaggron: {
		...
		name: "tangelaaggron",
		types: ["Grass", "Rock"],
		baseStats: {hp: 66, atk: 91, def: 158, spa: 86, spd: 46, spe: 53},
		abilities: {0: "Chlorophyll", 1: "Rock Head", H: "Regenerator"},
		heightm: 1.55,
		weightkg: 197,
		color: "Blue",
		evos: ["Tangrowth"],
	...
	pyukumukutogetic: {
		num: 10779,
		name: "pyukumukutogetic",
		types: ["Water", "Flying"],
		baseStats: {hp: 55, atk: 46, def: 100, spa: 46, spd: 121, spe: 28},
		abilities: {0: "Innards Out", 1: "Serene Grace", H: "Unaware"},
		heightm: 0.44999999999999996,
		weightkg: 2.2,
		color: "Black",
		evos: ["Togekiss"],
	...
	dusknoirkangaskhan: {
		...
		abilities: {0: "Pressure", 1: "Scrappy", H: "Frisk"},
		heightm: 2.2,
		weightkg: 93.3,
		color: "Black",
		eggGroups: ["Monster", "Amorphous"],
	...
	pinsirhitmontop: {
		...
		abilities: {0: "Hyper Cutter", 1: "Technician", H: "Moxie"},
		heightm: 1.45,
		weightkg: 51,
		color: "Brown",
		eggGroups: ["Human-Like", "Bug"],
	...
	cofagrigussalamence: {
		num: 10782,
		name: "cofagrigussalamence",
		types: ["Ghost", "Flying"],
		baseStats: {hp: 70, atk: 106, def: 101, spa: 100, spd: 96, spe: 76},
		abilities: {0: "Mummy", 1: "Intimidate", H: "Moxie"},
		heightm: 1.6,
		weightkg: 89.55,
		color: "Yellow",
		eggGroups: ["Dragon", "Mineral"],
	...
	klinklangscizor: {
		num: 10783,
		name: "klinklangscizor",
		types: ["Steel", "Bug"],
		baseStats: {hp: 63, atk: 120, def: 105, spa: 65, spd: 83, spe: 73},
		abilities: {0: "Plus", 1: "Technician", H: "Clear Body"},
		heightm: 1.2,
		weightkg: 99,
		color: "Gray",
	...
	magnezonebreloom: {
		num: 10784,
		name: "magnezonebreloom",
		types: ["Steel", "Fighting"],
		baseStats: {hp: 66, atk: 110, def: 91, spa: 106, spd: 80, spe: 66},
		abilities: {0: "Magnet Pull", 1: "Poison Heal", H: "Analytic"},
		heightm: 1.2,
		weightkg: 109.6,
		color: "Gray",
		eggGroups: ["Fairy", "Mineral"],
	...
	glaceonkingdra: {
		...
		name: "glaceonkingdra",
		types: ["Ice", "Dragon"],
		baseStats: {hp: 68, atk: 83, def: 100, spa: 118, spd: 95, spe: 78},
		abilities: {0: "Snow Cloak", 1: "Sniper", H: "Ice Body"},
		heightm: 1.3,
		weightkg: 88.95,
		color: "Blue",
		eggGroups: ["Water 1", "Field"],
	...
	empoleonsnorlax: {
		num: 10786,
		name: "empoleonsnorlax",
		types: ["Water", "Normal"],
		baseStats: {hp: 109, atk: 102, def: 72, spa: 95, spd: 104, spe: 40},
		abilities: {0: "Torrent", 1: "Thick Fat", H: "Defiant"},
		heightm: 1.9,
		weightkg: 272.25,
		color: "Blue",
		eggGroups: ["Monster", "Water 1"],
	...
	duskullbeldum: {
		...
		name: "duskullbeldum",
		types: ["Ghost", "Psychic"],
		baseStats: {hp: 26, atk: 50, def: 83, spa: 31, spd: 80, spe: 28},
		abilities: {0: "Levitate", 1: "Light Metal", H: "Frisk"},
		heightm: 0.7,
		weightkg: 55.1,
		color: "Black",
		evos: ["MetangDusclops"],
	...
	duskullonix: {
		...
		name: "duskullonix",
		types: ["Ghost", "Rock"],
		baseStats: {hp: 25, atk: 43, def: 136, spa: 30, spd: 75, spe: 55},
		abilities: {0: "Levitate", 1: "Sturdy", H: "Frisk"},
		heightm: 4.800000000000001,
		weightkg: 112,
		color: "Black",
		evos: ["SteelixDusclops"],
		eggGroups: ["Mineral", "Amorphous"],
	},
	typhlosionkrookodile: {
		num: 10790,
		name: "typhlosionkrookodile",
		types: ["Fire", "Dark"],
		baseStats: {hp: 83, atk: 106, def: 79, spa: 94, spd: 80, spe: 94},
		abilities: {0: "Blaze", 1: "Moxie", H: "Flash Fire"},
		heightm: 1.6,
		weightkg: 87.9,
		color: "Yellow",
		eggGroups: ["Field", "Field"],
	...
	slowpokeshieldon: {
		num: 10791,
		name: "slowpokeshieldon",
		types: ["Water", "Steel"],
		baseStats: {hp: 70, atk: 49, def: 100, spa: 40, spd: 56, spe: 25},
		abilities: {0: "Oblivious", 1: "Soundproof", H: "Regenerator"},
		heightm: 0.85,
		weightkg: 46,
		color: "Pink",
		evos: ["BastiodonSlowbroSlowking"],
		eggGroups: ["Monster", "Monster"],
	},
	snubbullbagon: {
		num: 10792,
		name: "snubbullbagon",
		types: ["Fairy", "Dragon"],
		baseStats: {hp: 55, atk: 76, def: 56, spa: 40, spd: 36, spe: 43},
		abilities: {0: "Intimidate", 1: "Sheer Force", H: "Rattled"},
		heightm: 0.6,
		weightkg: 24.95,
		color: "Pink",
		evos: ["ShelgonGranbull"],
		eggGroups: ["Dragon", "Field"],
	},
	tangelamankey: {
		num: 10793,
		name: "tangelamankey",
		types: ["Grass", "Fighting"],
		baseStats: {hp: 56, atk: 71, def: 61, spa: 78, spd: 41, spe: 66},
		abilities: {0: "Chlorophyll", 1: "Anger Point", H: "Regenerator"},
		heightm: 0.75,
		weightkg: 31,
		color: "Blue",
		evos: ["PrimeapeTangrowth"],
		eggGroups: ["Field", "Grass"],
	},
	rioluduskull: {
		num: 10794,
		name: "rioluduskull",
		types: ["Fighting", "Ghost"],
		baseStats: {hp: 33, atk: 50, def: 73, spa: 33, spd: 56, spe: 36},
		abilities: {0: "Steadfast", 1: "Frisk", H: "Prankster"},
		heightm: 0.8,
		weightkg: 19,
		color: "Brown",
	...
	magnezonevenusaur: {
		num: 10795,
		name: "magnezonevenusaur",
		types: ["Steel", "Grass"],
		baseStats: {hp: 73, atk: 78, def: 93, spa: 120, spd: 93, spe: 73},
		abilities: {0: "Magnet Pull", 1: "Chlorophyll", H: "Analytic"},
		heightm: 1.6,
		weightkg: 140,
		color: "Gray",
		eggGroups: ["Monster", "Mineral"],
	...
	reshiramtyranitar: {
		num: 10796,
		name: "reshiramtyranitar",
		types: ["Dragon", "Dark"],
		baseStats: {hp: 100, atk: 129, def: 106, spa: 131, spd: 113, spe: 70},
		abilities: {0: "Turboblaze", 1: "Sand Stream", H: "Unnerve"},
		heightm: 2.6,
		weightkg: 266,
		color: "White",
		eggGroups: ["Monster", "Undiscovered"],
	...
	reshiramsuicune: {
		num: 10797,
		name: "reshiramsuicune",
		types: ["Dragon", "Water"],
		baseStats: {hp: 100, atk: 90, def: 110, spa: 130, spd: 118, spe: 86},
		abilities: {0: "Turboblaze", 1: "Pressure", H: "Inner Focus"},
		heightm: 2.6,
		weightkg: 258,
		color: "White",
		eggGroups: ["Undiscovered", "Undiscovered"],
	...
	zekromcloyster: {
		...
		name: "zekromcloyster",
		types: ["Dragon", "Ice"],
		baseStats: {hp: 83, atk: 113, def: 160, spa: 108, spd: 81, spe: 76},
		abilities: {0: "Teravolt", 1: "Skill Link", H: "Overcoat"},
		heightm: 2.2,
		weightkg: 238.75,
		color: "Black",
		eggGroups: ["Water 3", "Undiscovered"],
	...
	blisseyweezing: {
		...
		name: "blisseyweezing",
		types: ["Normal", "Poison"],
		baseStats: {hp: 191, atk: 63, def: 83, spa: 78, spd: 113, spe: 58},
		abilities: {0: "Natural Cure", 1: "Neutralizing Gas", H: "Healer"},
		heightm: 1.35,
		weightkg: 28.15,
		color: "Pink",
		eggGroups: ["Amorphous", "Fairy"],
	...
	mewtwoblastoise: {
		num: 10800,
		name: "mewtwoblastoise",
		types: ["Psychic", "Water"],
		baseStats: {hp: 97, atk: 92, def: 96, spa: 131, spd: 95, spe: 95},
		abilities: {0: "Pressure", 1: "Rain Dish", H: "Unnerve"},
		heightm: 1.8,
		weightkg: 103.75,
		color: "Purple",
		eggGroups: ["Monster", "Undiscovered"],
	...
	dialgainfernape: {
		num: 10801,
		name: "dialgainfernape",
		types: ["Steel", "Fighting"],
		baseStats: {hp: 92, atk: 109, def: 87, spa: 134, spd: 90, spe: 102},
		abilities: {0: "Pressure", 1: "Iron Fist", H: "Telepathy"},
		heightm: 3.3000000000000003,
		weightkg: 369,
		color: "White",
	...
	dialgasceptile: {
		...
		name: "dialgasceptile",
		types: ["Steel", "Grass"],
		baseStats: {hp: 90, atk: 96, def: 83, spa: 135, spd: 95, spe: 110},
		abilities: {0: "Pressure", 1: "Unburden", H: "Telepathy"},
		heightm: 3.5500000000000003,
		weightkg: 367.6,
		color: "White",
		eggGroups: ["Monster", "Undiscovered"],
	},
	luxraygroudon: {
		...
		baseStats: {hp: 86, atk: 140, def: 119, spa: 96, spd: 82, spe: 83},
		abilities: {0: "Rivalry", 1: "Drought", H: "Guts"},
		heightm: 2.45,
		weightkg: 496,
		color: "Blue",
		eggGroups: ["Undiscovered", "Field"],
	...
	hitmontopregigigas: {
		num: 10804,
		name: "hitmontopregigigas",
		types: ["Fighting", "Normal"],
		baseStats: {hp: 70, atk: 138, def: 105, spa: 50, spd: 110, spe: 90},
		abilities: {0: "Intimidate", 1: "Slow Start", H: "Steadfast"},
		heightm: 2.55,
		weightkg: 234,
		color: "Brown",
		eggGroups: ["Undiscovered", "Human-Like"],
	...
	alakazamtyphlosion: {
		num: 10805,
		name: "alakazamtyphlosion",
		types: ["Psychic", "Fire"],
		baseStats: {hp: 62, atk: 72, def: 67, spa: 126, spd: 91, spe: 106},
		abilities: {0: "Synchronize", 1: "Flash Fire", H: "Magic Guard"},
		heightm: 1.6,
		weightkg: 63.75,
		color: "Brown",
		eggGroups: ["Field", "Human-Like"],
	...
	dialgakyurem: {
		...
		name: "dialgakyurem",
		types: ["Steel", "Ice"],
		baseStats: {hp: 108, atk: 126, def: 100, spa: 143, spd: 96, spe: 93},
		abilities: {0: "Pressure", H: "Telepathy"},
		heightm: 4.2,
		weightkg: 504,
		color: "White",
	...
	slowkinggiratina: {
		num: 10807,
		name: "slowkinggiratina",
		types: ["Water", "Dragon"],
		baseStats: {hp: 113, atk: 91, def: 106, spa: 100, spd: 113, spe: 70},
		abilities: {0: "Oblivious", 1: "Telepathy", H: "Regenerator"},
		heightm: 3.25,
		weightkg: 414.75,
		color: "Pink",
		eggGroups: ["Undiscovered", "Monster"],
	...
	salamenceslaking: {
		num: 10808,
		name: "salamenceslaking",
		types: ["Dragon", "Normal"],
		baseStats: {hp: 113, atk: 151, def: 93, spa: 105, spd: 75, spe: 100},
		abilities: {0: "Intimidate", 1: "Truant", H: "Moxie"},
		heightm: 1.75,
		weightkg: 116.55,
		color: "Blue",
		eggGroups: ["Field", "Dragon"],
	...
	volcaronabreloom: {
		num: 10809,
		name: "volcaronabreloom",
		types: ["Bug", "Fighting"],
		baseStats: {hp: 76, atk: 106, def: 75, spa: 110, spd: 90, spe: 80},
		abilities: {0: "Flame Body", 1: "Poison Heal", H: "Swarm"},
		heightm: 1.4,
		weightkg: 42.6,
		color: "White",
		eggGroups: ["Fairy", "Bug"],
	...
	magnezonedragonite: {
		num: 10810,
		name: "magnezonedragonite",
		types: ["Steel", "Dragon"],
		baseStats: {hp: 77, atk: 112, def: 101, spa: 120, spd: 93, spe: 73},
		abilities: {0: "Magnet Pull", 1: "Multiscale", H: "Analytic"},
		heightm: 1.7000000000000002,
		weightkg: 195,
		color: "Gray",
		eggGroups: ["Water 1", "Mineral"],
	...
	slowkingcelebi: {
		...
		abilities: {0: "Oblivious", 1: "Natural Cure", H: "Regenerator"},
		heightm: 1.3,
		weightkg: 42.25,
		color: "Pink",
		eggGroups: ["Undiscovered", "Monster"],
	...
	rayquazajolteon: {
		num: 10812,
		name: "rayquazajolteon",
		types: ["Dragon", "Electric"],
		baseStats: {hp: 91, atk: 93, def: 70, spa: 136, spd: 91, spe: 118},
		abilities: {0: "Air Lock", 1: "Volt Absorb", H: "Quick Feet"},
		heightm: 3.9,
		weightkg: 115.5,
		color: "Green",
		eggGroups: ["Field", "Undiscovered"],
	...
	lucariogroudon: {
		...
		name: "lucariogroudon",
		types: ["Fighting", "Ground"],
		baseStats: {hp: 80, atk: 136, def: 116, spa: 110, spd: 76, spe: 90},
		abilities: {0: "Steadfast", 1: "Drought", H: "Justified"},
		heightm: 2.35,
		weightkg: 502,
		color: "Blue",
		eggGroups: ["Undiscovered", "Field"],
	...
	groudonweavile: {
		...
		name: "groudonweavile",
		types: ["Ground", "Ice"],
		baseStats: {hp: 90, atk: 130, def: 90, spa: 81, spd: 88, spe: 113},
		abilities: {0: "Drought", 1: "Pressure", H: "Pickpocket"},
		heightm: 2.3,
		weightkg: 492,
		color: "Red",
		eggGroups: ["Field", "Undiscovered"],
	...
	kyogretalonflame: {
		num: 10816,
		name: "kyogretalonflame",
		types: ["Water", "Flying"],
		baseStats: {hp: 92, atk: 87, def: 77, spa: 124, spd: 116, spe: 114},
		abilities: {0: "Drizzle", 1: "Flame Body", H: "Gale Wings"},
		heightm: 2.85,
		weightkg: 188.25,
		color: "Blue",
		eggGroups: ["Flying", "Undiscovered"],
	...
	snorlaxgroudon: {
		...
		name: "snorlaxgroudon",
		types: ["Normal", "Ground"],
		baseStats: {hp: 140, atk: 136, def: 115, spa: 76, spd: 103, spe: 70},
		abilities: {0: "Thick Fat", 1: "Drought", H: "Gluttony"},
		heightm: 2.8,
		weightkg: 705,
		color: "Black",
		eggGroups: ["Undiscovered", "Monster"],
	...
	latiosarcanine: {
		...
		name: "latiosarcanine",
		types: ["Dragon", "Fire"],
		baseStats: {hp: 83, atk: 103, def: 80, spa: 120, spd: 100, spe: 100},
		abilities: {0: "Levitate", 1: "Intimidate", H: "Justified"},
		heightm: 1.95,
		weightkg: 107,
		color: "Blue",
		eggGroups: ["Field", "Undiscovered"],
	...
	hoohaerodactyl: {
		...
		name: "hoohaerodactyl",
		types: ["Fire", "Flying"],
		baseStats: {hp: 97, atk: 113, def: 73, spa: 93, spd: 127, spe: 116},
		abilities: {0: "Pressure", 1: "Rock Head", H: "Regenerator"},
		heightm: 2.8,
		weightkg: 129,
		color: "Red",
		eggGroups: ["Flying", "Undiscovered"],
	...
	porygonzgengar: {
		...
		name: "porygonzgengar",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 76, atk: 70, def: 63, spa: 133, spd: 75, spe: 103},
		abilities: {0: "Adaptability", 1: "Cursed Body", H: "Analytic"},
		heightm: 1.2,
		weightkg: 37.25,
		color: "Red",
		eggGroups: ["Amorphous", "Mineral"],
	...
	kecleonrayquaza: {
		num: 10821,
		name: "kecleonrayquaza",
		types: ["Normal", "Flying"],
		baseStats: {hp: 75, atk: 130, def: 83, spa: 90, spd: 110, spe: 76},
		abilities: {0: "Color Change", 1: "Air Lock", H: "Protean"},
		heightm: 4,
		weightkg: 114.25,
		color: "Green",
		eggGroups: ["Undiscovered", "Field"],
	...
	slowkingpalkia: {
		...
		name: "slowkingpalkia",
		types: ["Water", "Dragon"],
		baseStats: {hp: 93, atk: 105, def: 93, spa: 116, spd: 113, spe: 76},
		abilities: {0: "Oblivious", 1: "Telepathy", H: "Regenerator"},
		heightm: 3.1,
		weightkg: 207.75,
		color: "Pink",
	...
	rayquazamilotic: {
		num: 10823,
		name: "rayquazamilotic",
		types: ["Dragon", "Water"],
		baseStats: {hp: 101, atk: 90, def: 82, spa: 133, spd: 101, spe: 85},
		abilities: {0: "Air Lock", 1: "Competitive", H: "Cute Charm"},
		heightm: 6.6,
		weightkg: 184.25,
		color: "Green",
		eggGroups: ["Water 1", "Undiscovered"],
	...
	mewtwosmeargle: {
		...
		name: "mewtwosmeargle",
		types: ["Psychic", "Normal"],
		baseStats: {hp: 89, atk: 50, def: 53, spa: 109, spd: 75, spe: 93},
		abilities: {0: "Pressure", 1: "Technician", H: "Unnerve"},
		heightm: 1.6,
		weightkg: 90,
		color: "Purple",
		eggGroups: ["Field", "Undiscovered"],
	...
	nidokingweavile: {
		num: 10825,
		name: "nidokingweavile",
		types: ["Poison", "Ice"],
		baseStats: {hp: 77, atk: 114, def: 69, spa: 71, spd: 78, spe: 111},
		abilities: {0: "Poison Point", 1: "Pickpocket", H: "Sheer Force"},
		heightm: 1.25,
		weightkg: 48,
		color: "Purple",
		eggGroups: ["Field", "Monster"],
	...
	blisseyninjask: {
		...
		name: "blisseyninjask",
		types: ["Normal", "Flying"],
		baseStats: {hp: 190, atk: 63, def: 33, spa: 66, spd: 106, spe: 125},
		abilities: {0: "Natural Cure", 1: "Infiltrator", H: "Healer"},
		heightm: 1.15,
		weightkg: 29.4,
		color: "Pink",
		eggGroups: ["Bug", "Fairy"],
	...
	latiasweezing: {
		...
		name: "latiasweezing",
		types: ["Dragon", "Poison"],
		baseStats: {hp: 75, atk: 86, def: 110, spa: 101, spd: 110, spe: 76},
		abilities: {0: "Levitate", 1: "Neutralizing Gas", H: "Stench"},
		heightm: 1.2999999999999998,
		weightkg: 24.75,
		color: "Red",
	...
	nidokinginfernape: {
		num: 10828,
		name: "nidokinginfernape",
		types: ["Poison", "Fighting"],
		baseStats: {hp: 79, atk: 103, def: 73, spa: 91, spd: 73, spe: 100},
		abilities: {0: "Poison Point", 1: "Iron Fist", H: "Sheer Force"},
		heightm: 1.2999999999999998,
		weightkg: 58,
		color: "Purple",
		eggGroups: ["Field", "Monster"],
	...
	togekissweavile: {
		...
		abilities: {0: "Hustle", 1: "Pickpocket", H: "Super Luck"},
		heightm: 1.3,
		weightkg: 36,
		color: "White",
		eggGroups: ["Field", "Flying"],
	...
	slowbroweezing: {
		...
		name: "slowbroweezing",
		types: ["Water", "Poison"],
		baseStats: {hp: 85, atk: 85, def: 116, spa: 95, spd: 76, spe: 50},
		abilities: {0: "Oblivious", 1: "Neutralizing Gas", H: "Regenerator"},
		heightm: 1.4,
		weightkg: 44.0,
		color: "Pink",
		eggGroups: ["Amorphous", "Monster"],
	...
	tyranitarleafeon: {
		num: 10831,
		name: "tyranitarleafeon",
		types: ["Rock", "Grass"],
		baseStats: {hp: 88, atk: 118, def: 123, spa: 83, spd: 88, spe: 83},
		abilities: {0: "Sand Stream", 1: "Chlorophyll", H: "Unnerve"},
		heightm: 1,
		weightkg: 113.75,
		color: "Green",
		eggGroups: ["Field", "Monster"],
	...
	lickilickydragonite: {
		num: 10832,
		name: "lickilickydragonite",
		types: ["Normal", "Dragon"],
		baseStats: {hp: 103, atk: 117, def: 95, spa: 86, spd: 96, spe: 70},
		abilities: {0: "Own Tempo", 1: "Multiscale", H: "Cloud Nine"},
		heightm: 1.9500000000000002,
		weightkg: 175,
		color: "Pink",
		eggGroups: ["Water 1", "Monster"],
	...
	latiascofagrigus: {
		num: 10833,
		name: "latiascofagrigus",
		types: ["Dragon", "Ghost"],
		baseStats: {hp: 72, atk: 60, def: 126, spa: 105, spd: 121, spe: 56},
		abilities: {0: "Levitate", 1: "Mummy", H: ""},
		heightm: 1.5499999999999998,
		weightkg: 58.25,
		color: "Red",
		eggGroups: ["Mineral", "Undiscovered"],
	...
	nidokingblastoise: {
		num: 10834,
		name: "nidokingblastoise",
		types: ["Poison", "Water"],
		baseStats: {hp: 80, atk: 89, def: 92, spa: 85, spd: 85, spe: 80},
		abilities: {0: "Poison Point", 1: "Rain Dish", H: "Sheer Force"},
		heightm: 1.5,
		weightkg: 73.75,
		color: "Purple",
		eggGroups: ["Monster", "Monster"],
	...
	sylveonroserade: {
		num: 10835,
		name: "sylveonroserade",
		types: ["Fairy", "Poison"],
		baseStats: {hp: 83, atk: 68, def: 65, spa: 115, spd: 121, spe: 80},
		abilities: {0: "Cute Charm", 1: "Poison Point", H: "Pixilate"},
		heightm: 0.95,
		weightkg: 19.0,
		color: "Pink",
		eggGroups: ["Fairy", "Field"],
	...
	sylveonhydreigon: {
		num: 10836,
		name: "sylveonhydreigon",
		types: ["Fairy", "Dragon"],
		baseStats: {hp: 94, atk: 91, def: 81, spa: 115, spd: 116, spe: 85},
		abilities: {0: "Cute Charm", 1: "Levitate", H: "Pixilate"},
		heightm: 1.4,
		weightkg: 91.75,
		color: "Pink",
	...
	gengarhaxorus: {
		...
		name: "gengarhaxorus",
		types: ["Ghost", "Dragon"],
		baseStats: {hp: 65, atk: 119, def: 80, spa: 106, spd: 73, spe: 101},
		abilities: {0: "Cursed Body", 1: "Mold Breaker", H: "Unnerve"},
		heightm: 1.65,
		weightkg: 73.0,
		color: "Purple",
		eggGroups: ["Monster", "Amorphous"],
	...
	torterrainfernape: {
		num: 10838,
		name: "torterrainfernape",
		types: ["Grass", "Fighting"],
		baseStats: {hp: 88, atk: 105, def: 82, spa: 84, spd: 80, spe: 90},
		abilities: {0: "Overgrow", 1: "Iron Fist", H: "Shell Armor"},
		heightm: 1.7000000000000002,
		weightkg: 182,
		color: "Green",
		eggGroups: ["Field", "Monster"],
	...
	ursaringhaxorus: {
		num: 10839,
		name: "ursaringhaxorus",
		types: ["Normal", "Dragon"],
		baseStats: {hp: 85, atk: 141, def: 85, spa: 70, spd: 73, spe: 83},
		abilities: {0: "Guts", 1: "Mold Breaker", H: "Unnerve"},
		heightm: 1.8,
		weightkg: 115.65,
		color: "Brown",
		eggGroups: ["Monster", "Field"],
	...
	heracrosshaxorus: {
		num: 10840,
		name: "heracrosshaxorus",
		types: ["Bug", "Dragon"],
		baseStats: {hp: 78, atk: 139, def: 85, spa: 46, spd: 86, spe: 93},
		abilities: {0: "Swarm", 1: "Mold Breaker", H: "Moxie"},
		heightm: 1.65,
		weightkg: 79.75,
		color: "Blue",
		eggGroups: ["Monster", "Bug"],
	...
	snorlaxtangrowth: {
		...
		abilities: {0: "Thick Fat", 1: "Leaf Guard", H: "Gluttony"},
		heightm: 2.05,
		weightkg: 294.3,
		color: "Black",
		eggGroups: ["Grass", "Monster"],
	...
	steelixgallade: {
		...
		name: "steelixgallade",
		types: ["Steel", "Fighting"],
		baseStats: {hp: 72, atk: 111, def: 110, spa: 58, spd: 81, spe: 63},
		abilities: {0: "Sturdy", 1: "Justified", H: "Sheer Force"},
		heightm: 5.3999999999999995,
		weightkg: 226,
		color: "Gray",
		eggGroups: ["Human-Like", "Mineral"],
	...
	garchompsandslash: {
		num: 10843,
		name: "garchompsandslash",
		types: ["Dragon", "Ground"],
		baseStats: {hp: 97, atk: 110, def: 105, spa: 68, spd: 75, spe: 77},
		abilities: {0: "Sand Veil", 1: "Sand Rush", H: "Rough Skin"},
		heightm: 1.45,
		weightkg: 62.25,
		color: "Blue",
		eggGroups: ["Field", "Monster"],
	...
	metagrossscizor: {
		num: 10844,
		name: "metagrossscizor",
		types: ["Steel", "Bug"],
		baseStats: {hp: 76, atk: 131, def: 110, spa: 81, spd: 86, spe: 66},
	...
	chandeluremachamp: {
		num: 10845,
		name: "chandeluremachamp",
		types: ["Ghost", "Fighting"],
		baseStats: {hp: 70, atk: 105, def: 83, spa: 118, spd: 88, spe: 63},
		abilities: {0: "Flash Fire", 1: "Guts", H: "Infiltrator"},
		heightm: 1.3,
		weightkg: 82.15,
		color: "Black",
		eggGroups: ["Human-Like", "Amorphous"],
	...
	slowkingslowbro: {
		num: 10846,
		name: "slowkingslowbro",
		types: ["Water", "Psychic"],
		baseStats: {hp: 95, atk: 75, def: 100, spa: 100, spd: 100, spe: 30},
		abilities: {0: "Oblivious", 1: "Own Tempo", H: "Regenerator"},
		heightm: 1.8,
		weightkg: 79.0,
		color: "Pink",
	...
	togekisssuicune: {
		num: 10847,
		name: "togekisssuicune",
		types: ["Fairy", "Water"],
		baseStats: {hp: 90, atk: 66, def: 108, spa: 110, spd: 115, spe: 83},
		abilities: {0: "Hustle", 1: "Inner Focus", H: "Super Luck"},
		heightm: 1.75,
		weightkg: 112,
		color: "White",
		eggGroups: ["Undiscovered", "Flying"],
	...
	slowkingdusclops: {
		num: 10848,
		name: "slowkingdusclops",
		types: ["Water", "Ghost"],
		baseStats: {hp: 76, atk: 71, def: 113, spa: 86, spd: 116, spe: 26},
		abilities: {0: "Oblivious", 1: "Frisk", H: "Regenerator"},
		heightm: 1.8,
		weightkg: 55.05,
		color: "Pink",
		evos: ["Dusknoir"],
	...
	sylveonraichu: {
		...
		abilities: {0: "Cute Charm", 1: "Lightning Rod", H: "Pixilate"},
		heightm: 0.9,
		weightkg: 26.75,
		color: "Pink",
		eggGroups: ["Field", "Field"],
	...
	gardevoirninetales: {
		num: 10850,
		name: "gardevoirninetales",
		types: ["Psychic", "Fire"],
		baseStats: {hp: 69, atk: 72, def: 71, spa: 110, spd: 110, spe: 93},
		abilities: {0: "Synchronize", 1: "Drought", H: "Telepathy"},
		heightm: 1.35,
		weightkg: 34.15,
		color: "White",
		eggGroups: ["Field", "Human-Like"],
	...
	stantlergroudon: {
		num: 10851,
		name: "stantlergroudon",
		types: ["Normal", "Ground"],
		baseStats: {hp: 82, atk: 131, def: 114, spa: 90, spd: 73, spe: 88},
		abilities: {0: "Intimidate", 1: "Drought", H: "Sap Sipper"},
		heightm: 2.45,
		weightkg: 510.6,
		color: "Brown",
		eggGroups: ["Undiscovered", "Field"],
	...
	machamptyranitar: {
		num: 10852,
		name: "machamptyranitar",
		types: ["Fighting", "Dark"],
		baseStats: {hp: 93, atk: 132, def: 100, spa: 75, spd: 90, spe: 59},
		abilities: {0: "No Guard", 1: "Unnerve", H: "Steadfast"},
		heightm: 1.8,
		weightkg: 166,
		color: "Gray",
		eggGroups: ["Monster", "Human-Like"],
	...
	clefablearceus: {
		...
		name: "clefablearceus",
		types: ["Fairy", "Normal"],
		baseStats: {hp: 103, atk: 103, def: 104, spa: 103, spd: 100, spe: 100},
		abilities: {0: "Cute Charm", 1: "Multitype", H: "Unaware"},
		heightm: 2.25,
		weightkg: 180,
		color: "Pink",
		eggGroups: ["Undiscovered", "Fairy"],
	...
	hitmontopsteelix: {
		num: 10854,
		name: "hitmontopsteelix",
		types: ["Fighting", "Steel"],
		baseStats: {hp: 58, atk: 88, def: 165, spa: 41, spd: 95, spe: 43},
		abilities: {0: "Intimidate", 1: "Rock Head", H: "Steadfast"},
		heightm: 5.3,
		weightkg: 224,
		color: "Brown",
		eggGroups: ["Mineral", "Human-Like"],
	...
	rayquazaslaking: {
		num: 10855,
		name: "rayquazaslaking",
		types: ["Dragon", "Normal"],
		baseStats: {hp: 120, atk: 156, def: 96, spa: 131, spd: 81, spe: 98},
		abilities: {0: "Air Lock", 1: "Truant", H: ""},
		heightm: 4,
		weightkg: 168.5,
		color: "Green",
		eggGroups: ["Field", "Undiscovered"],
	...
	aerodactylgarchomp: {
		num: 10856,
		name: "aerodactylgarchomp",
		types: ["Rock", "Ground"],
		baseStats: {hp: 89, atk: 121, def: 85, spa: 66, spd: 78, spe: 111},
		abilities: {0: "Pressure", 1: "Rough Skin", H: "Unnerve"},
		heightm: 1.85,
		weightkg: 77,
		color: "Purple",
		eggGroups: ["Monster", "Flying"],
	...
	arceusclefable: {
		...
		name: "arceusclefable",
		types: ["Normal", "Fairy"],
		baseStats: {hp: 111, atk: 86, def: 88, spa: 111, spd: 110, spe: 80},
		abilities: {0: "Multitype", 1: "Magic Guard", H: "Unaware"},
		heightm: 2.25,
		weightkg: 180,
		color: "White",
		eggGroups: ["Fairy", "Undiscovered"],
	...
	solosismachop: {
		...
		name: "solosismachop",
		types: ["Psychic", "Fighting"],
		baseStats: {hp: 53, atk: 63, def: 46, spa: 81, spd: 45, spe: 30},
	...
	onixdoduo: {
		...
		name: "onixdoduo",
		types: ["Rock", "Flying"],
		baseStats: {hp: 35, atk: 71, def: 83, spa: 31, spd: 41, spe: 73},
		abilities: {0: "Sturdy", 1: "Early Bird", H: "Weak Armor"},
		heightm: 5.1000000000000005,
		weightkg: 124.6,
		color: "Gray",
		evos: ["DodrioSteelix"],
		eggGroups: ["Flying", "Mineral"],
	...
	lileepshieldon: {
		...
		name: "lileepshieldon",
		types: ["Rock", "Steel"],
		baseStats: {hp: 54, atk: 41, def: 104, spa: 54, spd: 87, spe: 27},
		abilities: {0: "Suction Cups", 1: "Soundproof", H: "Storm Drain"},
		heightm: 0.75,
		weightkg: 40.4,
		color: "Purple",
		evos: ["BastiodonCradily"],
		eggGroups: ["Monster", "Water 3"],
	},
	larvestaponyta: {
		num: 10862,
		name: "larvestaponyta",
		types: ["Bug", "Fire"],
		baseStats: {hp: 53, atk: 85, def: 55, spa: 55, spd: 58, spe: 80},
		abilities: {0: "Flame Body", 1: "Flash Fire", H: "Swarm"},
		heightm: 1.05,
		weightkg: 29.4,
		color: "White",
		evos: ["RapidashVolcarona"],
		eggGroups: ["Field", "Bug"],
	},
	aronponyta: {
		num: 10863,
		name: "aronponyta",
		types: ["Steel", "Fire"],
		baseStats: {hp: 50, atk: 80, def: 70, spa: 48, spd: 48, spe: 70},
		abilities: {0: "Sturdy", 1: "Flash Fire", H: "Heavy Metal"},
		heightm: 0.7,
		weightkg: 45,
		color: "Gray",
		evos: ["RapidashLairon"],
	...
	cottoneeoddish: {
		...
		name: "cottoneeoddish",
		types: ["Grass", "Poison"],
		baseStats: {hp: 41, atk: 42, def: 56, spa: 49, spd: 55, spe: 42},
		abilities: {0: "Prankster", 1: "Run Away", H: "Chlorophyll"},
		heightm: 0.4,
		weightkg: 3.0,
		color: "Green",
		evos: ["GloomWhimsicott"],
		eggGroups: ["Grass", "Fairy"],
	},
	larvestaaxew: {
		num: 10865,
		name: "larvestaaxew",
		types: ["Bug", "Dragon"],
		baseStats: {hp: 52, atk: 86, def: 58, spa: 43, spd: 50, spe: 58},
		abilities: {0: "Flame Body", 1: "Mold Breaker", H: "Swarm"},
		heightm: 0.8500000000000001,
		weightkg: 23.4,
		color: "White",
		evos: ["FraxureVolcarona"],
		eggGroups: ["Monster", "Bug"],
	},
	shellderdrifloon: {
		num: 10866,
		name: "shellderdrifloon",
		types: ["Water", "Flying"],
		baseStats: {hp: 50, atk: 55, def: 56, spa: 50, spd: 31, spe: 60},
		abilities: {0: "Shell Armor", 1: "Unburden", H: "Overcoat"},
		heightm: 0.35,
		weightkg: 2.6,
		color: "Purple",
		evos: ["DrifblimCloyster"],
		eggGroups: ["Amorphous", "Water 3"],
	},
	yanmalarvesta: {
		num: 10867,
		name: "yanmalarvesta",
		types: ["Bug", "Fire"],
		baseStats: {hp: 61, atk: 78, def: 51, spa: 66, spd: 48, spe: 71},
		abilities: {0: "Speed Boost", 1: "Swarm", H: "Frisk"},
		heightm: 1.15,
		weightkg: 33.4,
		color: "Red",
		evos: ["VolcaronaYanmega"],
		eggGroups: ["Bug", "Bug"],
	},
	larvestapawniard: {
		num: 10868,
		name: "larvestapawniard",
		types: ["Bug", "Steel"],
		baseStats: {hp: 51, atk: 85, def: 65, spa: 46, spd: 50, spe: 60},
		abilities: {0: "Flame Body", 1: "Inner Focus", H: "Swarm"},
		heightm: 0.8,
		weightkg: 19.5,
		color: "White",
		evos: ["BisharpVolcarona"],
		eggGroups: ["Human-Like", "Bug"],
	},
	murkrowferroseed: {
		num: 10869,
		name: "murkrowferroseed",
		types: ["Dark", "Steel"],
		baseStats: {hp: 54, atk: 61, def: 74, spa: 64, spd: 56, spe: 37},
		abilities: {0: "Super Luck", 1: "Iron Barbs", H: "Prankster"},
		heightm: 0.55,
		weightkg: 10.450000000000001,
		color: "Black",
		evos: ["FerrothornHonchkrow"],
		eggGroups: ["Grass", "Flying"],
	},
	pinecoferroseed: {
		num: 10870,
		name: "pinecoferroseed",
		types: ["Bug", "Steel"],
		baseStats: {hp: 48, atk: 55, def: 90, spa: 31, spd: 52, spe: 11},
		abilities: {0: "Sturdy", 1: "Iron Barbs", H: "Overcoat"},
		heightm: 0.6,
		weightkg: 13.0,
		color: "Gray",
		evos: ["FerrothornForretress"],
		eggGroups: ["Grass", "Bug"],
	},
	misdreavustogepi: {
		num: 10871,
		name: "misdreavustogepi",
		types: ["Ghost", "Fairy"],
		baseStats: {hp: 51, atk: 33, def: 63, spa: 70, spd: 78, spe: 41},
		abilities: {0: "Levitate", 1: "Serene Grace", H: "Super Luck"},
		heightm: 0.5,
		weightkg: 1.25,
		color: "Gray",
		evos: ["TogeticMismagius"],
		eggGroups: ["Undiscovered", "Amorphous"],
	},
	solosislickitung: {
		num: 10872,
		name: "solosislickitung",
		types: ["Psychic", "Normal"],
		baseStats: {hp: 60, atk: 46, def: 63, spa: 90, spd: 58, spe: 26},
		abilities: {0: "Overcoat", 1: "Oblivious", H: "Regenerator"},
		heightm: 0.75,
		weightkg: 33.25,
		color: "Green",
		evos: ["LickilickyDuosion"],
		eggGroups: ["Monster", "Amorphous"],
	},
	magmortarscizor: {
		num: 10873,
	...
	doduoonix: {
		...
		name: "doduoonix",
		types: ["Flying", "Rock"],
		baseStats: {hp: 35, atk: 58, def: 121, spa: 33, spd: 38, spe: 71},
		abilities: {0: "Run Away", 1: "Rock Head", H: "Tangled Feet"},
		heightm: 5.1000000000000005,
		weightkg: 124.6,
		color: "Brown",
		evos: ["SteelixDodrio"],
	...
	magnezoneweezing: {
		...
		abilities: {0: "Magnet Pull", 1: "Neutralizing Gas", H: "Analytic"},
		heightm: 1.2,
		weightkg: 94.75,
		color: "Gray",
		eggGroups: ["Amorphous", "Mineral"],
	...
	volcaronasceptile: {
		num: 10876,
		name: "volcaronasceptile",
		types: ["Bug", "Grass"],
		baseStats: {hp: 80, atk: 76, def: 65, spa: 125, spd: 98, spe: 113},
		abilities: {0: "Flame Body", 1: "Unburden", H: "Swarm"},
		heightm: 1.65,
		weightkg: 49.1,
		color: "White",
		eggGroups: ["Monster", "Bug"],
	...
	jirachiinfernape: {
		num: 10877,
		name: "jirachiinfernape",
		types: ["Steel", "Fighting"],
		baseStats: {hp: 92, atk: 102, def: 80, spa: 101, spd: 90, spe: 105},
		abilities: {0: "Serene Grace", 1: "Blaze", H: "Iron Fist"},
		heightm: 0.75,
		weightkg: 28.05,
		color: "Yellow",
		eggGroups: ["Field", "Undiscovered"],
	...
	tyranitarsandslash: {
		num: 10878,
		name: "tyranitarsandslash",
		types: ["Rock", "Ground"],
		baseStats: {hp: 91, atk: 111, def: 110, spa: 78, spd: 85, spe: 63},
		abilities: {0: "Sand Stream", 1: "Sand Rush", H: "Unnerve"},
		heightm: 1,
		weightkg: 115.75,
		color: "Green",
		eggGroups: ["Field", "Monster"],
	...
	slowkingsunflora: {
		num: 10880,
		name: "slowkingsunflora",
		types: ["Water", "Grass"],
		baseStats: {hp: 88, atk: 75, def: 63, spa: 101, spd: 101, spe: 30},
		abilities: {0: "Oblivious", 1: "Solar Power", H: "Regenerator"},
		heightm: 1.4,
		weightkg: 44.0,
		color: "Pink",
		eggGroups: ["Grass", "Monster"],
	...
	machampzekrom: {
		...
		baseStats: {hp: 93, atk: 143, def: 106, spa: 83, spd: 90, spe: 78},
		abilities: {0: "No Guard", 1: "Teravolt", H: "Steadfast"},
		heightm: 2.25,
		weightkg: 237,
		color: "Gray",
		eggGroups: ["Undiscovered", "Human-Like"],
	...
	rampardossandslash: {
		num: 10882,
		name: "rampardossandslash",
		types: ["Rock", "Ground"],
		baseStats: {hp: 89, atk: 121, def: 93, spa: 58, spd: 51, spe: 62},
		abilities: {0: "Mold Breaker", 1: "Sand Rush", H: "Sheer Force"},
		heightm: 1.3,
		weightkg: 66.0,
		color: "Blue",
		eggGroups: ["Field", "Monster"],
	...
	arbokgroudon: {
		...
		name: "arbokgroudon",
		types: ["Poison", "Ground"],
		baseStats: {hp: 73, atk: 131, def: 116, spa: 76, spd: 82, spe: 86},
		abilities: {0: "Shed Skin", 1: "Drought", H: "Unnerve"},
		heightm: 3.5,
		weightkg: 507,
		color: "Purple",
		eggGroups: ["Undiscovered", "Field"],
	...
	vaporeonregigigas: {
		num: 10884,
		name: "vaporeonregigigas",
		types: ["Water", "Normal"],
		baseStats: {hp: 123, atk: 128, def: 93, spa: 100, spd: 100, spe: 88},
		abilities: {0: "Water Absorb", 1: "Slow Start", H: "Hydration"},
		heightm: 2.35,
		weightkg: 224,
		color: "Blue",
		eggGroups: ["Undiscovered", "Field"],
	...
	genesectbreloom: {
		num: 10885,
		name: "genesectbreloom",
		types: ["Bug", "Fighting"],
		baseStats: {hp: 67, atk: 126, def: 85, spa: 100, spd: 83, spe: 79},
		abilities: {0: "Download", 1: "Poison Heal", H: "Technician"},
		heightm: 1.35,
		weightkg: 60.85,
		color: "Purple",
		eggGroups: ["Fairy", "Undiscovered"],
	...
	tangrowthrayquaza: {
		num: 10886,
		name: "tangrowthrayquaza",
		types: ["Grass", "Flying"],
		baseStats: {hp: 101, atk: 133, def: 101, spa: 123, spd: 63, spe: 80},
		abilities: {0: "Chlorophyll", 1: "Air Lock", H: "Regenerator"},
		heightm: 4,
		weightkg: 167.55,
		color: "Blue",
		eggGroups: ["Undiscovered", "Grass"],
	...
	mimejrriolu: {
		...
		name: "mimejrriolu",
		types: ["Psychic", "Fighting"],
		baseStats: {hp: 26, atk: 55, def: 41, spa: 58, spd: 73, spe: 60},
		abilities: {0: "Soundproof", 1: "Inner Focus", H: "Technician"},
		heightm: 0.7,
		weightkg: 18,
		color: "Pink",
		evos: ["VigorothMr. MimeMr. Mime-Galar"],
		eggGroups: ["Field", "Undiscovered"],
	},
	nidokingdarkrai: {
		num: 10888,
		name: "nidokingdarkrai",
		types: ["Poison", "Dark"],
		baseStats: {hp: 77, atk: 94, def: 85, spa: 101, spd: 80, spe: 111},
		abilities: {0: "Poison Point", 1: "Bad Dreams", H: "Sheer Force"},
		heightm: 1.45,
		weightkg: 56.25,
		color: "Purple",
		eggGroups: ["Undiscovered", "Monster"],
	...
	lucariokangaskhan: {
		num: 10889,
		name: "lucariokangaskhan",
		types: ["Fighting", "Normal"],
		baseStats: {hp: 81, atk: 100, def: 76, spa: 90, spd: 73, spe: 90},
		abilities: {0: "Steadfast", 1: "Scrappy", H: "Justified"},
		heightm: 1.7000000000000002,
		weightkg: 67,
		color: "Blue",
		eggGroups: ["Monster", "Field"],
	...
	chandelureklinklang: {
		num: 10890,
		name: "chandelureklinklang",
		types: ["Ghost", "Steel"],
		baseStats: {hp: 60, atk: 85, def: 106, spa: 120, spd: 88, spe: 86},
		abilities: {0: "Flash Fire", 1: "Minus", H: "Infiltrator"},
		heightm: 0.8,
		weightkg: 57.65,
		color: "Black",
		eggGroups: ["Mineral", "Amorphous"],
	...
	empoleonbisharp: {
		num: 10891,
		name: "empoleonbisharp",
		types: ["Water", "Steel"],
		baseStats: {hp: 77, atk: 112, def: 96, spa: 94, spd: 90, spe: 66},
		abilities: {0: "Torrent", 1: "Inner Focus", H: "Defiant"},
		heightm: 1.65,
		weightkg: 77.25,
		color: "Blue",
		eggGroups: ["Human-Like", "Water 1"],
	...
	raikoukyurem: {
		...
		name: "raikoukyurem",
		types: ["Electric", "Ice"],
		baseStats: {hp: 101, atk: 115, def: 85, spa: 120, spd: 96, spe: 101},
		abilities: {0: "Pressure", H: "Inner Focus"},
		heightm: 2.45,
		weightkg: 251,
		color: "Yellow",
	...
	umbreonsteelix: {
		...
		name: "umbreonsteelix",
		types: ["Dark", "Steel"],
		baseStats: {hp: 88, atk: 78, def: 170, spa: 58, spd: 108, spe: 41},
		abilities: {0: "Synchronize", 1: "Rock Head", H: "Inner Focus"},
		heightm: 5.1,
		weightkg: 213,
		color: "Black",
		eggGroups: ["Mineral", "Field"],
	...
	zoroarkmewtwo: {
		...
		name: "zoroarkmewtwo",
		types: ["Dark", "Psychic"],
		baseStats: {hp: 75, atk: 108, def: 80, spa: 131, spd: 70, spe: 121},
		abilities: {0: "Illusion", 1: "Pressure", H: "Unnerve"},
		heightm: 1.8,
		weightkg: 101.55,
		color: "Gray",
		eggGroups: ["Undiscovered", "Field"],
	...
	kyogreempoleon: {
		...
		abilities: {0: "Drizzle", 1: "Torrent", H: "Defiant"},
		heightm: 3.1,
		weightkg: 218.25,
		color: "Blue",
		eggGroups: ["Water 1", "Undiscovered"],
	...
	snubbullsandshrew: {
		num: 10896,
		name: "snubbullsandshrew",
		types: ["Fairy", "Ground"],
		baseStats: {hp: 56, atk: 76, def: 73, spa: 33, spd: 36, spe: 36},
		abilities: {0: "Run Away", 1: "Sand Rush", H: "Rattled"},
		heightm: 0.6,
		weightkg: 9.9,
		color: "Pink",
		evos: ["SandslashGranbull"],
		eggGroups: ["Field", "Field"],
	},
	kyuremblaziken: {
		num: 10897,
		name: "kyuremblaziken",
		types: ["Dragon", "Fighting"],
		baseStats: {hp: 110, atk: 123, def: 76, spa: 123, spd: 83, spe: 85},
		abilities: {0: "Pressure", 1: "Blaze", H: "Speed Boost"},
		heightm: 2.45,
		weightkg: 188,
		color: "Gray",
		eggGroups: ["Field", "Undiscovered"],
	...
	palkiavolcarona: {
		num: 10898,
		name: "palkiavolcarona",
		types: ["Water", "Fire"],
		baseStats: {hp: 88, atk: 80, def: 76, spa: 145, spd: 115, spe: 100},
		abilities: {0: "Pressure", 1: "Swarm", H: "Telepathy"},
		heightm: 2.9000000000000004,
		weightkg: 191,
		color: "Purple",
		eggGroups: ["Bug", "Undiscovered"],
	...
	zekromsteelix: {
		...
		name: "zekromsteelix",
		types: ["Dragon", "Steel"],
		baseStats: {hp: 91, atk: 106, def: 173, spa: 98, spd: 88, spe: 50},
		abilities: {0: "Teravolt", 1: "Rock Head", H: "Sheer Force"},
		heightm: 6.05,
		weightkg: 372,
		color: "Black",
		eggGroups: ["Mineral", "Undiscovered"],
	...
	tyroguegligar: {
		...
		name: "tyroguegligar",
		types: ["Fighting", "Flying"],
		baseStats: {hp: 45, atk: 61, def: 81, spa: 35, spd: 45, spe: 68},
		abilities: {0: "Guts", 1: "Sand Veil", H: "Vital Spirit"},
		heightm: 0.9,
		weightkg: 42.9,
		color: "Purple",
		evos: ["GliscorHitmonleeHitmonchan"],
		eggGroups: ["Bug", "Undiscovered"],
	},
	tentacruelpyukumuku: {
		num: 10901,
		name: "tentacruelpyukumuku",
		types: ["Water", "Poison"],
		baseStats: {hp: 71, atk: 63, def: 108, spa: 63, spd: 123, spe: 36},
		abilities: {0: "Clear Body", 1: "Unaware", H: "Rain Dish"},
		heightm: 0.9500000000000001,
		weightkg: 28.1,
		color: "Blue",
		eggGroups: ["Water 1", "Water 3"],
	...
	politoedferrothorn: {
		num: 10902,
		name: "politoedferrothorn",
		types: ["Water", "Steel"],
		baseStats: {hp: 84, atk: 87, def: 112, spa: 78, spd: 105, spe: 36},
		abilities: {0: "Water Absorb", 1: "Anticipation", H: "Drizzle"},
		heightm: 1.05,
		weightkg: 71.95,
		color: "Green",
		eggGroups: ["Grass", "Water 1"],
	...
	murkrowspinarak: {
		num: 10903,
		name: "murkrowspinarak",
		types: ["Dark", "Poison"],
		baseStats: {hp: 53, atk: 68, def: 40, spa: 70, spd: 41, spe: 50},
		abilities: {0: "Super Luck", 1: "Insomnia", H: "Prankster"},
		heightm: 0.5,
		weightkg: 5.3,
		color: "Black",
		evos: ["AriadosHonchkrow"],
		eggGroups: ["Bug", "Flying"],
	},
	dratinisquirtle: {
		num: 10904,
		name: "dratinisquirtle",
		types: ["Dragon", "Water"],
		baseStats: {hp: 42, atk: 53, def: 58, spa: 50, spd: 54, spe: 45},
		abilities: {0: "Shed Skin", 1: "Rain Dish", H: "Marvel Scale"},
		heightm: 1.15,
		weightkg: 6.15,
		color: "Blue",
		evos: ["WartortleDragonair"],
		eggGroups: ["Monster", "Water 1"],
	},
	azumarillhaxorus: {
		num: 10905,
		name: "azumarillhaxorus",
		types: ["Water", "Dragon"],
		baseStats: {hp: 92, atk: 114, def: 86, spa: 60, spd: 76, spe: 81},
		abilities: {0: "Huge Power", 1: "Mold Breaker", H: "Sap Sipper"},
		heightm: 1.3,
		weightkg: 67.0,
		color: "Blue",
		eggGroups: ["Monster", "Water 1"],
	...
	hydreigonvenomoth: {
		num: 10906,
		name: "hydreigonvenomoth",
		types: ["Dark", "Poison"],
		baseStats: {hp: 84, atk: 78, def: 70, spa: 113, spd: 85, spe: 92},
		abilities: {0: "Levitate", 1: "Tinted Lens", H: "Wonder Skin"},
		heightm: 1.65,
		weightkg: 86.25,
		color: "Blue",
		eggGroups: ["Bug", "Dragon"],
	...
	blastoiseparasect: {
		num: 10907,
		name: "blastoiseparasect",
		types: ["Water", "Grass"],
		baseStats: {hp: 72, atk: 91, def: 86, spa: 76, spd: 96, spe: 46},
		abilities: {0: "Torrent", 1: "Dry Skin", H: "Rain Dish"},
		heightm: 1.3,
		weightkg: 57.5,
		color: "Blue",
		eggGroups: ["Bug", "Monster"],
	...
	volcaronatyphlosion: {
		num: 10908,
		name: "volcaronatyphlosion",
		types: ["Bug", "Fire"],
		baseStats: {hp: 82, atk: 76, def: 73, spa: 126, spd: 98, spe: 100},
		abilities: {0: "Flame Body", 1: "Flash Fire", H: "Swarm"},
		heightm: 1.65,
		weightkg: 62.75,
		color: "White",
	...
	swinubaxew: {
		...
		name: "swinubaxew",
		types: ["Ice", "Dragon"],
		baseStats: {hp: 48, atk: 74, def: 53, spa: 30, spd: 33, spe: 54},
		abilities: {0: "Oblivious", 1: "Mold Breaker", H: "Thick Fat"},
		heightm: 0.5,
		weightkg: 12.25,
		color: "Brown",
		evos: ["FraxurePiloswine"],
		eggGroups: ["Monster", "Field"],
	},
	swinubtrapinch: {
		num: 10910,
		name: "swinubtrapinch",
		types: ["Ice", "Ground"],
		baseStats: {hp: 48, atk: 83, def: 43, spa: 35, spd: 35, spe: 23},
		abilities: {0: "Oblivious", 1: "Arena Trap", H: "Thick Fat"},
		heightm: 0.55,
		weightkg: 10.75,
		color: "Brown",
		evos: ["VibravaPiloswine"],
		eggGroups: ["Bug", "Field"],
	},
	lugiaforretress: {
		num: 10911,
		name: "lugiaforretress",
		types: ["Psychic", "Steel"],
		baseStats: {hp: 95, atk: 90, def: 136, spa: 80, spd: 122, spe: 63},
		abilities: {0: "Pressure", 1: "Overcoat", H: "Multiscale"},
		heightm: 3.2,
		weightkg: 170.9,
		color: "White",
		eggGroups: ["Bug", "Undiscovered"],
	...
	wooperferroseed: {
		num: 10912,
		name: "wooperferroseed",
		types: ["Water", "Steel"],
		baseStats: {hp: 51, atk: 48, def: 75, spa: 24, spd: 45, spe: 11},
		abilities: {0: "Damp", 1: "Iron Barbs", H: "Unaware"},
		heightm: 0.5,
		weightkg: 13.65,
		color: "Blue",
		evos: ["FerrothornQuagsire"],
		eggGroups: ["Grass", "Water 1"],
	},
	kyuremreshiram: {
		num: 10913,
		name: "kyuremreshiram",
		types: ["Dragon", "Fire"],
		baseStats: {hp: 116, atk: 123, def: 96, spa: 136, spd: 100, spe: 91},
		abilities: {0: "Pressure", 1: "Turboblaze", H: ""},
		heightm: 3.1,
		weightkg: 327,
		color: "Gray",
		eggGroups: ["Undiscovered", "Undiscovered"],
	...
	slowkingvileplume: {
		num: 10914,
		name: "slowkingvileplume",
		types: ["Water", "Poison"],
		baseStats: {hp: 88, atk: 78, def: 83, spa: 103, spd: 103, spe: 43},
		abilities: {0: "Oblivious", 1: "Effect Spore", H: "Regenerator"},
		heightm: 1.6,
		weightkg: 49.05,
		color: "Pink",
		eggGroups: ["Grass", "Monster"],
	...
	electrodetalonflame: {
		num: 10915,
		name: "electrodetalonflame",
		types: ["Electric", "Flying"],
		baseStats: {hp: 66, atk: 70, def: 70, spa: 78, spd: 76, spe: 134},
		abilities: {0: "Static", 1: "Gale Wings", H: "Aftermath"},
		heightm: 1.2,
		weightkg: 45.55,
		color: "Red",
		eggGroups: ["Flying", "Mineral"],
	...
	budewkoffing: {
		...
		name: "budewkoffing",
		types: ["Grass", "Poison"],
		baseStats: {hp: 40, atk: 53, def: 75, spa: 53, spd: 61, spe: 41},
		abilities: {0: "Natural Cure", 1: "Levitate", H: "Leaf Guard"},
		heightm: 0.5,
		weightkg: 1.1,
		color: "Purple",
		evos: ["WeezingDrifblimWeezing-Galar"],
		eggGroups: ["Amorphous", "Amorphous"],
	},
	politoedrhyperior: {
		num: 10917,
		name: "politoedrhyperior",
		types: ["Water", "Rock"],
		baseStats: {hp: 98, atk: 118, def: 111, spa: 78, spd: 85, spe: 50},
		abilities: {0: "Water Absorb", 1: "Solid Rock", H: "Drizzle"},
		heightm: 1.75,
		weightkg: 158.35,
		color: "Green",
		eggGroups: ["Monster", "Water 1"],
	...
	genesectelectivire: {
		num: 10918,
		name: "genesectelectivire",
		types: ["Bug", "Electric"],
		baseStats: {hp: 72, atk: 122, def: 76, spa: 111, spd: 91, spe: 96},
		abilities: {0: "Download", 1: "Motor Drive", H: "Vital Spirit"},
		heightm: 1.65,
		weightkg: 110.55,
		color: "Purple",
		eggGroups: ["Human-Like", "Undiscovered"],
	...
	nidokingreshiram: {
		num: 10919,
		name: "nidokingreshiram",
		types: ["Poison", "Fire"],
		baseStats: {hp: 87, atk: 114, def: 92, spa: 106, spd: 90, spe: 88},
		abilities: {0: "Poison Point", 1: "Turboblaze", H: "Sheer Force"},
		heightm: 2.3,
		weightkg: 196,
		color: "Purple",
		eggGroups: ["Undiscovered", "Monster"],
	...
	glaceonjolteon: {
		...
		name: "glaceonjolteon",
		types: ["Ice", "Electric"],
		baseStats: {hp: 65, atk: 63, def: 76, spa: 123, spd: 95, spe: 108},
		abilities: {0: "Snow Cloak", 1: "Quick Feet", H: "Ice Body"},
		heightm: 0.8,
		weightkg: 25.2,
		color: "Blue",
		eggGroups: ["Field", "Field"],
	...
	mamoswineregigigas: {
		...
		abilities: {0: "Oblivious", 1: "Slow Start", H: "Thick Fat"},
		heightm: 3.1,
		weightkg: 355,
		color: "Brown",
		eggGroups: ["Undiscovered", "Field"],
	...
	poliwrathblaziken: {
		num: 10922,
		name: "poliwrathblaziken",
		types: ["Water", "Fighting"],
		baseStats: {hp: 86, atk: 111, def: 78, spa: 83, spd: 83, spe: 76},
		abilities: {0: "Water Absorb", 1: "Speed Boost", H: "Swift Swim"},
		heightm: 1.6,
		weightkg: 53,
		color: "Blue",
		eggGroups: ["Field", "Water 1"],
	...
	aegislashursaring: {
		num: 10924,
		name: "aegislashursaring",
		types: ["Steel", "Normal"],
		baseStats: {hp: 70, atk: 103, def: 96, spa: 58, spd: 118, spe: 56},
		abilities: {0: "Stance Change", 1: "Guts", H: "Unnerve"},
		heightm: 1.75,
		weightkg: 89.4,
		color: "Brown",
		eggGroups: ["Field", "Mineral"],
	...
	fletchlingdoduo: {
		num: 10925,
		name: "fletchlingdoduo",
		types: ["Flying"],
		baseStats: {hp: 41, atk: 73, def: 44, spa: 38, spd: 37, spe: 70},
		abilities: {0: "Big Pecks", 1: "Early Bird", H: "Gale Wings"},
		heightm: 0.85,
		weightkg: 20.450000000000003,
		color: "Red",
		evos: ["DodrioFletchinder"],
		eggGroups: ["Flying", "Flying"],
	},
	machampweavile: {
		num: 10926,
		name: "machampweavile",
		types: ["Fighting", "Ice"],
		baseStats: {hp: 83, atk: 123, def: 70, spa: 58, spd: 85, spe: 101},
		abilities: {0: "No Guard", 1: "Pickpocket", H: "Steadfast"},
		heightm: 1.35,
		weightkg: 82,
		color: "Gray",
		eggGroups: ["Field", "Human-Like"],
	...
	darkraivenomoth: {
		num: 10927,
		name: "darkraivenomoth",
		types: ["Dark", "Poison"],
		baseStats: {hp: 70, atk: 73, def: 70, spa: 120, spd: 85, spe: 101},
		abilities: {0: "Bad Dreams", 1: "Tinted Lens", H: "Wonder Skin"},
		heightm: 1.5,
		weightkg: 31.5,
		color: "Black",
		eggGroups: ["Bug", "Undiscovered"],
	...
	gengarblaziken: {
		...
		name: "gengarblaziken",
		types: ["Ghost", "Fighting"],
		baseStats: {hp: 66, atk: 101, def: 66, spa: 123, spd: 73, spe: 90},
		abilities: {0: "Cursed Body", 1: "Blaze", H: "Speed Boost"},
		heightm: 1.7,
		weightkg: 46.25,
		color: "Purple",
		eggGroups: ["Field", "Amorphous"],
	...
	steelixgligar: {
		...
		name: "steelixgligar",
		types: ["Steel", "Flying"],
		baseStats: {hp: 71, atk: 78, def: 136, spa: 48, spd: 65, spe: 66},
		abilities: {0: "Sturdy", 1: "Sand Veil", H: "Sheer Force"},
		heightm: 5.1499999999999995,
		weightkg: 232.4,
		color: "Gray",
		evos: ["Gliscor"],
		eggGroups: ["Bug", "Mineral"],
	...
	genesectsalamence: {
		num: 10930,
		name: "genesectsalamence",
		types: ["Bug", "Flying"],
		baseStats: {hp: 79, atk: 130, def: 85, spa: 116, spd: 90, spe: 99},
		abilities: {0: "Download", 1: "Intimidate", H: "Moxie"},
		heightm: 1.5,
		weightkg: 92.55,
		color: "Purple",
		eggGroups: ["Dragon", "Undiscovered"],
	...
	taurosweavile: {
		...
		name: "taurosweavile",
		types: ["Normal", "Ice"],
		baseStats: {hp: 73, atk: 113, def: 75, spa: 41, spd: 75, spe: 120},
		abilities: {0: "Intimidate", 1: "Pickpocket", H: "Sheer Force"},
		heightm: 1.25,
		weightkg: 61.2,
		color: "Brown",
		eggGroups: ["Field", "Field"],
	...
	zweilousabsol: {
		...
		name: "zweilousabsol",
		types: ["Dark", "Dragon"],
		baseStats: {hp: 69, atk: 115, def: 63, spa: 68, spd: 66, spe: 69},
		abilities: {0: "Hustle", 1: "Pressure", H: "Justified"},
		heightm: 1.2999999999999998,
		weightkg: 48,
		color: "Blue",
		evos: ["Hydreigon"],
	...
	mawileaerodactyl: {
		num: 10933,
		name: "mawileaerodactyl",
		types: ["Steel", "Flying"],
		baseStats: {hp: 60, atk: 98, def: 71, spa: 56, spd: 61, spe: 103},
		abilities: {0: "Hyper Cutter", 1: "Rock Head", H: "Sheer Force"},
		heightm: 1.2,
		weightkg: 35.25,
		color: "Black",
		eggGroups: ["Flying", "Field"],
	...
	mewtwoinfernape: {
		num: 10934,
		name: "mewtwoinfernape",
		types: ["Psychic", "Fighting"],
		baseStats: {hp: 96, atk: 106, def: 77, spa: 137, spd: 83, spe: 115},
		abilities: {0: "Pressure", 1: "Iron Fist", H: "Unnerve"},
		heightm: 1.6,
		weightkg: 88,
		color: "Purple",
		eggGroups: ["Field", "Undiscovered"],
	...
	hoohclefable: {
		...
		name: "hoohclefable",
		types: ["Fire", "Fairy"],
		baseStats: {hp: 102, atk: 90, def: 78, spa: 105, spd: 132, spe: 70},
		abilities: {0: "Pressure", 1: "Magic Guard", H: "Regenerator"},
		heightm: 2.55,
		weightkg: 119,
		color: "Red",
		eggGroups: ["Fairy", "Undiscovered"],
	...
	lucarioregigigas: {
		num: 10936,
		name: "lucarioregigigas",
		types: ["Fighting", "Normal"],
		baseStats: {hp: 83, atk: 143, def: 96, spa: 103, spd: 83, spe: 96},
		abilities: {0: "Steadfast", 1: "Slow Start", H: "Justified"},
		heightm: 2.45,
		weightkg: 237,
		color: "Blue",
		eggGroups: ["Undiscovered", "Field"],
	...
	drifblimmewtwo: {
		...
		name: "drifblimmewtwo",
		types: ["Ghost", "Psychic"],
		baseStats: {hp: 135, atk: 100, def: 74, spa: 111, spd: 66, spe: 113},
		abilities: {0: "Aftermath", 1: "Unnerve", H: "Flare Boost"},
		heightm: 1.6,
		weightkg: 68,
		color: "Purple",
		eggGroups: ["Undiscovered", "Amorphous"],
	...
	sylveontogekiss: {
		num: 10938,
		name: "sylveontogekiss",
		types: ["Fairy", "Flying"],
		baseStats: {hp: 91, atk: 55, def: 85, spa: 113, spd: 125, spe: 73},
	...
	zoruadiglett: {
		...
		name: "zoruadiglett",
		types: ["Dark", "Ground"],
		baseStats: {hp: 30, atk: 58, def: 30, spa: 65, spd: 41, spe: 85},
		abilities: {0: "Illusion", 1: "Sand Veil", H: "Sand Force"},
		heightm: 0.44999999999999996,
		weightkg: 6.65,
		color: "Gray",
		evos: ["DugtrioZoroark"],
	...
	arbokkrookodile: {
		num: 10941,
		name: "arbokkrookodile",
		types: ["Poison", "Dark"],
		baseStats: {hp: 71, atk: 109, def: 76, spa: 65, spd: 76, spe: 88},
		abilities: {0: "Shed Skin", 1: "Moxie", H: "Unnerve"},
		heightm: 2.5,
		weightkg: 80.65,
		color: "Purple",
		eggGroups: ["Field", "Field"],
	...
	tyranitararmaldo: {
		num: 10942,
		name: "tyranitararmaldo",
		types: ["Rock", "Bug"],
		baseStats: {hp: 91, atk: 128, def: 103, spa: 86, spd: 93, spe: 50},
		abilities: {0: "Sand Stream", 1: "Swift Swim", H: "Unnerve"},
		heightm: 1.75,
		weightkg: 135.1,
		color: "Green",
		eggGroups: ["Water 3", "Monster"],
	...
	mewtwoblaziken: {
		...
		name: "mewtwoblaziken",
		types: ["Psychic", "Fighting"],
		baseStats: {hp: 97, atk: 116, def: 76, spa: 139, spd: 83, spe: 96},
		abilities: {0: "Pressure", 1: "Speed Boost", H: "Unnerve"},
		heightm: 1.95,
		weightkg: 87,
		color: "Purple",
		eggGroups: ["Field", "Undiscovered"],
	...
	krookodiledarkrai: {
		num: 10944,
		name: "krookodiledarkrai",
		types: ["Ground", "Dark"],
		baseStats: {hp: 86, atk: 99, def: 86, spa: 88, spd: 76, spe: 114},
		abilities: {0: "Intimidate", 1: "Bad Dreams", H: "Anger Point"},
		heightm: 1.5,
		weightkg: 73.4,
		color: "Red",
		eggGroups: ["Undiscovered", "Field"],
	...
	kingdrazapdos: {
		...
		name: "kingdrazapdos",
		types: ["Water", "Electric"],
		baseStats: {hp: 80, atk: 91, def: 88, spa: 105, spd: 93, spe: 95},
		abilities: {0: "Swift Swim", 1: "Static", H: "Damp"},
		heightm: 1.7000000000000002,
		weightkg: 102.3,
		color: "Blue",
		eggGroups: ["Undiscovered", "Water 1"],
	...
	latiosraikou: {
		...
		name: "latiosraikou",
		types: ["Dragon", "Electric"],
		baseStats: {hp: 83, atk: 86, def: 76, spa: 125, spd: 106, spe: 113},
		abilities: {0: "Levitate", 1: "Pressure", H: "Inner Focus"},
		heightm: 1.95,
		weightkg: 119,
		color: "Blue",
		eggGroups: ["Undiscovered", "Undiscovered"],
	...
	clefablemetagross: {
		num: 10947,
		name: "clefablemetagross",
		types: ["Fairy", "Psychic"],
		baseStats: {hp: 90, atk: 113, def: 111, spa: 95, spd: 90, spe: 66},
		abilities: {0: "Cute Charm", 1: "Light Metal", H: "Unaware"},
		heightm: 1.4500000000000002,
		weightkg: 295,
		color: "Pink",
		eggGroups: ["Mineral", "Fairy"],
	...
	kyogrescizor: {
		...
		name: "kyogrescizor",
		types: ["Water", "Bug"],
		baseStats: {hp: 90, atk: 120, def: 96, spa: 118, spd: 120, spe: 73},
		abilities: {0: "Drizzle", 1: "Technician", H: "Light Metal"},
		heightm: 3.15,
		weightkg: 235,
		color: "Blue",
		eggGroups: ["Bug", "Undiscovered"],
	...
	sylveonmetagross: {
		num: 10949,
		name: "sylveonmetagross",
		types: ["Fairy", "Psychic"],
		baseStats: {hp: 90, atk: 111, def: 108, spa: 105, spd: 116, spe: 66},
		abilities: {0: "Cute Charm", 1: "Light Metal", H: "Pixilate"},
		heightm: 1.3,
		weightkg: 286.75,
		color: "Pink",
		eggGroups: ["Mineral", "Field"],
	...
	rayquazaforretress: {
		num: 10951,
		name: "rayquazaforretress",
		types: ["Dragon", "Steel"],
		baseStats: {hp: 95, atk: 110, def: 123, spa: 120, spd: 80, spe: 58},
		abilities: {0: "Air Lock", 1: "Sturdy", H: "Overcoat"},
		heightm: 4.1,
		weightkg: 166.15,
		color: "Green",
		eggGroups: ["Bug", "Undiscovered"],
	...
	magcargolapras: {
		...
		name: "magcargolapras",
		types: ["Fire", "Ice"],
		baseStats: {hp: 83, atk: 73, def: 93, spa: 88, spd: 85, spe: 50},
		abilities: {0: "Magma Armor", 1: "Water Absorb", H: "Weak Armor"},
		heightm: 1.65,
		weightkg: 137,
		color: "Red",
		eggGroups: ["Monster", "Amorphous"],
	...
	rampardosdeoxys: {
		num: 10953,
		name: "rampardosdeoxys",
		types: ["Rock", "Psychic"],
		baseStats: {hp: 81, atk: 155, def: 53, spa: 93, spd: 50, spe: 119},
		abilities: {0: "Mold Breaker", 1: "Pressure", H: "Sheer Force"},
		heightm: 1.65,
		weightkg: 81.65,
		color: "Blue",
	...
	lucariodarkrai: {
		...
		name: "lucariodarkrai",
		types: ["Fighting", "Dark"],
		baseStats: {hp: 70, atk: 96, def: 83, spa: 121, spd: 76, spe: 113},
		abilities: {0: "Steadfast", 1: "Bad Dreams", H: "Justified"},
		heightm: 1.35,
		weightkg: 52.25,
		color: "Blue",
		eggGroups: ["Undiscovered", "Field"],
	...
	gyaradosdodrio: {
		...
		name: "gyaradosdodrio",
		types: ["Water", "Flying"],
		baseStats: {hp: 83, atk: 115, def: 73, spa: 60, spd: 86, spe: 100},
	...
	dittoditto: {
		...
		types: ["Normal"],
		baseStats: {hp: 48, atk: 48, def: 48, spa: 48, spd: 48, spe: 48},
		abilities: {0: "Limber", 1: "Limber", H: "Imposter"},
		heightm: 0.3,
		weightkg: 4,
		color: "Purple",
	...
	pawniardmeowth: {
		...
		name: "pawniardmeowth",
		types: ["Dark", "Normal"],
		baseStats: {hp: 43, atk: 58, def: 46, spa: 40, spd: 40, spe: 80},
		abilities: {0: "Defiant", 1: "Technician", H: "Pressure"},
		heightm: 0.45,
		weightkg: 7.199999999999999,
		color: "Red",
	...
	cottoneevoltorb: {
		num: 10958,
		name: "cottoneevoltorb",
		types: ["Grass", "Electric"],
		baseStats: {hp: 40, atk: 29, def: 53, spa: 43, spd: 51, spe: 88},
		abilities: {0: "Prankster", 1: "Soundproof", H: "Chlorophyll"},
		heightm: 0.4,
		weightkg: 5.5,
		color: "Green",
		evos: ["ElectrodeWhimsicott"],
		eggGroups: ["Mineral", "Fairy"],
	},
	hydreigonlugia: {
		num: 10959,
		name: "hydreigonlugia",
		types: ["Dark", "Flying"],
		baseStats: {hp: 96, atk: 95, def: 116, spa: 113, spd: 111, spe: 106},
		abilities: {0: "Levitate", 1: "Pressure", H: "Multiscale"},
		heightm: 3.5,
		weightkg: 188,
		color: "Blue",
	...
	arcaninebastiodon: {
		num: 10960,
		name: "arcaninebastiodon",
		types: ["Fire", "Steel"],
		baseStats: {hp: 80, atk: 71, def: 138, spa: 82, spd: 99, spe: 51},
		abilities: {0: "Flash Fire", 1: "Soundproof", H: "Justified"},
		heightm: 1.6,
		weightkg: 152.25,
		color: "Brown",
		eggGroups: ["Monster", "Field"],
	...
	piplupzorua: {
		...
		name: "piplupzorua",
		types: ["Water", "Dark"],
		baseStats: {hp: 48, atk: 60, def: 44, spa: 67, spd: 50, spe: 56},
		abilities: {0: "Torrent", 1: "Illusion", H: "Defiant"},
		heightm: 0.55,
		weightkg: 8.85,
		color: "Blue",
		evos: ["ZoroarkPrinplup"],
		eggGroups: ["Field", "Water 1"],
	},
	hydreigondoublade: {
		num: 10962,
		name: "hydreigondoublade",
		types: ["Dark", "Ghost"],
		baseStats: {hp: 81, atk: 108, def: 130, spa: 98, spd: 76, spe: 56},
		abilities: {0: "Levitate", 1: "No Guard", H: ""},
		heightm: 1.3,
		weightkg: 82.25,
		color: "Blue",
		evos: ["Aegislash"],
	...
	latiasbibarel: {
		...
		name: "latiasbibarel",
		types: ["Dragon", "Water"],
		baseStats: {hp: 79, atk: 83, def: 70, spa: 91, spd: 106, spe: 84},
		abilities: {0: "Levitate", 1: "Unaware", H: "Moody"},
		heightm: 2.3499999999999996,
		weightkg: 182,
		color: "Red",
		eggGroups: ["Undiscovered", "Undiscovered"],
	},
	venusaurempoleon: {
		num: 10964,
		name: "venusaurempoleon",
		types: ["Grass", "Steel"],
		baseStats: {hp: 81, atk: 84, def: 86, spa: 103, spd: 100, spe: 66},
		abilities: {0: "Overgrow", 1: "Defiant", H: "Chlorophyll"},
		heightm: 1.85,
		weightkg: 92.25,
		color: "Green",
		eggGroups: ["Water 1", "Monster"],
	...
	raichutorchic: {
		...
		name: "raichutorchic",
		types: ["Electric", "Fire"],
		baseStats: {hp: 55, atk: 70, def: 45, spa: 83, spd: 70, spe: 66},
	...
	raichushuckle: {
		...
		name: "raichushuckle",
		types: ["Electric", "Rock"],
		baseStats: {hp: 46, atk: 36, def: 171, spa: 63, spd: 130, spe: 40},
		abilities: {0: "Static", 1: "Gluttony", H: "Lightning Rod"},
		heightm: 0.7,
		weightkg: 25.25,
		color: "Yellow",
		eggGroups: ["Bug", "Field"],
